...
CRM.GetCurrentModeMOTDChecksumData = function ( f73_arg0 )
	local f73_local0 = PLAYER_DATA.IO( f73_arg0, CoD.StatsGroup.NonGame )
	if CONDITIONS.IsMagmaGameMode() then
...
CRM.TryForceOpenCRMWindow = function ( f72_arg0, f72_arg1, f72_arg2 )
	...
	if f72_local1 then
		if CRM.IsLocationMOTD( f72_arg1 ) then
			local f72_local2 = PLAYER_DATA.IO( f72_local0, CoD.StatsGroup.NonGame )
			local f72_local3 = CRM.GetCurrentModeMOTDChecksumData( f72_local0 )
			if not f72_local3 then
				return false
			end
			local f72_local4 = Dvar[0x9E5BE3B4BBA4E0E]( 0xE6893D05BB345EF )
...
CRM.GetPatchNoteMessageData = function ()
	...
	local f67_local4 = Dvar[0x22EAAB59AA27E9B]( 0xAB72538D417785B )
...
CRM.GetMessageContent = function ( f66_arg0, f66_arg1, f66_arg2 )
	if Dvar[0x9E5BE3B4BBA4E0E]( 0x9AB37E59DA04E3E ) then
...
CRM.GetMenuMessageData = function ()
	...
	local f64_local7 = Dvar[0x22EAAB59AA27E9B]( 0x7719A62BE2A4897 )
...
CRM.GetMessageData = function ( f63_arg0, f63_arg1, f63_arg2 )
	...
	if not f63_local0[CRM.keys.TITLE] or f63_local0[CRM.keys.TITLE] == "" then
		f63_local0[CRM.keys.TITLE] = Engine[0xED84C33EC5F01EA]( 0xA93AD801A47ED61 )
	else
	...
	if f63_local0[CRM.keys.ACTION] and 0 < #f63_local0[CRM.keys.ACTION] then
		if not f63_local0[CRM.keys.ACTION_TITLE] or f63_local0[CRM.keys.ACTION_TITLE] == "" then
			f63_local0[CRM.keys.ACTION_TITLE] = Engine[0xED84C33EC5F01EA]( 0x7D9DC9E3291E103 )
		end
...
CRM.SetupBackButtonHandler = function ( f56_arg0, f56_arg1, f56_arg2, f56_arg3, f56_arg4 )
	...
	if f56_arg2[CRM.keys.FORCE_VIEW_TIME] and f56_arg3 then
		...
		f56_local2:SetFont( FONTS.GetFont( FONTS.PrimaryLight.File ) )
		...
		return function ( f50_arg0, f50_arg1 )
			...
			return {
				...
				openMenuFunction = function ()
					LUI.FlowManager.RequestAddMenu( LOADOUT.GetLoadoutMenuRef(), true, f50_arg0 )
				end
...
local f0_local2 = function ( f46_arg0, f46_arg1 )
	if 0 < #WEAPON.GetModifications( f46_arg0, {
...
local f0_local4 = function ( f38_arg0, f38_arg1 )
	...
	local f38_local1 = function ( f41_arg0 )
		Engine[0x7C75E608EA39B5C]( string.format( "clickCRMMessageAction %d %d %s %s", f38_arg0[CRM.keys.LOCATION_ID], f38_arg0[CRM.keys.MESSAGE_ID], "goto_ingame", "tournaments" ), f38_arg0 )
...
local f0_local5 = function ( f36_arg0, f36_arg1 )
	if not CONDITIONS.IsWeGameGovBanned() then
		return function ( f37_arg0, f37_arg1 )
			Engine[0x7C75E608EA39B5C]( string.format( "clickCRMMessageAction %d %d %s %s", f36_arg0[CRM.keys.LOCATION_ID], f36_arg0[CRM.keys.MESSAGE_ID], "goto_ingame", "barracks" ), f36_arg0 )
...
local f0_local6 = function ( f32_arg0, f32_arg1 )
	if not CONDITIONS.IsWeGameGovBanned() and not Engine[0x757E77CA15D6B8F]( f32_arg0 ) then
		return function ( f33_arg0, f33_arg1 )
			Engine[0x7C75E608EA39B5C]( string.format( "clickCRMMessageAction %d %d %s %s", f32_arg0[CRM.keys.LOCATION_ID], f32_arg0[CRM.keys.MESSAGE_ID], "goto_ingame", "missions" ), f32_arg0 )
...
local f0_local7 = function ( f30_arg0, f30_arg1 )
	return function ( f31_arg0, f31_arg1 )
		Engine[0x7C75E608EA39B5C]( string.format( "clickCRMMessageAction %d %d %s %s", f30_arg0[CRM.keys.LOCATION_ID], f30_arg0[CRM.keys.MESSAGE_ID], "goto_ingame", "social" ), f30_arg0 )
...
local f0_local8 = function ( f28_arg0, f28_arg1 )
	if CONDITIONS.IsStoreAllowed() and STORE.GetCategoryIndex( f28_arg0, f28_arg1[CRM.keys.STORE_ITEM] ) ~= nil then
		return function ( f29_arg0, f29_arg1 )
			Engine[0x7C75E608EA39B5C]( string.format( "clickCRMMessageAction %d %d %s %s", f28_arg0[CRM.keys.LOCATION_ID], f28_arg0[CRM.keys.MESSAGE_ID], "goto_ingame", "store" ), f28_arg0 )
...
local f0_local9 = function ( f26_arg0, f26_arg1 )
	if CONDITIONS.IsStoreAllowed() then
		return function ( f27_arg0, f27_arg1 )
			Engine[0x7C75E608EA39B5C]( string.format( "clickCRMMessageAction %d %d %s %s", f26_arg0[CRM.keys.LOCATION_ID], f26_arg0[CRM.keys.MESSAGE_INDEX], "goto_ingame", "Store" ), f26_arg0 )
...
local f0_local10 = function ( f24_arg0, f24_arg1 )
	if CONDITIONS.IsBattlePassEnabled() then
		return function ( f25_arg0, f25_arg1 )
			Engine[0x7C75E608EA39B5C]( string.format( "clickCRMMessageAction %d %d %s %s", f24_arg0[CRM.keys.LOCATION_ID], f24_arg0[CRM.keys.MESSAGE_ID], "goto_ingame", "battlepass" ), f24_arg0 )
...
local f0_local11 = function ( f22_arg0, f22_arg1 )
	return function ( f23_arg0, f23_arg1 )
		Engine[0x7C75E608EA39B5C]( string.format( "clickCRMMessageAction %d %d %s %s", f22_arg0[CRM.keys.LOCATION_ID], f22_arg0[CRM.keys.MESSAGE_ID], "goto_ingame", "operators" ), f22_arg0 )
...
local f0_local14 = function ( f17_arg0, f17_arg1 )
	...
	if f17_local0 and 0 < #f17_local0 then
		return function ( f18_arg0, f18_arg1 )
			Engine[0xA265A859B7C189E]( f18_arg1.controller, Enum[0xF1088316FF3F9][0xE9F94B4318205CC], f17_arg0 )
			Engine[0x7C75E608EA39B5C]( string.format( "clickCRMMessageAction %d %d %s %s", f17_arg0[CRM.keys.LOCATION_ID], f17_arg0[CRM.keys.MESSAGE_ID], "goto_url", f17_arg0 ), f18_arg1.controller )
			CRM.QueueReadMessage( f18_arg1.controller, f17_arg0[CRM.keys.LOCATION_ID], f17_arg0[CRM.keys.MESSAGE_INDEX] )
...
MenuBuilder.registerType( "RegistrationFailedPopup", function ()
	local f16_local0 = MenuBuilder.BuildRegisteredType( "PopupOK", {
		message = Engine[0xED84C33EC5F01EA]( 0x1CBFB8FD6F438DE )
	} )
...
MenuBuilder.registerType( "RegisteringEmailPopup", function ( f13_arg0, f13_arg1 )
	local f13_local0 = MenuBuilder.BuildRegisteredType( "FenceDialogPopup", {
		message = Engine[0xED84C33EC5F01EA]( 0xEE414ED3C7C7BDD ),
	...
	f13_local0:addEventHandler( "registration_success", function ( f15_arg0, f15_arg1 )
		Engine[0x7C75E608EA39B5C]( string.format( "clickCRMMessageAction %d %d %s %s", f13_arg0.locationIndex, f13_arg0.messageID, "register", "registration_success" ), f13_arg0.controllerIndex )
	...
	f13_local0:addEventHandler( "registration_error", function ( f14_arg0, f14_arg1 )
		Engine[0x7C75E608EA39B5C]( string.format( "clickCRMMessageAction %d %d %s %s", f13_arg0.locationIndex, f13_arg0.messageID, "register", "registration_error" ), f13_arg0.controllerIndex )
...
local f0_local15 = function ( f10_arg0, f10_arg1 )
	return function ( f11_arg0, f11_arg1 )
		OSK[0xC1C15C14B75864C]( f10_arg0, Engine[0xED84C33EC5F01EA]( 0x772C8D3A772B59 ), "", 128, false, false, false, function ( f12_arg0, f12_arg1, f12_arg2 )
			if f12_arg1 then
				...
				Engine[0x5F6068BE979AB1F]( f12_arg0, f12_arg1 )
			end
		end )
	end
...
MenuBuilder.registerType( "RedeemCRMMessagePopup", function ( f5_arg0, f5_arg1 )
	local f5_local0 = {
		message = Engine[0xED84C33EC5F01EA]( 0x211CF5EE0B0350 ),
	...
	f5_local2:addEventHandler( "redemption_success", function ( f7_arg0, f7_arg1 )
		...
		Engine[0x7C75E608EA39B5C]( string.format( "clickCRMMessageAction %d %d %s %s", f5_arg0.locationIndex, f5_arg0.messageID, "redeem", "redemption_success" ), f5_arg0.controllerIndex )
	...
	f5_local2:addEventHandler( "redemption_failed", function ( f6_arg0, f6_arg1 )
		...
		if f6_arg1.errorAlreadyRedeemed then
			Engine[0x7C75E608EA39B5C]( string.format( "clickCRMMessageAction %d %d %s %s", f5_arg0.locationIndex, f5_arg0.messageID, "redeem", "redemption_failed_already_redeemed" ), f5_arg0.controllerIndex )
		...
		elseif f6_arg1.errorCodeExpired then
			Engine[0x7C75E608EA39B5C]( string.format( "clickCRMMessageAction %d %d %s %s", f5_arg0.locationIndex, f5_arg0.messageID, "redeem", "redemption_failed_code_expired" ), f5_arg0.controllerIndex )
			CRM.UpdateCRMData( f6_arg0, f5_arg0.controllerIndex, f5_arg0.locationIndex, f5_arg0.messageIndex, f5_arg0 )
			LUI.FlowManager.RequestPopupMenu( f6_arg0, "code_expired_popup", true, f5_arg0.controllerIndex )
		else
			Engine[0x7C75E608EA39B5C]( string.format( "clickCRMMessageAction %d %d %s %s", f5_arg0.locationIndex, f5_arg0.messageID, "redeem", "redemption_failed" ), f5_arg0.controllerIndex )
...
local f0_local17 = function ( f3_arg0, f3_arg1 )
	return function ( f4_arg0, f4_arg1 )
		...
		Engine[0x5B9DB8CF06C2366]( f3_arg0, f3_arg0[CRM.keys.LOCATION_ID], f3_arg0[CRM.keys.MESSAGE_INDEX] )
	end
