...
local f0_local1 = function ( f6_arg0, f6_arg1, f6_arg2, f6_arg3 )
	...
	if f6_local0 == ATTACHMENT.conversionkit then
	...
	if CONDITIONS.ShouldShowAttachmentLines() then
		...
		if f6_arg0._attachLine then
			...
			f6_arg0._attachLine:SetVertexPosition( LUI.UILine.START, 0, 0, 10, 20 )
		end
	...
	f6_local3 = f6_local3.SetCategoryText
	local f6_local5
	...
	if f6_arg0.Category.AMPIcon then
		f6_arg0.Category.AMPIcon:SetVisible( ATTACHMENT.IsAMP( f6_arg3.ref ) )
	end
end
...
local f0_local2 = function ( f5_arg0, f5_arg1, f5_arg2, f5_arg3, f5_arg4 )
	...
	if CONDITIONS.ShouldShowAttachmentLines() then
		...
		if f5_arg0._attachLine then
			...
			f5_arg0._attachLine:SetVertexPosition( LUI.UILine.START, 0, 0, 10, 20 )
		end
		if f5_arg0._attachPoint then
			f5_arg0._attachPoint:SetAlpha( 0.4 )
		end
	end
	f5_arg0.Category:SetCategoryText( Engine[0xED84C33EC5F01EA]( f5_local0 ) )
...
MenuBuilder.registerType( 0xFE43458C2C89F5, GunsmithPreviewButtonBase )
LockTable( _M )
