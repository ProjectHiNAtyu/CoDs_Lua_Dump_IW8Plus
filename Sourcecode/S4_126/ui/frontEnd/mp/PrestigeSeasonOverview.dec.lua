...
local f0_local0 = function ( f4_arg0, f4_arg1 )
	...
	f4_local1.top = f4_local0.bottom + 5 * _1080p
	...
	for f4_local2 = 1, 6, 1 do
		local f4_local5 = MenuBuilder.BuildRegisteredType( "PrestigeOverviewRow", {
			controllerIndex = f4_arg0._controllerIndex
		} )
		...
		f4_local5.id = "PrestigeOverviewRow_" .. tostring( f4_local2 )
	end
end
...
function PrestigeSeasonOverview( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 1200 * _1080p, 0, 640 * _1080p )
	self.id = "PrestigeSeasonOverview"
	local f1_local1
	if controller then
	...
	Description:setText( Engine[0xED84C33EC5F01EA]( "SEASONS_TUALPHA/PRESTIGE_EMBLEMS_DESC" ), 0 )
	...
	Title:setText( Engine[0xED84C33EC5F01EA]( "SEASONS_TUALPHA/PRESTIGE_SEASON_OVERVIEW" ), 0 )
...
MenuBuilder.registerType( "PrestigeSeasonOverview", PrestigeSeasonOverview )
LockTable( _M )
