...
local f0_local0 = function ( f6_arg0, f6_arg1, f6_arg2 )
	...
	local f6_local1 = LOADOUT.GetLoadoutsPlayerData( f6_arg1 )
	f6_arg0.LoadoutGrid:SetRefreshChild( function ( f7_arg0, f7_arg1, f7_arg2 )
		...
		f7_arg0.GenericButton:addEventHandler( "button_action", function ( f8_arg0 )
			if Dvar[0x9E5BE3B4BBA4E0E]( "#x36dd71ea0a4812ceb" ) == true then
				return 
			else
...
function MatchSimLoadoutSelect( menu, controller )
	...
	MenuTitle.MenuTitle:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU_MP/LOADOUT_SELECT" ), 0 )
