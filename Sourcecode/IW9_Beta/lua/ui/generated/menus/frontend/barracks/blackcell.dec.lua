...
local f0_local0 = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	f3_arg0.MenuTitle:SetTitle( Engine[0xED84C33EC5F01EA]( 0x1AC745CA0907E03 ) )
end

function BlackCell( menu, controller )
	...
	MenuTitle.MenuTitle:setText( Engine[0xED84C33EC5F01EA]( 0x1AC745CA0907E03 ), 0 )
