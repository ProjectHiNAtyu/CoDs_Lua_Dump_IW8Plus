...
local f0_local0 = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	if false then
		f3_arg0.ProgressText:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU_MP/CONTRACT_COMPLETE" ) )
...
function ContractProgress( menu, controller )
	...
	ProgressTitle:setText( ToUpperCase( Engine[0xED84C33EC5F01EA]( "LUA_MENU/PROGRESS" ) ), 0 )
	ProgressTitle:SetFont( FONTS.GetFont( FONTS.MainRegular.File ) )
	ProgressTitle:SetFontSize( 24 * _PT )
	ProgressTitle:SetMinFontSize( 16 * _PT )
	...
	ProgressText:SetFontSize( 36 * _PT )
