...
function BasicCurrencies( menu, controller )
	...
	PartsValue:SetFont( FONTS.GetFont( FONTS.MainRegularHeader.File ) )
	PartsValue:SetFontSize( 24 * _PT )
	PartsValue:SetMinFontSize( 16 * _PT )
	...
	PartsValue:SetEllipsesEnabled( true )
	...
	KeysValue:SetFont( FONTS.GetFont( FONTS.MainRegularHeader.File ) )
	KeysValue:SetFontSize( 24 * _PT )
	KeysValue:SetMinFontSize( 16 * _PT )
	...
	KeysValue:SetEllipsesEnabled( true )
