...
local f0_local5 = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	f3_arg0:AddGamepadEventCallback( "button_left_stick", function ( f6_arg0, f6_arg1 )
		if Dvar[0x9E5BE3B4BBA4E0E]( 0xF5F221A98F7AAE1 ) then
			f3_arg0( f6_arg0, f6_arg1.controller or f3_arg0 )
	...
	f3_arg0:AddGamepadEventCallback( "button_alt1", function ( f5_arg0, f5_arg1 )
		if f5_arg0._switchClanTagEnabled then
			...
			local f5_local1 = f5_arg0._currentClanTagType
			local f5_local2 = ClanTagType.CUSTOM
			f5_local1 = REG8 and ClanTagType.OFFICIAL or ClanTagType.CUSTOM
			Engine[0x83EEB60522A30A9]( f5_local0, f5_local1 )
			f5_arg0._currentClanTagType = f5_local1
	...
	local f3_local6 = LUI.DataSourceInGlobalModel.new( "menu.spltscreenDisplay.controllerIndex" )
...
function BarracksMenuBase( f1_arg0, f1_arg1 )
	local f1_local0 = LUI
	local f1_local1 = f1_local0.UIVerticalNavigatorMenu.new()
	f1_local1.id = "BarracksMenuBase"
	local f1_local2
	if f1_arg1 then
		f1_local2 = f1_arg1
	else
...
MenuBuilder.registerType( 0xAB80128FFFE241C, BarracksMenuBase )
LockTable( _M )
