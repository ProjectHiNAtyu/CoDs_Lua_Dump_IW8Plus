...
function ContractRewardBox( menu, controller )
	...
	Title:setText( ToUpperCase( Engine[0xED84C33EC5F01EA]( 0xAFBF0C99F716D44 ) ), 0 )
	...
	RewardType:SetFontSize( 18 * _PT )
	RewardType:SetMinFontSize( 18 * _PT )
	...
	self._sequences.FlareRotate = function ()
		menu:AnimateLoop( "FlareRotate", -1 )
		menu:AnimateLoop( "FlareRotate", -1 )
	end
