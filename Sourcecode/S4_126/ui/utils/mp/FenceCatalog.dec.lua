...
FenceCatalog.Start = function ( f4_arg0 )
	...
	local f4_local0 = Dvar[0x9E5BE3B4BBA4E0E]( "#x3d287aa02d9315c1d" )
	local f4_local1 = Dvar[0x22EAAB59AA27E9B]( "#x330817fb263c18800" )
...
FenceCatalog.ShowInProgressPopup = function ( f1_arg0 )
	LUI.FlowManager.RequestPopupMenu( nil, "StoreInProgressPopup", false, f1_arg0._controllerIndex, false, {
