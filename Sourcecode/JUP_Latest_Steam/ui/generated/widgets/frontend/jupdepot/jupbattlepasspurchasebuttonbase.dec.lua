...
function JupBattlePassPurchaseButtonBase( f1_arg0, f1_arg1 )
	local f1_local0 = LUI
	local f1_local1 = f1_local0.UIButton.new()
	f1_local1:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 500, 0, 100 )
	f1_local1.id = "JupBattlePassPurchaseButtonBase"
	local f1_local2
	if f1_arg1 then
		f1_local2 = f1_arg1
	else
...
MenuBuilder.registerType( 0x5F7F900BF2AE465, JupBattlePassPurchaseButtonBase )
LockTable( _M )
