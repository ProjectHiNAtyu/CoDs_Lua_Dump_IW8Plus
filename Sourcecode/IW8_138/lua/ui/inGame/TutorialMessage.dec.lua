...
local f0_local1 = function ( f16_arg0 )
	if CONDITIONS.IsBRGameType() and DataSources.inGame.player.BRData.PlayerStatusIsZombie:GetValue( f16_arg0 ) == true and DataSources.inGame.HUD.hints.invalidCmdHintType:GetValue( f16_arg0 ) == f0_local0.NO_GRENADE then
		return false
	else
		return true
	end
