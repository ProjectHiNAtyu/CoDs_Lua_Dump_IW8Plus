...
LUI.FenceSpinner.init = function ( f8_arg0, f8_arg1, f8_arg2 )
	LUI.Fence.init( f8_arg0 )
	f8_arg0.fenceChannel = CoD.FenceChannel.Default
	f8_arg0._controllerIndex = f8_arg2
	assert( f8_arg0._controllerIndex ~= nil )
end
...
LUI.FenceSpinner.Stop = function ( f6_arg0 )
	local f6_local0, f6_local1 = Fences[0x2CCEF78DFCF4E7A]( f6_arg0.fenceChannel )
	LUI.FlowManager.RequestLeaveMenuByName( "SpinnerInProgressPopup", true )
	if f6_local0 ~= LUI.FenceSpinner.CODE_STATE.idle then
		if f6_local0 == LUI.FenceSpinner.CODE_STATE.success then
			if Fences[0xD84CAEED33E4AFD]( f6_arg0.fenceChannel ) == true then
				f6_arg0:ShowSuccessPopup()
			end
			Fences[0x4545228C7EF954E]( f6_arg0.fenceChannel )
		elseif f6_local0 == LUI.FenceSpinner.CODE_STATE.failure and Fences[0x6A2406C0A723BC7]( f6_arg0.fenceChannel ) == LUI.FenceSpinner.FAILURE_ACTION.none then
...
LUI.FenceSpinner.PostFail = function ( f5_arg0 )
	if f5_arg0._state == LUI.Fence.STATE.fail then
		...
		Fences[0x4545228C7EF954E]( f5_arg0.fenceChannel )
	end
end

LUI.FenceSpinner.ShowInProgressPopup = function ( f4_arg0 )
	local f4_local0, f4_local1 = Fences[0x2CCEF78DFCF4E7A]( f4_arg0.fenceChannel )
	LUI.FlowManager.RequestPopupMenu( nil, "SpinnerInProgressPopup", false, nil, false, {
		message = f4_local1
	}, nil, true, true )
end

LUI.FenceSpinner.ShowSuccessPopup = function ( f3_arg0 )
	local f3_local0, f3_local1 = Fences[0x2CCEF78DFCF4E7A]( f3_arg0.fenceChannel )
	LUI.FlowManager.RequestPopupMenu( nil, "SpinnerConfirmationPopup", false, nil, false, {
		message = f3_local1
	}, nil, true, true )
end

LUI.FenceSpinner.ShowFailurePopup = function ( f2_arg0 )
	local f2_local0, f2_local1 = Fences[0x2CCEF78DFCF4E7A]( f2_arg0.fenceChannel )
	LUI.FlowManager.RequestPopupMenu( nil, "ErrorNoticePopup", false, f2_arg0._controllerIndex, false, {
		message = f2_local1
	}, nil, true, true )
end
...
LUI.FenceSpinner.UpdateState = function ( f1_arg0 )
	...
	local f1_local0, f1_local1 = Fences[0x2CCEF78DFCF4E7A]( f1_arg0.fenceChannel )
	...
	elseif f1_local0 == LUI.FenceSpinner.CODE_STATE.failure then
		if Fences[0x6A2406C0A723BC7]( f1_arg0.fenceChannel ) == LUI.FenceSpinner.FAILURE_ACTION.fence then
