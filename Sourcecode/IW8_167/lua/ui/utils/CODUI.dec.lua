...
Memory.CheckLow = function ()
	local f59_local0 = Engine.CFCAICIAJC()
	local f59_local1 = Memory.InGame.lowFreeBytes
	if Engine.DDJFBBJAIG() then
		f59_local1 = Memory.Frontend.lowFreeBytes
	end
...
CoD.PartyMemberHasAllMapPacksForMode = function ( f58_arg0, f58_arg1 )
	for f58_local0 = 1, #f58_arg1, 1 do
		if not Engine.FHEGBGHEC( f58_arg0, f58_arg1[f58_local0].index ) then
			return false
		end
	end
	return true
...
local f0_local2 = function ( f57_arg0, f57_arg1 )
	...
	for f57_local2 = 1, #f57_arg0, 1 do
		if Engine.BAJHDFAJJF( f57_arg0[f57_local2].index ) == false then
			f57_local0 = f57_local0 + 1
			f57_local1 = f57_arg0[f57_local2].missingMessage
		end
	end
...
CoD.CheckForMissingMPDataPacks = function ()
	...
	local f56_local1 = CoD.MP_PACKS
	return f56_local0( Engine.CBBHFCGDIC( "LUA_MENU/MISSING_DLC_MP" ) )
end

CoD.CheckForMissingSPDataPacks = function ()
	local f55_local0 = f0_local0
	local f55_local1 = CoD.SP_PACKS
	return f55_local0( Engine.CBBHFCGDIC( "LUA_MENU/MISSING_DLC_SP" ) )
end

CoD.CheckForMissingCPDataPacks = function ()
	local f54_local0 = f0_local0
	local f54_local1 = CoD.CP_PACKS
	return f54_local0( Engine.CBBHFCGDIC( "LUA_MENU/MISSING_DLC_CP" ) )
end
...
CoD.CheckForMissingSurvivalDataPacks = function ()
	if not Engine.CGABICJHAI() then
		...
		local f53_local1 = CoD.SURVIVAL_PACKS
		return f53_local0( Engine.CBBHFCGDIC( "LUA_MENU/MISSING_DLC_CP3" ) )
	end
end

CoD.CheckForMissingBRDataPacks = function ()
	local f52_local0 = f0_local0
	local f52_local1 = CoD.BR_PACKS
	return f52_local0( Engine.CBBHFCGDIC( "LUA_MENU/MISSING_DLC_BR" ) )
end
...
CoD.GrantAllT9ItemsAction = function ( f8_arg0 )
	for f8_local6, f8_local7 in ipairs( CSV.itemSourceTable.fileList ) do
		for f8_local5 = 0, CSV.MultiTableGetRowCount( CSV.itemSourceTable.fileList, f8_local6 ), 1 do
			local f8_local3 = CSV.MultiFileReadRow( CSV.itemSourceTable, f8_local6, f8_local5 )
