...
ONBOARDING_DATA = {
	...
	GetOnboardingOperatorMissionsData = function ()
		return {
			...
			confirmButton = {
				action = function ( f128_arg0 )
					ACTIONS.LeaveMenu( f128_arg0 )
				end
	...
	GetOnboardingLoadoutData = function ()
		...
		if CONDITIONS.IsThirdGameMode() then
			f110_local4 = "onboarding_loadout_1"
		else
			f110_local4 = "onboarding_ch2_mw_only_edit_loadout_01"
		end
		f110_local3.image = f110_local4
		if CONDITIONS.IsThirdGameMode() then
			f110_local4 = "ONBOARDING/LOADOUT_1_CP"
		else
			f110_local4 = "ONBOARDING/EDITDROPKIT_MW_EDITLOADOUT_1"
		end
		f110_local3.desc = f110_local4
		f110_local2[1] = f110_local3
		f110_local3 = {}
		if CONDITIONS.IsThirdGameMode() then
			f110_local4 = "onboarding_loadout_2"
		else
			f110_local4 = "onboarding_ch2_mw_only_edit_loadout_02"
		end
		f110_local3.image = f110_local4
		if CONDITIONS.IsThirdGameMode() then
			f110_local4 = "ONBOARDING/LOADOUT_2_CP"
		else
			f110_local4 = "ONBOARDING/EDITDROPKIT_MW_EDITLOADOUT_2"
		end
		f110_local3.desc = f110_local4
		f110_local2[2] = f110_local3
		f110_local3 = {}
		if CONDITIONS.IsThirdGameMode() then
			f110_local4 = "onboarding_loadout_3"
		else
			f110_local4 = "onboarding_ch2_mw_only_edit_loadout_03"
		end
		f110_local3.image = f110_local4
		if CONDITIONS.IsThirdGameMode() then
			f110_local4 = "ONBOARDING/LOADOUT_3"
		else
			f110_local4 = "ONBOARDING/EDITDROPKIT_MW_EDITLOADOUT_3"
		end
		f110_local3.desc = f110_local4
		f110_local2[3] = f110_local3
		f110_local1.panelData = f110_local2
		f110_local1.confirmButton = {
			action = f110_local0
		}
		return f110_local1
	end,
	...
	GetOnboardingPerkUpdateData = function ()
		local f103_local0 = function ( f105_arg0 )
	...
	GetOnboardingMatureContentData = function ()
		return {
			...
			cancelButton = {
				...
				action = function ( f97_arg0, f97_arg1 )
					if LUI.FlowManager.IsInStack( "MainMenuOffline" ) then
						ACTIONS.RestoreMenu( "MainMenuOffline", true, f97_arg1 )
					else
						ACTIONS.RestoreMenu( "MainMenu", true, f97_arg1 )
					end
				end
	...
	GetPlunderTutorialData = function ( f77_arg0 )
		return {
	...
	GetOnboardingTDMData = function ( f75_arg0 )
		return {
	...
	GetOnboardingGunfightData = function ( f73_arg0 )
		return {
	...
	GetOnboardingMPMoshpitData = function ( f71_arg0 )
		return {
	...
	GetOnboardingTDMAnywhereData = function ( f55_arg0 )
		return {
	...
	GetOnboardingArmoredRoyaleData = function ( f53_arg0 )
		return {
	...
	GetOnboardingZombiesBRData = function ( f51_arg0 )
		return {
	...
	GetOnboardingRebirthOnboardingData = function ( f33_arg0 )
		return {
