...
LUI.Scoreboard.GetCurrentNumberOfPlayers = function ( f12_arg0, f12_arg1 )
	if not f12_arg0._teamIndex then
		return 0
	elseif f12_arg0._numPlayersFunc and not Engine[0x12586A3F4FB490E]() then
...
LUI.Scoreboard.SetNumberOfPlayersFunction = function ( f10_arg0, f10_arg1 )
	local f10_local0 = function ( f11_arg0 )
		return Game[0xC22F90682BB5BF5]( f11_arg0._teamIndex )
	end
...
LUI.Scoreboard.UpdateTeamCount = function ( f2_arg0, f2_arg1 )
	...
	local f2_local2 = f2_local1:GetValue( f2_arg0._controllerIndex )
	if Dvar[0x54084D7CA2317BB]( "#x3a30c33efc8281eb1" ) ~= "infect" or not f2_local2 then
		f2_local2 = f2_local2 / 2
	end
	if MLG[0x9894ED459E76619]() then
		f2_local0:SetAlpha( 0 )
	else
		f2_local0:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU/X_OF_Y", tostring( f2_arg1 ), tostring( f2_local2 ) ) )
	end
end
