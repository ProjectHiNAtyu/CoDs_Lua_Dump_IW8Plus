...
local f0_local0 = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	if f3_arg0.PlayerDetails then
		f3_arg0.PlayerDetails:EnableClanProgression()
	end
	local f3_local0 = Engine[0xED84C33EC5F01EA]( "LUA_MENU/CLAN_CAPS" )
	f3_arg0.GenericProgressionFullscreen:SetUp( f3_arg1, f3_arg2.progressionTypeData, f3_arg2.progressionData, f3_arg2.progressionTypeData.currentUnlockedLevel, Engine[0xED84C33EC5F01EA]( "CLANS/CLAN_PROGRESSION" ) )
...
function ClansProgression( menu, controller )
	local self = LUI.UIElement.new()
	self.id = "ClansProgression"
	local f1_local1
	if controller then
...
MenuBuilder.registerType( "ClansProgression", ClansProgression )
LockTable( _M )
