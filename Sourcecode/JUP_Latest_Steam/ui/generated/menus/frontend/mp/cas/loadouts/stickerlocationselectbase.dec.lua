...
local f0_local1 = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	f3_arg0.weaponModel = WEAPON.GetWeaponModel( f3_arg1, FrontEndScene.ClientWeapons.Preview, WEAPON.OffsetFiles.AttachmentData )
		...
		if f3_local5 ~= nil then
			for f3_local6 = LOADOUT.STICKER_1_SLOT, #f3_local5, 1 do
				...
				if String.IsNilOrEmpty( f3_local9 ) or f3_local9 == WEAPON.StickerNoneValue then
					f3_local4.stickers[f3_local6] = GUNSMITH.STICKER_PLACEMENT_STICKER_REFS[f3_local6]
				else
...
function StickerLocationSelectBase( f1_arg0, f1_arg1 )
	local f1_local0 = LUI
	local f1_local1 = f1_local0.UIMenu.new()
	f1_local1.id = "StickerLocationSelectBase"
	local f1_local2
	if f1_arg1 then
		f1_local2 = f1_arg1
	else
...
MenuBuilder.registerType( 0xFBB4B42EFC98346, StickerLocationSelectBase )
LockTable( _M )
