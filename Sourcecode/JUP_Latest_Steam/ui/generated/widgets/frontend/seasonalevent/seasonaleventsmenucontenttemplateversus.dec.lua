...
function SeasonalEventsMenuContentTemplateVersus( f1_arg0, f1_arg1 )
	local f1_local0 = LUI
	local f1_local1 = f1_local0.UIElement.new()
	f1_local1:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 1920, 0, 1080 )
	f1_local1.id = "SeasonalEventsMenuContentTemplateVersus"
	local f1_local2
	if f1_arg1 then
		f1_local2 = f1_arg1
	else
...
MenuBuilder.registerType( 0xEC9518D97D2A5F8, SeasonalEventsMenuContentTemplateVersus )
LockTable( _M )
