...
local f0_local0 = function ( f15_arg0, f15_arg1 )
	...
	for f15_local4, f15_local5 in pairs( f15_arg1 ) do
		f15_local0[f15_local4] = f15_local5
	end
	return f15_local0
end

MAIN_MENU.GetMainMenuId = function ()
	local f14_local0
	if CONDITIONS.IsMobileOrMobileSim() then
		f14_local0 = "MainMenuMobile"
	else
		f14_local0 = "MainMenu"
	end
	return f14_local0
...
MAIN_MENU.GetSubMainMenuId = function ()
	if CONDITIONS.IsMenuInStack( "MPMainMenu" ) then
		return "MPMainMenu"
	elseif CONDITIONS.IsMenuInStack( "CPMainMenu" ) then
		return "MPMainMenu"
	elseif CONDITIONS.IsMenuInStack( "BRMainMenu" ) then
		return "BRMainMenu"
	elseif CONDITIONS.IsMenuInStack( "DMZMainMenu" ) then
		return "DMZMainMenu"
	else
		return MAIN_MENU.GetMainMenuId()
	end
end
...
MAIN_MENU.GetFocusRow = function ( f8_arg0, f8_arg1, f8_arg2 )
	local f8_local0 = 1
	local f8_local1 = math.min( f8_local0 + 1, f8_arg2 )
	...
	if f8_local5 == f8_local0 and f8_local4 then
		f8_local5 = f8_local1
	end
	return f8_local5
end
...
MAIN_MENU.CrossTitleActionFunc = function ( f5_arg0, f5_arg1, f5_arg2, f5_arg3, f5_arg4 )
	...
	local f5_local1 = function ()
		DebugPrint( "CrossLaunching with title = " .. f5_arg0 .. ", mode = " .. f5_arg0 )
