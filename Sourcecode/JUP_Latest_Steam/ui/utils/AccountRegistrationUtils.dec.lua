...
REGISTRATION.UserNameRules = {
	[REGISTRATION.UserNameRuleIDs.LENGTH] = {
		...
		GetLocalizedString = function ()
			return Engine[0xED84C33EC5F01EA]( 0x24B5D4E20E81F20, REGISTRATION.UserNameRulesConstants.MIN_GLYPHS, REGISTRATION.UserNameRulesConstants.MAX_GLYPHS )
		end
	},
	[REGISTRATION.UserNameRuleIDs.ILLEGAL_CHARACTER] = {
		isPassing = false,
		GetLocalizedString = function ()
			return Engine[0xED84C33EC5F01EA]( 0x5282C87D0F432BD )
		end
	},
	...
	[REGISTRATION.UserNameRuleIDs.EMPTY_USERNAME] = {
		isPassing = false,
		GetLocalizedString = function ()
			return Engine[0xED84C33EC5F01EA]( 0x5079DA8771BEAF6 )
		end
	}
}
...
REGISTRATION.EmailRules = {
	[REGISTRATION.EmailRuleIDs.LENGTH] = {
		isPassing = false,
		GetLocalizedString = function ()
			return Engine[0xED84C33EC5F01EA]( 0xD3D18C53CA0D20, REGISTRATION.EmailRulesConstants.MIN_LENGTH, REGISTRATION.EmailRulesConstants.MAX_LENGTH )
		end
	},
	[REGISTRATION.EmailRuleIDs.MUST_CONTAIN_SYMBOLS] = {
		isPassing = false,
		GetLocalizedString = function ( f21_arg0 )
			local f21_local0 = {}
			for f21_local4, f21_local5 in ipairs( REGISTRATION.EmailRulesConstants.REQUIRED_SYMBOLS ) do
				if not CONDITIONS.IsMobileOrMobileSim() or not f21_arg0 or not f21_arg0:find( "[" .. f21_local5 .. "]" ) then
					table.insert( f21_local0, Engine[0x7D3158A9539A355]( "\"" .. f21_local5 .. "\"" ) )
				end
			end
			if 0 >= #f21_local0 or not f21_local0[1] then
				f21_local1 = ""
			end
			for f21_local2 = 2, #f21_local0, 1 do
				local f21_local6
				if f21_local2 == #f21_local0 then
					f21_local6 = 0xFFF4C7CC72AD177
					if not f21_local6 then
					
					else
						f21_local1 = Engine[0xED84C33EC5F01EA]( f21_local6, f21_local1, f21_local0[f21_local2] )
					end
				end
				f21_local6 = 0x77F573284F20E35
			end
			f21_local2 = Engine[0xED84C33EC5F01EA]
			if 1 < #f21_local0 then
				f21_local4 = 0xABD458E2C698CA1
				if not f21_local4 then
				
				else
					return f21_local2( f21_local4, f21_local1 )
				end
			end
			f21_local4 = 0x18E1A6EF7464628
		end
	}
}
...
REGISTRATION.PasswordRules = {
	[REGISTRATION.PasswordRuleIDs.LENGTH] = {
		isPassing = false,
		GetLocalizedString = function ()
			return Engine[0xED84C33EC5F01EA]( 0x31AC1EB2E6C3487, REGISTRATION.PasswordRulesConstants.MIN_GLYPHS, REGISTRATION.PasswordRulesConstants.MAX_GLYPHS )
		end
	},
	[REGISTRATION.PasswordRuleIDs.GLYPH_BYTE_LIMIT] = {
		isPassing = false,
		GetLocalizedString = function ()
			return Engine[0xED84C33EC5F01EA]( 0x31AC1EB2E6C3487, REGISTRATION.PasswordRulesConstants.MIN_GLYPHS, REGISTRATION.PasswordRulesConstants.MAX_GLYPHS )
		end
	...
	[REGISTRATION.PasswordRuleIDs.CHAR_NUMBER] = {
		isPassing = false,
		GetLocalizedString = function ()
			return Engine[0xED84C33EC5F01EA]( 0x843517D543B0D71 )
		end
	},
	[REGISTRATION.PasswordRuleIDs.SEQUENTIAL] = {
		isPassing = false,
		GetLocalizedString = function ()
			return Engine[0xED84C33EC5F01EA]( 0x9E949168A8AA088 )
		end
	},
	[REGISTRATION.PasswordRuleIDs.CONSECUTIVE] = {
		isPassing = false,
		GetLocalizedString = function ()
			return Engine[0xED84C33EC5F01EA]( 0xE8E6C7F765F6A57 )
		end
	}
}
...
REGISTRATION.CheckRulesOnUserName = function ( f9_arg0, f9_arg1, f9_arg2 )
...
REGISTRATION.CheckRulesOnEmail = function ( f8_arg0 )
	...
	REGISTRATION.EmailRules[REGISTRATION.EmailRuleIDs.MUST_CONTAIN_SYMBOLS].isPassing = true
	for f8_local5, f8_local6 in ipairs( REGISTRATION.EmailRulesConstants.REQUIRED_SYMBOLS ) do
		if not f8_arg0 or not f8_arg0:find( "[" .. f8_local6 .. "]" ) then
			REGISTRATION.EmailRules[REGISTRATION.EmailRuleIDs.MUST_CONTAIN_SYMBOLS].isPassing = false
			return 
		end
	end
end
...
REGISTRATION.CheckRulesOnPassword = function ( f7_arg0 )
	...
	REGISTRATION.PasswordRules[REGISTRATION.PasswordRuleIDs.GLYPH_BYTE_LIMIT].isPassing = #f7_arg0 <= REGISTRATION.PasswordRulesConstants.MAX_LENGTH
	local f7_local2 = 0
...
REGISTRATION.CheckRulesOnPasswordLogin = function ( f6_arg0 )
	...
	REGISTRATION.PasswordRulesLogin[REGISTRATION.PasswordRuleIDs.GLYPH_BYTE_LIMIT].isPassing = #f6_arg0 <= REGISTRATION.PasswordRulesConstants.MAX_LENGTH
end

REGISTRATION.CheckIsPassing = function ( f5_arg0, f5_arg1 )
	for f5_local3, f5_local4 in ipairs( f5_arg0 ) do
		if not f5_local4.isPassing then
			return false, f5_local4.GetLocalizedString( f5_arg1 )
		end
	end
	return true
end
...
REGISTRATION.UpdateEmail = function ( f3_arg0 )
	...
	DataSources.frontEnd.boot.emailVerification.playerEmail:SetValue( nil, f3_arg0 )
end
