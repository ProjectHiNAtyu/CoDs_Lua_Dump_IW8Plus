...
function FooterMouseIcon( f1_arg0, f1_arg1 )
	local f1_local0 = LUI
	...
	f1_local5:setImage( RegisterMaterial( 0x4C2E857C7F1B58E ), 0 )
...
MenuBuilder.registerType( 0xE6100447EEA7BC, FooterMouseIcon )
LockTable( _M )
