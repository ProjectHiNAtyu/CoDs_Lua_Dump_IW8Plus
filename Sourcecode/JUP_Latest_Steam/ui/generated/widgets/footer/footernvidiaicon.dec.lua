...
function FooterNVidiaIcon( f1_arg0, f1_arg1 )
	local f1_local0 = LUI
	...
	f1_local5:setImage( RegisterMaterial( 0x76EA83F3E96AF47 ), 0 )
...
MenuBuilder.registerType( 0xD66D0B3045CE8E0, FooterNVidiaIcon )
LockTable( _M )
