...
local f0_local1 = function ( f7_arg0, f7_arg1, f7_arg2, f7_arg3 )
	...
	if not WEAPON.SupportsOptics( f7_local2 ) then
		...
		local f7_local12 = LOOT.IsMWItem( {
			type = LOOT.itemTypes.WEAPON,
			ref = f7_local2
		} )
		if not ATTACHMENT.SupportsCustomReticles( f7_arg0.equippedOptic, f7_local12 ) or not f7_local12 and ATTACHMENT.IsDefaultScope( f7_arg0.equippedOptic ) then
	...
	elseif f7_local7 then
		...
		if f7_local7 == WEAPON.CharmNoneValue then
			...
			if not f7_local14 then
				...
				f7_arg0.CharmButton:UpdateBreadcrumb( LOOT.IsCategoryNew( f7_arg1, LOOT.itemTypes.CHARM, LOOT.GetItemGameSource( {
					type = LOOT.itemTypes.WEAPON,
					ref = f7_local2
				} ) ) )
			end
	...
	elseif f7_local8 then
		...
		f7_arg0.StickerButton:UpdateBreadcrumb( LOOT.IsCategoryNew( f7_arg1, LOOT.itemTypes.STICKER, LOOT.GetItemGameSource( {
			type = LOOT.itemTypes.WEAPON,
			ref = f7_local2
		} ) ) )
	end
