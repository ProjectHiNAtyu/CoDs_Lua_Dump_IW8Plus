...
local f0_local3 = function ( f13_arg0, f13_arg1, f13_arg2 )
	...
	if f13_local0 ~= nil and f13_local0 ~= "" then
		...
		f13_local2:SetPromptText( f13_local1 )
		f13_local2.id = f13_local0 .. "KBMButtonPrompt"
		local f13_local3 = f13_local2:GetCurrentAnchorsAndPositions()
		local f13_local4 = math.abs( f13_local3.right - f13_local3.left )
		f13_local2:SetPressAnimation()
...
local f0_local4 = function ( f12_arg0, f12_arg1 )
	...
	if f12_local0 ~= nil and f12_local0 ~= "" then
		...
		self:SetAnchorsAndPosition( 0, 1, 0.5, 0.5, 0, 0, -f0_local0, f0_local0 )
		self:SetAlignment( LUI.Alignment.Left )
		self:SetRGBFromTable( COLORS.white )
		self:SetFont( FONTS.GetFont( FONTS.MainRegular.File ) )
		self:SetFontSize( f0_local0 * 2 )
...
LUI.ButtonHelperTextTooltip.GetTooltipPromptsTotalWidth = function ( f6_arg0 )
	assert( f6_arg0._promptList )
	local f6_local0 = f6_arg0._promptList:getFirstChild()
	local f6_local1 = 0
	local f6_local2 = 0
	if f6_local0 then
	...
	return f6_local1 + f0_local0 * f6_local3
end
...
LUI.ButtonHelperTextTooltip.init = function ( f1_arg0, f1_arg1 )
	...
	local ButtonHelperContainer = f0_local0( f1_arg0 )
	f1_arg0:addElement( ButtonHelperContainer )
	f1_arg0.ButtonHelperContainer = ButtonHelperContainer
