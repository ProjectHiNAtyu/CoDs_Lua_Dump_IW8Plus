...
PERK.GetImage = function ( f28_arg0 )
	return StringTable.DIFCHIGDFB( CSV.perks.file, CSV.perks.cols.ref, f28_arg0, CSV.perks.cols.image )
end

PERK.GetProgressionImage = function ( f27_arg0 )
	return StringTable.DIFCHIGDFB( CSV.perks.file, CSV.perks.cols.ref, f27_arg0, CSV.perks.cols.progressionImage )
end

PERK.GetBWImage = function ( f26_arg0 )
	return StringTable.DIFCHIGDFB( CSV.perks.file, CSV.perks.cols.ref, f26_arg0, CSV.perks.cols.BWImage )
end

PERK.GetModel = function ( f25_arg0 )
	return StringTable.DIFCHIGDFB( CSV.perks.file, CSV.perks.cols.ref, f25_arg0, CSV.perks.cols.model )
end
