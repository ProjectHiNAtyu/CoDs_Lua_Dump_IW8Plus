...
function SocialShowcasePlayerCompare( f1_arg0, f1_arg1 )
	local f1_local0 = ACTIONS
	local f1_local1 = LUI
	local f1_local2 = MenuBuilder
	local f1_local3 = f1_local1.UIMenu.new()
	f1_local3.id = "SocialShowcasePlayerCompare"
	local f1_local4
	if f1_arg1 then
		f1_local4 = f1_arg1
	else
	...
	f1_local7[0x8B72E07B55C3AC0] = "TestLabel"
	f1_local7:setText( "Compare", 0 )
	...
	f1_local7:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 1920, 390, 540 )
	f1_local3:addElement( f1_local7 )
	f1_local3[0x275D8C10EC7A3D] = f1_local7
...
MenuBuilder.registerType( 0x9884FF8AC247361, SocialShowcasePlayerCompare )
LockTable( _M )
