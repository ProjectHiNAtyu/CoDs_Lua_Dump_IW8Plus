	...
	f13_local2.onComplete = function ()
		if f13_arg0._isSelected then
			...
			if f13_arg0._isZoomed then
				...
				f14_local2 = REG14 and Engine[0xED84C33EC5F01EA]( 0xB13E6056053E21D ) or Engine[0xED84C33EC5F01EA]( 0xFC9748BE6B8242E )
...
function LevelSelectMap( menu, controller )
	...
	self._sequences.UrzBlink = function ()
		menu:AnimateLoop( "UrzBlink", -1 )
	end
	
	self._sequenceLengths.UrzBlink = 1333
	...
	self._sequenceLengths.UrzHide = 0
	...
	self._sequenceLengths.UrzFocusStart = 200
	...
	self._sequences.UrzFocusLoop = function ()
		menu:AnimateLoop( "UrzFocusLoop", -1 )
	end
	
	self._sequenceLengths.UrzFocusLoop = 35000
	...
	self._sequenceLengths.UrzFocusEnd = 200
