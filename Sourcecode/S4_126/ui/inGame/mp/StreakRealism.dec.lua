...
local f0_local1 = function ( f7_arg0, f7_arg1, f7_arg2 )
	...
	local f7_local3 = function ()
		...
		local f11_local3 = f7_arg0:GetDataSource()
		f11_local3 = f11_local3.currentScore:GetValue( f7_arg0 )
	...
	f7_arg0.widgetAction = function ()
		Engine[0x6055C55456F05DF]( "streak_select", f7_arg0.streakIndex )
	end
...
function StreakRealism( menu, controller )
	...
	MinPipStreak:SetRGBFromTable( SWATCHES.highlight.vAllyHighlight, 0 )
	...
	self._sequenceLengths.MinPipShow = 700
	local f1_local6 = nil
