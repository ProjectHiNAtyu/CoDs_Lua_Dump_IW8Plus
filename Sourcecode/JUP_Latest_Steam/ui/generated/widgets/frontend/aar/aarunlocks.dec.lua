...
local f0_local9 = function ( f9_arg0, f9_arg1, f9_arg2 )
	if not f9_arg1 then
		...
		f9_local0:SetAnchorsAndPosition( 0, 1, 0, 1, -((f9_local2 + 1) * f0_local0), -(f9_local2 * f0_local0), f0_local0, f0_local0 + f0_local0, f9_arg2 )
		return 
	end
	for f9_local0 = 1, f9_arg0._rowCount, 1 do
		...
		f9_local3:SetAnchorsAndPosition( 0, 1, 0, 1, -((f9_local5 + 1) * f0_local0), -(f9_local5 * f0_local0), (f9_local0 - f9_local4) * f0_local0 + f0_local0, (f9_local0 - f9_local4 + 1) * f0_local0 + f0_local0, f9_arg2 )
	end
end
		...
		if f8_local5.startLevel ~= f8_local5.currentLevel then
			...
			for f8_local9 = f8_local5.startLevel + 1, f8_local5.currentLevel, 1 do
				...
				for f8_local13 = 1, #f8_local12, 1 do
					f8_local4[f8_local8][f8_local13] = AAR.GetUnlockData( f8_arg2, f8_local12[f8_local13][0x28887F70BF5EBA] )
				end
			...
			if 0 < f8_local8 then
				...
				for f8_local10 = 1, f8_local9, 1 do
					...
					for f8_local14 = 1, #f8_local13, 1 do
						f8_local4[f8_local8][f8_local14] = AAR.GetUnlockData( f8_arg2, f8_local13[f8_local14][0x28887F70BF5EBA] )
					end
				...
				f8_local10:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 1920, (f8_arg0._rowCount - 1) * f0_local0 + f0_local0, f8_arg0._rowCount * f0_local0 + f0_local0 )
...
local f0_local11 = function ( f7_arg0, f7_arg1, f7_arg2 )
	...
	for f7_local3 = f7_arg1.preRank + 1, f7_arg1.curRank, 1 do
		...
		f7_local2[f7_local1] = AAR.GetRankupUnlockPackage( f7_arg2, f7_local3, PROGRESSION.GetProgressionGameModes() )
	...
	for f7_local4 = 1, f7_local3, 1 do
		f7_local1 = f7_local1 + 1
		f7_local2[f7_local1] = AAR.GetRankupUnlockPackage( f7_arg2, f7_local0 + f7_local4, PROGRESSION.GetProgressionGameModes() )
	...
	f7_local4:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 1920, (f7_arg0._rowCount - 1) * f0_local0 + f0_local0, f7_arg0._rowCount * f0_local0 + f0_local0 )
...
local f0_local12 = function ( f6_arg0, f6_arg1, f6_arg2 )
	...
	for f6_local4 = 1, f6_local2, 1 do
		if f6_local0[f6_local4].type ~= Challenge.GetAEKindID( 0xB5B9F37D66C7E1A ) then
	...
	f6_local4:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 1920, (f6_arg0._rowCount - 1) * f0_local0 + f0_local0, f6_arg0._rowCount * f0_local0 + f0_local0 )
...
function AARUnlocks( f1_arg0, f1_arg1 )
	...
	local f1_local4 = nil
	f1_local4 = f1_local1.BuildRegisteredType( 0x5AA9EF831BF7A5B, {
		controllerIndex = f1_local3
	} )
	f1_local4[0x8B72E07B55C3AC0] = "AARUnlockDescription"
	f1_local4:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 1920, 25, 435 )
	f1_local2:addElement( f1_local4 )
	f1_local2[0x5AA9EF831BF7A5B] = f1_local4
	local f1_local5 = nil
	f1_local5 = f1_local0.UIImage.new()
	f1_local5[0x8B72E07B55C3AC0] = "Mask"
	f1_local5:setImage( RegisterMaterial( 0xBD4EDDE06081392 ), 0 )
	f1_local5:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 1920, 400, 1060 )
	f1_local2:addElement( f1_local5 )
	f1_local2[0xF375FA2CE7B1849] = f1_local5
	f0_local0( f1_local2, f1_local3, f1_arg1 )
	return f1_local2
end

MenuBuilder.registerType( 0xDFFFC1E9D33510C, AARUnlocks )
LockTable( _M )
