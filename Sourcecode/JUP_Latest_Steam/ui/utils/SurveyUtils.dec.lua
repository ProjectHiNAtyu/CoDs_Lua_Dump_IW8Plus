...
SURVEY.GetGameMode = function ()
	local f13_local0 = Engine[0xD36E3CAF4F0D8DB]()
	if f13_local0 == Enum[0xAC7E3CE067D9A9F][0x8A94A07B5502CF8] then
		return "mp"
	elseif f13_local0 == Enum[0xAC7E3CE067D9A9F][0x8A64607B54DF055] then
		return "br"
	elseif f13_local0 == Enum[0xAC7E3CE067D9A9F][0x8A23E07B549F9E6] then
		return "cp"
	elseif f13_local0 == Enum[0xAC7E3CE067D9A9F][0xAB52E18F478CE80] then
		return "dmz"
	elseif f13_local0 == Enum[0xAC7E3CE067D9A9F][0x8B06407B55677D4] then
		return "ob"
	else
		return ""
	end
...
SURVEY.SendSurveyDlogResponseEvent = function ( f12_arg0, f12_arg1, f12_arg2, f12_arg3 )
	Engine[0x15D98DF5F61904B]( f12_arg0, "dlog_event_client_survey_response_data", {
		name = f12_arg2.name,
		version = f12_arg2.version,
		survey_question = f12_arg2.question,
		survey_answer = f12_arg1,
		entry_point = f12_arg2.entryPoint,
		game_mode = f12_arg2.gameMode,
		is_quitter = f12_arg2.isQuitter,
		time_spent = f12_arg3
	} )
end

SURVEY.HandlePlayerSurveyResponded = function ( f11_arg0, f11_arg1, f11_arg2, f11_arg3, f11_arg4 )
	SURVEY.SendSurveyDlogResponseEvent( f11_arg0, f11_arg2, f11_arg3, f11_arg4 )
	Engine[0xAF7FB041D72A06E]( f11_arg0, 0, f11_arg1, f11_arg3.isQuitter )
end

SURVEY.HandlePlayerSurveyCanceled = function ( f10_arg0, f10_arg1, f10_arg2 )
	SURVEY.SendSurveyDlogResponseEvent( f10_arg0, "survey_cancelled", f10_arg1, f10_arg2 )
	Engine[0xAF7FB041D72A06E]( f10_arg0, 0, -1, f10_arg1.isQuitter )
end
...
SURVEY.IsSurveyEnabledForInGameMP = function ()
	return Dvar[0x9E5BE3B4BBA4E0E]( 0x2644DFF9AD0736E )
end
	...
	for f4_local15 = 0, f4_local9 - 1, 1 do
		...
		table.insert( f4_local14, {
			...
			action = function ( f6_arg0, f6_arg1 )
				SURVEY.HandlePlayerSurveyResponded( f6_arg0, f4_arg0, f4_arg0, f4_arg0, f6_arg1 )
			end
		} )
	end
	return {
		...
		onCancel = function ( f5_arg0, f5_arg1 )
			SURVEY.HandlePlayerSurveyCanceled( f5_arg0, f4_arg0, f5_arg1 )
		end
...
SURVEY.ShouldIgnoreCurrentGameMode = function ( f3_arg0 )
	if f3_arg0 ~= "" then
		...
		for f3_local1 = 1, table.getn( f3_local0 ), 1 do
			if f3_local0[f3_local1] == SURVEY.GetGameMode() then
				return false
			end
		end
		return true
