...
PostGameFanfare.advance = function ( f1_arg0 )
	if f1_arg0._state == nil then
		LUI.FlowManager.RequestLeaveMenuByName( GAMEMODE_SCRIPTBUNDLE_UTILS.GetAARMenuLuaName() or "AARContainer", true )
		return 
	end
	...
	if Engine[0x220CB915CEFC1FE]() and not Engine[0x8B495DC361731F7]( f1_local3 ) and CONDITIONS.IsMagmaEnabled() then
		if Dvar[0x9E5BE3B4BBA4E0E]( 0x9744FE656AB5E62 ) and Dvar[0x54084D7CA2317BB]( 0x65E9A96EB2FF62B ) ~= "br" then
