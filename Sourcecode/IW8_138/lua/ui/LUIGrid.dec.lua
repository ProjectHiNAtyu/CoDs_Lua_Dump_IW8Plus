...
local f0_local1 = function ( f116_arg0 )
	f116_arg0.DebugBackground = LUI.UIImage.new()
	f116_arg0.DebugBackground.id = "DebugBackground"
	f116_arg0.DebugBackground:SetRGBFromTable( {
		g = -8.679223792368794E+209,
		b = 4.667261640415006E-62,
		r = -9.255965340288647E+61
	} )
	f116_arg0:addEventHandler( "layout_initialized", function ( f119_arg0, f119_arg1 )
		f119_arg0.DebugBackground:addElementBefore( f119_arg0 )
	end )
	f116_arg0.DebugBackground._updateDebugBackgroundTimer = LUI.UITimer.new( {
		event = "debug_update_pos_and_size",
		interval = 32,
		eventTarget = f116_arg0
	} )
	f116_arg0.DebugBackground:addElement( f116_arg0.DebugBackground._updateDebugBackgroundTimer )
	f116_arg0:registerEventHandler( "debug_update_pos_and_size", function ( element, event )
		local f118_local0 = element:GetCurrentAnchorsAndPositions()
		if element.DebugBackground and element.DebugBackground:getParent() then
			element.DebugBackground:SetAnchorsAndPosition( f118_local0.leftAnchor, f118_local0.rightAnchor, f118_local0.topAnchor, f118_local0.bottomAnchor, f118_local0.left, f118_local0.right, f118_local0.top, f118_local0.bottom )
			element.DebugBackground:SetAlpha( element:GetAlpha() )
			element.DebugBackground:SetScale( element:GetScale() )
		end
	end )
	local f116_local0 = f116_arg0.closeTree
	f116_arg0.closeTree = function ( f117_arg0 )
		f116_arg0( f117_arg0 )
		f117_arg0.DebugBackground:closeTree()
		f117_arg0.DebugBackground = nil
	end
	
end

LUI.UIGrid.init = function ( f106_arg0, f106_arg1 )
	Engine.BHFFIBEFFH( "UIGrid", "widget" )
	assert( f106_arg1 )
	assert( type( f106_arg1.maxVisibleRows ) == "number" )
	assert( type( f106_arg1.maxVisibleColumns ) == "number" )
	local f106_local0 = assert
	local f106_local1
	if f106_arg1.buildChild ~= nil and type( f106_arg1.buildChild ) ~= "function" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	...
	f106_local0 = assert
	if f106_arg1.refreshChild ~= nil and type( f106_arg1.refreshChild ) ~= "function" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.measureRow ~= nil and type( f106_arg1.measureRow ) ~= "function" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.rowHeight ~= nil and type( f106_arg1.rowHeight ) ~= "number" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	f106_local1 = f106_arg1.rowHeight
	if not f106_local1 then
		f106_local1 = f106_arg1.measureRow
		if not f106_local1 then
			f106_local1 = not f106_arg1.buildChild
		end
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.measureColumn ~= nil and type( f106_arg1.measureColumn ) ~= "function" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.columnWidth ~= nil and type( f106_arg1.columnWidth ) ~= "number" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	f106_local1 = f106_arg1.columnWidth
	if not f106_local1 then
		f106_local1 = f106_arg1.measureColumn
		if not f106_local1 then
			f106_local1 = not f106_arg1.buildChild
		end
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.isPositionFocusable ~= nil and type( f106_arg1.isPositionFocusable ) ~= "function" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.wrapX ~= nil and type( f106_arg1.wrapX ) ~= "boolean" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.wrapY ~= nil and type( f106_arg1.wrapY ) ~= "boolean" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.spacingX ~= nil and type( f106_arg1.spacingX ) ~= "number" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.spacingY ~= nil and type( f106_arg1.spacingY ) ~= "number" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.horizontalAlignment ~= nil and type( f106_arg1.horizontalAlignment ) ~= "number" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.verticalAlignment ~= nil and type( f106_arg1.verticalAlignment ) ~= "number" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.defaultFocus ~= nil and type( f106_arg1.defaultFocus ) ~= "table" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.numRows ~= nil and type( f106_arg1.numRows ) ~= "number" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.numColumns ~= nil and type( f106_arg1.numColumns ) ~= "number" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.numChildren ~= nil and type( f106_arg1.numChildren ) ~= "number" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.scrollingThresholdX ~= nil and type( f106_arg1.scrollingThresholdX ) ~= "number" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.scrollingThresholdY ~= nil and type( f106_arg1.scrollingThresholdY ) ~= "number" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.maxVelocity ~= nil and type( f106_arg1.maxVelocity ) ~= "number" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.springCoefficient ~= nil and type( f106_arg1.springCoefficient ) ~= "number" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.primaryAxis ~= nil and type( f106_arg1.primaryAxis ) ~= "number" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.adjustSizeToContent ~= nil and type( f106_arg1.adjustSizeToContent ) ~= "boolean" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.alwaysSnap ~= nil and type( f106_arg1.alwaysSnap ) ~= "boolean" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.disableMouseWheel ~= nil and type( f106_arg1.disableMouseWheel ) ~= "boolean" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.arrowsEnabled ~= nil and type( f106_arg1.arrowsEnabled ) ~= "boolean" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.widgetsAlwaysVisible ~= nil and type( f106_arg1.widgetsAlwaysVisible ) ~= "boolean" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.directionalInputEnabled ~= nil and type( f106_arg1.directionalInputEnabled ) ~= "boolean" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.buildArrowsLabel ~= nil and type( f106_arg1.buildArrowsLabel ) ~= "boolean" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.arrowsVerticalOffset ~= nil and type( f106_arg1.arrowsVerticalOffset ) ~= "number" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.alwaysTrapMouseWheel ~= nil and type( f106_arg1.alwaysTrapMouseWheel ) ~= "boolean" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_local0 = assert
	if f106_arg1.countFunction ~= nil and type( f106_arg1.countFunction ) ~= "function" then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	f106_arg1.adjustSizeToContent = f106_arg1.adjustSizeToContent == true
	f106_arg1.spacingX = f106_arg1.spacingX or 0
	f106_arg1.spacingY = f106_arg1.spacingY or 0
	f106_arg1.maxVelocity = f106_arg1.maxVelocity or 5000
	f106_arg1.springCoefficient = f106_arg1.springCoefficient or 400
	f106_arg1.arrowsVerticalOffset = f106_arg1.arrowsVerticalOffset or f106_arg1.spacingY
	if not f106_arg1.primaryAxis then
		if f106_arg1.maxVisibleColumns == 1 and 1 < f106_arg1.maxVisibleRows then
			f106_arg1.primaryAxis = LUI.DIRECTION.vertical
		else
			f106_arg1.primaryAxis = LUI.DIRECTION.horizontal
		end
	end
	f106_local0 = assert
	if f106_arg1.primaryAxis ~= LUI.DIRECTION.horizontal and f106_arg1.primaryAxis ~= LUI.DIRECTION.vertical then
		f106_local1 = false
	else
		f106_local1 = true
	end
	f106_local0( f106_local1 )
	LUI.UIGrid.super.init( f106_arg0 )
	f106_arg0.id = "UIGrid"
	f106_arg0._controllerIndex = f106_arg1.controllerIndex
	f106_arg0._isPositionFocusable = f106_arg1.isPositionFocusable
	f106_arg0._rowHeight = f106_arg1.rowHeight
	f106_arg0._columnWidth = f106_arg1.columnWidth
	f106_arg0._spacingX = f106_arg1.spacingX
	f106_arg0._spacingY = f106_arg1.spacingY
	f106_arg0._wrapX = f106_arg1.wrapX or false
	f106_arg0._wrapY = f106_arg1.wrapY or false
	f106_arg0._defaultFocus = f106_arg1.defaultFocus or nil
	f106_arg0._scrollingThresholdX = f106_arg1.scrollingThresholdX or 1
	f106_arg0._scrollingThresholdY = f106_arg1.scrollingThresholdY or 1
	f106_arg0._scrollingThresholdPixelX = f106_arg1.scrollingThresholdPixelX or 0
	f106_arg0._scrollingThresholdPixelY = f106_arg1.scrollingThresholdPixelY or 0
	f106_arg0._permittedQualifiers = f106_arg1.permittedQualifiers or {}
	f106_arg0._horizontalAlignment = f106_arg1.horizontalAlignment
	f106_arg0._verticalAlignment = f106_arg1.verticalAlignment
	f106_arg0._alwaysSnap = f106_arg1.alwaysSnap == true
	f106_arg0._disableMouseWheel = f106_arg1.disableMouseWheel
	f106_arg0._arrowsEnabled = f106_arg1.arrowsEnabled ~= false
	f106_arg0._widgetsAlwaysVisible = f106_arg1.widgetsAlwaysVisible or false
	f106_arg0._directionalInputEnabled = f106_arg1.directionalInputEnabled ~= false
	f106_arg0._alwaysTrapMouseWheel = f106_arg1.alwaysTrapMouseWheel or false
	f106_arg0._buildChild = f106_arg1.buildChild
	f106_arg0._onNewTargetFocusPosition = f106_arg1.onNewTargetFocusPosition or nil
	f106_arg0._arrows = {}
	f106_arg0._itemNumbers = {}
	f106_arg0._scrollbars = {}
	f106_arg0._mouseWheelScrollingVerticalOffsetPx = f106_arg1.mouseWheelScrollingOffsetPx or 16
	f106_arg0._mouseWheelScrollingHorizontalOffsetPx = f106_arg1.mouseWheelScrollingOffsetPx or 56
	f106_arg0._showNumbersAndArrowsKBM = false
	f106_arg0._updateArrowVisibilityOnRefresh = true
	f106_arg0._countFunction = f106_arg1.countFunction or nil
	if Engine.BHICADFIHA() then
		f106_arg0._refreshChild = f106_arg1.refreshChild
		f106_arg0._isGrid = true
	end
	f106_arg0:registerEventHandler( "position_visible", function ( element, event )
	...
	f106_arg0:registerEventHandler( "restore_focus", f106_arg0.restoreFocus )
	f106_arg0:registerEventHandler( "gain_focus", function ( element, event )
		return element:GainFocus( event )
	end )
	f106_arg0:registerEventHandler( "lose_focus", function ( element, event )
		return element:LoseFocus( event )
	end )
	f106_arg0:registerEventHandler( "gamepad_button", function ( element, event )
		return element:GamepadButton( event )
	end )
	f106_arg0:registerEventHandler( "update_input_type", LUI.UIGrid.UpdateNumbersArrowsAndScrolling )
	f106_arg0:registerEventHandler( "grid_size_updated", function ( element, event )
		element:UpdateNumbersArrowsAndScrolling()
	end )
	f106_arg0:registerEventHandler( "ensure_line_visible", function ( element, event )
		element:EnsureLineVisible( event.direction, event.line, event.force )
	end )
	if Engine.EABCCIBFIG() then
		f106_arg0:addEventHandler( "update_current_grid_focus", function ( f109_arg0, f109_arg1 )
			local f109_local0, f109_local1 = f109_arg0:GetChildPosition( f109_arg1.child )
			if f109_arg1.focusType == FocusType.MouseOver and f109_local0 and f109_local1 then
				local f109_local2, f109_local3 = f109_arg0:GetColumnBoundaries()
				local f109_local4, f109_local5 = f109_arg0:GetRowBoundaries()
				if f109_local2 and f109_local4 then
					f109_local0 = LUI.clamp( f109_local0, f109_local2, f109_local3 )
					f109_local1 = LUI.clamp( f109_local1, f109_local4, f109_local5 )
				end
			end
			local f109_local2 = f109_arg0._targetPosition
			if f109_local2 then
				if f109_arg0._targetPosition.x ~= f109_local0 or f109_arg0._targetPosition.y ~= f109_local1 then
					f109_local2 = false
				else
					f109_local2 = true
				end
			end
			if not f109_local2 and f109_local0 and f109_local1 then
				f109_arg0._targetPosition = {
					x = f109_local0,
					y = f109_local1
				}
				f109_arg0._childInFocus = f109_arg0:GetElementAtPosition( f109_local0, f109_local1 )
				f109_arg0:PositionChanged()
				f109_arg0._shouldFocus = true
				f109_arg0:FocusChanged( f109_arg1.focusType )
			end
		end )
	end
	f106_arg0:SetHandleMouse( true )
	f106_arg0:OverrideMouseCursorType( MouseCursorType.CURSOR_TYPE_ARROW_NORMAL )
	f106_arg0:registerEventHandler( "mousedown", function ()
		return true
	end )
	f106_arg0:registerEventHandler( "mouseup", function ()
		return true
	end )
	f106_arg0:SetupUIGrid( f106_arg1 )
	if f106_arg1.buildArrowsLabel then
		f106_arg0:BuildGridCountArrows( nil, f106_arg1.arrowsVerticalOffset )
	end
...
LUI.UIGrid.SetScrollingThreshold = function ( f105_arg0, f105_arg1, f105_arg2 )
	local f105_local0
	if not f105_arg1 then
		f105_local0 = f105_arg1
	else
		f105_local0 = f105_arg0._scrollingThresholdX
	end
	f105_arg0._scrollingThresholdX = f105_local0
	if not f105_arg2 then
		f105_local0 = f105_arg2
	else
		f105_local0 = f105_arg0._scrollingThresholdY
	end
	f105_arg0._scrollingThresholdY = f105_local0
end

LUI.UIGrid.GetSpacingX = function ( f104_arg0 )
	return f104_arg0._spacingX
end

LUI.UIGrid.GetSpacingY = function ( f103_arg0 )
	return f103_arg0._spacingY
end

LUI.UIGrid.GetRowHeight = function ( f102_arg0 )
	return f102_arg0._rowHeight
end

LUI.UIGrid.GetColumnWidth = function ( f101_arg0 )
	return f101_arg0._columnWidth
end

LUI.UIGrid.SetRefreshChild = function ( f100_arg0, f100_arg1 )
	if Engine.BHICADFIHA() then
		f100_arg0._refreshChild = f100_arg1
	end
	f100_arg0:SetRefreshChildInC( f100_arg1 )
end

LUI.UIGrid.ColumnRowToPrimarySecondary = function ( f99_arg0, f99_arg1, f99_arg2 )
	if f99_arg0:GetPrimaryAxis() == LUI.DIRECTION.horizontal then
		return f99_arg1, f99_arg2
	else
		return f99_arg2, f99_arg1
	end
end

LUI.UIGrid.PrimarySecondaryToColumnRow = function ( f98_arg0, f98_arg1, f98_arg2 )
	if f98_arg0:GetPrimaryAxis() == LUI.DIRECTION.horizontal then
		return f98_arg1, f98_arg2
	else
		return f98_arg2, f98_arg1
	end
end

LUI.UIGrid.SetNumChildren = function ( f97_arg0, f97_arg1, f97_arg2 )
	if f97_arg0.maxAllocatedChildren then
		assert( f97_arg1 <= f97_arg0.maxAllocatedChildren, "LUIGrid: Trying to set more than the max number of allowed children." )
	end
	if f97_arg2 and f97_arg2.shouldRemoveExcessChildren then
		f97_arg0.maxAllocatedChildren = f97_arg1
		local f97_local0 = f97_arg0:GetBuiltChildren()
		local f97_local1 = #f97_local0
		if 0 < f97_local1 - f97_arg1 then
			for f97_local2 = f97_local1, f97_arg1 + 1, -1 do
				local f97_local5 = f97_local0[f97_local2]
				f97_arg0:RemoveElement( f97_local5 )
				f97_local5:closeTree()
				f97_local5 = nil
			end
		end
		f97_arg0:SetNumChildrenInC( f97_arg1, f97_arg2.shouldRemoveExcessChildren )
	else
		f97_arg0:SetNumChildrenInC( f97_arg1 )
	end
	if f97_arg0._targetPosition then
		...
		f97_arg0:SetTargetColumnToDefault()
		f97_arg0:SetTargetRowToDefault()
	end
end

LUI.UIGrid.SetNumColumns = function ( f96_arg0, f96_arg1 )
	f96_arg0:SetNumColumnsInC( f96_arg1 )
	if f96_arg0._targetPosition then
		if f96_arg0._shouldFocus then
			f96_arg0:SetFocusedPosition( f96_arg0._targetPosition, true )
		else
			f96_arg0:SetPosition( f96_arg0._targetPosition, true )
		end
	else
		f96_arg0:SetTargetColumnToDefault()
	end
end

LUI.UIGrid.SetNumRows = function ( f95_arg0, f95_arg1 )
	f95_arg0:SetNumRowsInC( f95_arg1 )
	if f95_arg0._targetPosition then
		if f95_arg0._shouldFocus then
			f95_arg0:SetFocusedPosition( f95_arg0._targetPosition, true )
		else
			f95_arg0:SetPosition( f95_arg0._targetPosition, true )
		end
	else
		f95_arg0:SetTargetRowToDefault()
	end
end

LUI.UIGrid.EnsureLineVisible = function ( f94_arg0, f94_arg1, f94_arg2, f94_arg3 )
	local f94_local0 = assert
	local f94_local1
	if (f94_arg1 ~= LUI.DIRECTION.vertical or f94_arg0._verticalAlignment ~= LUI.Alignment.Top and f94_arg0._verticalAlignment ~= nil) and (f94_arg1 ~= LUI.DIRECTION.horizontal or f94_arg0._horizontalAlignment ~= LUI.Alignment.Left and f94_arg0._horizontalAlignment ~= nil) then
		f94_local1 = false
	else
		f94_local1 = true
	end
	f94_local0( f94_local1 )
	f94_local0, f94_local2, f94_local1 = nil
	if f94_arg1 == LUI.DIRECTION.horizontal then
		f94_local0 = f94_arg0.SetTargetColumn
		f94_local2 = f94_arg0.GetColumnBoundaries
		f94_local1 = f94_arg0.ComputeColumnLeftFromRight
	else
		f94_local0 = f94_arg0.SetTargetRow
		f94_local2 = f94_arg0.GetRowBoundaries
		f94_local1 = f94_arg0.ComputeRowTopFromBottom
	end
	local f94_local3, f94_local4 = f94_local2( f94_arg0 )
	local f94_local5 = false
	if f94_arg2 < f94_local3 then
		f94_local0( f94_arg0, f94_arg2, true, false )
		f94_local5 = true
	elseif f94_local4 < f94_arg2 then
		f94_local0( f94_arg0, f94_local1( f94_arg0, f94_arg2 ), true, false )
		f94_local5 = true
	end
	if not f94_local5 and f94_arg3 then
		f94_local0( f94_arg0, f94_arg2, true, false )
		f94_local5 = true
	end
	if f94_local5 then
		f94_arg0:UpdateNumbersArrowsAndScrolling()
	end
end

LUI.UIGrid.HandleScrollbarDrag = function ( f93_arg0, f93_arg1 )
	local f93_local0 = f93_arg1.scrollbar
	if f93_arg1.dragStart or not f93_arg0._dragTargetRef then
		f93_arg0._dragTargetRef = {
			x = f93_arg1.targetX,
			y = f93_arg1.targetY
		}
	end
	local f93_local1 = f93_arg1.targetX - f93_arg0._dragTargetRef.x
	local f93_local2 = f93_arg1.targetY - f93_arg0._dragTargetRef.y
	if f93_local1 == 0 and f93_local2 == 0 then
		return false
	end
	local f93_local3 = f93_arg0:GetContentSize( f93_local0:GetDirection() )
	if f93_local3 and 0 < f93_local3 then
		if f93_local0:GetDirection() == LUI.DIRECTION.vertical then
			local f93_local4 = f93_local2 * f93_local3
			local f93_local5, f93_local6 = f93_arg0:GetRowBoundaries()
			local f93_local7 = f93_arg0
			local f93_local8 = f93_arg0.ConvertRowPixelToLine
			local f93_local9
			if 0 <= f93_local4 and not f93_local6 then
				f93_local9 = f93_local6
			else
				f93_local9 = f93_local5
			end
			f93_local8 = f93_local8( f93_local7, f93_local9, f93_local4 )
			f93_arg0:SetPositionInternal( {
				x = f93_arg0:GetTargetColumn(),
				y = f93_local8,
				x = f93_arg0:GetTargetColumn(),
				y = f93_local8
			}, true, false, false )
		else
			local f93_local4 = f93_local1 * f93_local3
			local f93_local5, f93_local6 = f93_arg0:GetColumnBoundaries()
			local f93_local7 = f93_arg0
			local f93_local8 = f93_arg0.ConvertColumnPixelToLine
			local f93_local9
			if 0 <= f93_local4 and not f93_local6 then
				f93_local9 = f93_local6
			else
			...
			f93_arg0:SetPositionInternal( {
				x = f93_local8,
				y = f93_arg0:GetTargetRow(),
				x = f93_local8,
				y = f93_arg0:GetTargetRow()
			}, true, false, false )
		end
		f93_arg0:UpdateScrolling()
		f93_arg0._dragTargetRef = {
			x = f93_arg1.targetX,
			y = f93_arg1.targetY
		}
...
LUI.UIGrid.HandleScrollbarSet = function ( f92_arg0, f92_arg1 )
	if f92_arg1.scrollbar:GetDirection() == LUI.DIRECTION.vertical then
		f92_arg0:SetPositionInternal( {
			x = f92_arg0:GetTargetColumn(),
			y = f92_arg0:ConvertRowPixelToLine( 0, (f92_arg0:GetContentSize( LUI.DIRECTION.vertical ) or 1) * f92_arg1.targetY )
		}, true )
	else
		f92_arg0:SetPositionInternal( {
			x = f92_arg0:ConvertColumnPixelToLine( 0, (f92_arg0:GetContentSize( LUI.DIRECTION.horizontal ) or 1) * f92_arg1.targetX ),
			y = f92_arg0:GetTargetRow()
		}, true )
	end
end

LUI.UIGrid.AddScrollbar = function ( f89_arg0, f89_arg1 )
	if f89_arg1._slider then
		f89_arg1._slider.mouseWheelTarget = f89_arg0
	elseif f89_arg1._fixedSizeSlider then
		f89_arg1._fixedSizeSlider.mouseWheelTarget = f89_arg0
	end
	f89_arg1:LinkTo( f89_arg0 )
	f89_arg0:SetHandleMouseMove( true )
	table.insert( f89_arg0._scrollbars, f89_arg1 )
	f89_arg0:SetNotifyOnLayoutInit( true )
	if not f89_arg1._customScrolling then
		f89_arg0:registerEventHandler( "scrollbar_previous", function ( element, event )
		...
		f89_arg0:registerEventHandler( "scrollbar_next", function ( element, event )
			if event.scrollbar:GetDirection() == LUI.DIRECTION.vertical then
				element:Scroll( "down" )
			else
		...
		f89_arg0:registerEventHandler( "scrollbar_drag", f89_arg0.HandleScrollbarDrag )
		f89_arg0:registerEventHandler( "scrollbar_set", f89_arg0.HandleScrollbarSet )
	end
end

LUI.UIGrid.SetArrowsEnabled = function ( f88_arg0, f88_arg1 )
	f88_arg0._arrowsEnabled = f88_arg1
end

LUI.UIGrid.SetWidgetsAlwaysVisible = function ( f87_arg0, f87_arg1 )
	f87_arg0._widgetsAlwaysVisible = f87_arg1
end

LUI.UIGrid.SetWraps = function ( f86_arg0, f86_arg1, f86_arg2 )
	if f86_arg1 ~= nil then
		f86_arg0._wrapX = f86_arg1
	end
	if f86_arg2 ~= nil then
		f86_arg0._wrapY = f86_arg2
	end
end
...
LUI.UIPeekingGrid.ScrollAmount = function ( f6_arg0, f6_arg1, f6_arg2 )
	if f6_arg1 == "up" or f6_arg1 == "down" then
		...
		elseif f6_arg1 == "down" then
			f6_local2 = f6_local2 + f6_arg2
			if f6_arg0._targetPosition.y == f6_local2 then
