...
FenceInstall.UpdateState = function ( f5_arg0 )
	...
	local f5_local0, f5_local1 = Engine.BJCCIACEHG()
...
function FenceStreamingInstall( f3_arg0, f3_arg1 )
	assert( f3_arg1 )
	f3_arg1.message = Engine.CBBHFCGDIC( "MENU/STREAMING_INSTALL_IN_PROGRESS" )
	...
	self:registerEventHandler( "update_streaming_bar", function ( self, event )
		local f4_local0, f4_local1 = Engine.BJCCIACEHG()
