...
function InitLFPDataSources()
	local f16_local0 = function ( f18_arg0, f18_arg1 )
		...
		return f18_local0:GetValue( f18_arg0 )
	end
	
	local f16_local1 = function ( f17_arg0, f17_arg1, f17_arg2 )
		local f17_local0 = LUI.DataSourceInGlobalModel.new( METRICS.LFP_DATASOURCE_PATH .. f17_arg1 )
		return f17_local0:SetValue( f17_arg0, f17_arg2 )
	end
	
	DataSources.frontEnd.lfpPartyInstrumentation.GetLFPValue = f16_local0
	DataSources.frontEnd.lfpPartyInstrumentation.SetLFPValue = f16_local1
end
