...
local f0_local0 = function ( f3_arg0, f3_arg1, f3_arg2 )
	f3_arg0.MenuTitle:SetTitle( Engine.CBBHFCGDIC( "CODCASTER/KEYBOARD_SHORTCUTS" ) )
...
function CodcasterKeyboardMenu( menu, controller )
	...
	MenuTitle.MenuTitle:setText( ToUpperCase( Engine.CBBHFCGDIC( "CODCASTER/KEYBOARD_SHORTCUTS" ) ), 0 )
	...
	CodcasterKeyboardShortcuts:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 324, _1080p * 1596, _1080p * 177, _1080p * 902 )
