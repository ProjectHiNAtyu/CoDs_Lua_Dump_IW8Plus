...
function HeadquartersLeaderboardButton( menu, controller )
	...
	TitleBackground:SetAnchorsAndPosition( 0, 1, 0, 1, 0, _1080p * -3.1, 0, _1080p * 24 )
	...
	Title.id = "Title"
	Title:setText( ToUpperCase( Engine[0xED84C33EC5F01EA]( 0x7B4A1A762741CD6 ) ), 0 )
	...
	if not CONDITIONS.IsLeaderboardsKillswitched( self ) then
		...
		f1_local7.id = "TrophyIcon"
		f1_local7:setImage( RegisterMaterial( "icon_barracks_trophy" ), 0 )
		f1_local7:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 160.45, _1080p * 334.45, _1080p * 49.3, _1080p * 223.3 )
		self:addElement( f1_local7 )
		self.TrophyIcon = f1_local7
	end
