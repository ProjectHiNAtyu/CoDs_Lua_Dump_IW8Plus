...
local f0_local2 = function ( f7_arg0, f7_arg1 )
	...
	f7_arg0.Tabs:SetAnchorsAndPosition( 0, 1, 0, 1, 295, 1192, 54, 105 )
...
MenuBuilder.registerType( 0xC280CB8D6688763, WorldMap )
LUI.FlowManager.RegisterStackPushBehaviour( 0xC280CB8D6688763, f0_local1 )
LUI.FlowManager.RegisterStackPopBehaviour( 0xC280CB8D6688763, f0_local0 )
LockTable( _M )
