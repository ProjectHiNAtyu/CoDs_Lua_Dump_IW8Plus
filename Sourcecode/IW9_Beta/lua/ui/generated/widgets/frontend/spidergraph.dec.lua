...
local f0_local9 = function ( f7_arg0, f7_arg1, f7_arg2 )
	...
	for f7_local1 = 1, #f7_local0, 1 do
		...
		elseif f7_arg2 == f0_local0.LINE1 then
			...
			local f7_local16 = (f7_local12 + f7_local5) / 2
			f7_local4:SetRGBFromTable( Color.HSVToRGB( f0_local0 * f7_local16, f0_local0 * f7_local16 * f7_local16, f0_local0 ) )
			f7_local4:SetAlpha( 0.8 )
		elseif f7_arg2 == f0_local0.LINE2 then
			local f7_local15 = math.sqrt( f7_arg0._points[f7_local1].x * f7_arg0._points[f7_local1].x + f7_arg0._points[f7_local1].y * f7_arg0._points[f7_local1].y )
			local f7_local17 = f7_arg0._points[f7_local1].x / f7_local15
			local f7_local18 = f7_arg0._points[f7_local1].y / f7_local15
			local f7_local16 = math.sqrt( f7_arg0._points[f7_local11].x * f7_arg0._points[f7_local11].x + f7_arg0._points[f7_local11].y * f7_arg0._points[f7_local11].y )
			f7_local4:SetTriangleVerts( f7_local13 + f7_arg0._points[f7_local11].x / f7_local16 * f0_local0 + f7_local7, f7_local14 + f7_arg0._points[f7_local11].y / f7_local16 * f0_local0 + f7_local8, f7_local9 + f7_local17 * f0_local0 + f7_local7, f7_local10 + f7_local18 * f0_local0 + f7_local8, f7_local13 + f7_local7, f7_local14 + f7_local8 )
			local f7_local19 = (f7_local12 + f7_local5) / 2
			f7_local4:SetRGBFromTable( Color.HSVToRGB( f0_local0 * f7_local19, f0_local0 * f7_local19 * f7_local19, f0_local0 ) )
			f7_local4:SetAlpha( 0.8 )
		end
