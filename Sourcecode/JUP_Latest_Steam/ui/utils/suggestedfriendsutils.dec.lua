...
local f0_local8 = function ( f13_arg0, f13_arg1 )
	...
	if f13_arg1 == f0_local0.MutualFriends then
		f13_local0.mutualFriendsCount = Social[0xCAEB442C1068A40]( f13_arg0, false ) or 0
	end
	return f13_local0
end
...
local f0_local11 = function ( f10_arg0 )
	...
	for f10_local2 = 1, #f10_local0, 1 do
		...
		local f10_local6 = math.min( #f10_local5, f0_local0 )
		for f10_local7 = 1, f10_local6, 1 do
			if f0_local0( f10_local5[f10_local7], f10_local0[f10_local2].reasonCode, f10_arg0 ) and f0_local0 <= f10_local6 + 1 then
...
local f0_local13 = function ( f8_arg0 )
	...
	local f8_local1 = Social[0xC57868DE2B09F52]( f8_arg0 )
...
local f0_local14 = function ( f7_arg0 )
	if f0_local0 <= Table.CountKeys( f0_local0[f7_arg0] ) then
		return 
	end
	local f7_local0 = Social[0x78EFF3CEBEB804E]( f7_arg0, f0_local0 )
	for f7_local4, f7_local5 in ipairs( f7_local0.players or {} ) do
		if f0_local0( f7_local5, f0_local0.MetOnMatch, f7_arg0 ) and f0_local0 <= REG1 + 1 then
			break
		end
	end
end
...
local f0_local16 = function ( f5_arg0 )
