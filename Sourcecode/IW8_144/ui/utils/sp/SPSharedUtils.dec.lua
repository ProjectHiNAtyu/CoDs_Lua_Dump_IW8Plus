...
SPSharedUtils.ShaderPreloadWrap = function ( f8_arg0 )
	local f8_local0 = Dvar.IBEGCHEFE( "killswitch_sp_shader_loading_block" )
	if not f8_local0 then
		f8_local0 = Dvar.IBEGCHEFE( "MQQOKSOPL" )
	end
	if f8_local0 then
...
SPSharedUtils.GetHighestDifficultyForLevel = function ( f7_arg0, f7_arg1 )
	assert( f7_arg1 )
	local f7_local0 = SPSharedUtils.Difficulties[Engine.EAIJDCADAJ( StringTable.DIFCHIGDFB( CSV.levels.file, CSV.levels.cols.name, f7_arg0, CSV.levels.cols.ref ), f7_arg1 )]
...
SPSharedUtils.GetHighestCollateralRankForLevel = function ( f6_arg0, f6_arg1 )
	assert( f6_arg1 )
	local f6_local0 = PlayerData.BFFBGAJGD( f6_arg1, 0 )
...
SPSharedUtils.GetMissionStateForLevel = function ( f5_arg0, f5_arg1 )
	local f5_local0 = PlayerData.BFFBGAJGD( f5_arg1, CoD.ProgressionBlob.Gold )
