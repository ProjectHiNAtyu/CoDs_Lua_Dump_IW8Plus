	...
	f6_arg0:SubscribeToModelThroughElement( f6_arg0, "challengeInfo.isCompleted", function ()
		...
		if f7_local0.challengeInfo.isCompleted:GetValue( f6_arg0 ) ~= nil and f7_local0.challengeInfo.isCompleted:GetValue( f6_arg0 ) == false then
			...
			if f7_local0.challengeInfo.tierCount:GetValue( f6_arg0 ) ~= nil then
				...
				f6_arg0( Engine[0xED84C33EC5F01EA]( "LUA_MENU/UNLOCK_MAX_TIER" ) )
			else
				f6_arg0( "" )
			end
		end
...
function CallingCardImage( menu, controller )
	...
	LockStatusLabel:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU/UNLOCK_MAX_TIER" ), 0 )
	LockStatusLabel:SetFont( FONTS.GetFont( FONTS.MainRegularHeader.File ) )
	LockStatusLabel:SetFontSize( 22 * _PT )
	LockStatusLabel:SetMinFontSize( 16 * _PT )
	...
	self._sequenceLengths.ShowLockedStatus = 0
