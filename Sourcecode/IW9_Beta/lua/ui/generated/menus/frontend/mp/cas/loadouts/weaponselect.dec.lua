...
States = {
	[0xAD14C6E7156B923] = function ( f7_arg0, f7_arg1 )
		...
		f7_arg0.WeaponsGrid:RegisterAnimationSequence( "Frontend", {
			{
				duration = 0,
		...
		f7_arg0.WeaponAttributes:RegisterAnimationSequence( "Frontend", {
			{
				duration = 0,
		...
		f7_arg0.InfoPanel:RegisterAnimationSequence( "Frontend", {
			{
				duration = 0,
				property = TWEEN_PROPERTY.Left,
				value = _1080p * 720
		...
		local f7_local1 = function ( f12_arg0, f12_arg1 )
			f12_arg0.WeaponsGrid:AnimateSequence( "Frontend" )
			f12_arg0.WeaponAttributes:AnimateSequence( "Frontend" )
			f12_arg0.InfoPanel:AnimateSequence( "Frontend" )
		end
		
		f7_arg0.WeaponsGrid:RegisterAnimationSequence( "InGame", {
			{
				duration = 0,
				property = TWEEN_PROPERTY.Left,
				value = _1080p * -843
		...
		f7_arg0.ArrowUp:RegisterAnimationSequence( "InGame", {
			{
				duration = 0,
				property = TWEEN_PROPERTY.Left,
				value = _1080p * -764
		...
		f7_arg0.ArrowDown:RegisterAnimationSequence( "InGame", {
			{
				duration = 0,
				property = TWEEN_PROPERTY.Left,
				value = _1080p * -596
		...
		f7_arg0.ListCount:RegisterAnimationSequence( "InGame", {
			{
				duration = 0,
				property = TWEEN_PROPERTY.Left,
				value = _1080p * -732
		...
		local f7_local2 = function ( f11_arg0, f11_arg1 )
			f11_arg0.WeaponsGrid:AnimateSequence( "InGame" )
			f11_arg0.ArrowUp:AnimateSequence( "InGame" )
			f11_arg0.ArrowDown:AnimateSequence( "InGame" )
			f11_arg0.ListCount:AnimateSequence( "InGame" )
		end
		
		f7_arg0.ListCount:RegisterAnimationSequence( "CountArabic", {
			{
				duration = 0,
		...
		local f7_local3 = function ( f10_arg0, f10_arg1 )
			f10_arg0.ListCount:AnimateSequence( "CountArabic" )
		end
		
		f7_arg0.WeaponsGrid:RegisterAnimationSequence( "SplitScreen", {
			{
				duration = 0,
				property = TWEEN_PROPERTY.Top,
				value = _1080p * 170
		...
		f7_arg0.WeaponAttributes:RegisterAnimationSequence( "SplitScreen", {
			{
				duration = 0,
				property = TWEEN_PROPERTY.Left,
				value = _1080p * 720
		...
		if f7_arg0.InGameMenuTimerStatus then
			f7_arg0.InGameMenuTimerStatus:RegisterAnimationSequence( "SplitScreen", {
				{
					duration = 0,
					property = TWEEN_PROPERTY.Left,
					value = _1080p * 760
		...
		f7_arg0.VWeaponScrollbar:RegisterAnimationSequence( "SplitScreen", {
			{
				duration = 0,
				property = TWEEN_PROPERTY.Top,
				value = _1080p * 170
		...
		f7_arg0.ArrowUp:RegisterAnimationSequence( "SplitScreen", {
			{
				duration = 0,
				property = TWEEN_PROPERTY.Top,
				value = _1080p * 529
		...
		f7_arg0.ArrowDown:RegisterAnimationSequence( "SplitScreen", {
			{
				duration = 0,
				property = TWEEN_PROPERTY.Top,
				value = _1080p * 529
		...
		f7_arg0.ListCount:RegisterAnimationSequence( "SplitScreen", {
			{
				duration = 0,
				property = TWEEN_PROPERTY.Top,
				value = _1080p * 536
		...
		local f7_local4 = function ( f9_arg0, f9_arg1 )
			f9_arg0.WeaponsGrid:AnimateSequence( "SplitScreen" )
			f9_arg0.WeaponAttributes:AnimateSequence( "SplitScreen" )
			if f9_arg0.InGameMenuTimerStatus then
				f9_arg0.InGameMenuTimerStatus:AnimateSequence( "SplitScreen" )
			end
			f9_arg0.VWeaponScrollbar:AnimateSequence( "SplitScreen" )
			f9_arg0.ArrowUp:AnimateSequence( "SplitScreen" )
			f9_arg0.ArrowDown:AnimateSequence( "SplitScreen" )
			f9_arg0.ListCount:AnimateSequence( "SplitScreen" )
		end
		
		f7_arg0.ComparisonString:RegisterAnimationSequence( "CHT", {
			{
				duration = 0,
				property = TWEEN_PROPERTY.Top,
				value = _1080p * -304
		...
		f7_arg0._sequences = {
			...
			Frontend = f7_local1,
			InGame = f7_local2,
			CountArabic = f7_local3,
			SplitScreen = f7_local4,
			CHT = function ( f8_arg0, f8_arg1 )
				f8_arg0.ComparisonString:AnimateSequence( "CHT" )
			end
		}
...
function WeaponSelect( f1_arg0, f1_arg1 )
	...
	if Engine[0x12586A3F4FB490E]() and not CONDITIONS.IsDMZMatch() then
		f1_local20:addEventHandler( "button_over", function ( f3_arg0, f3_arg1 )
		...
		f1_local20:addEventHandler( "button_up", function ( f2_arg0, f2_arg1 )
	...
	if not f1_local0.bindButton then
		...
		f1_local0.bindButton = f1_local26
	end
