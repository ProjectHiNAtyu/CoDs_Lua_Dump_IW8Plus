			...
			if f34_local0 then
				if f34_arg0.weaponData.isGunsmithDisabled ~= "1" then
					if CoD.IsDMZMatch() then
						f34_local0 = CONDITIONS.IsDMZGunsmithEnabled()
					else
						f34_local0 = true
					end
				else
...
local f0_local8 = function ( f32_arg0, f32_arg1, f32_arg2, f32_arg3, f32_arg4 )
	return function ( f33_arg0, f33_arg1 )
		...
		local f33_local1 = LOOT.GetItemID( LOOT.itemTypes.WEAPON, f32_arg0.weaponData.ref )
		...
		if f32_arg0.BundleUpsellButton then
			if Dvar[0x9E5BE3B4BBA4E0E]( 0x62400405F9F3C0B ) and Dvar[0x9E5BE3B4BBA4E0E]( 0xA051309A7F18047 ) and not CONDITIONS.AreRestrictionsActive( f32_arg0 ) and f33_local5.bundleVariants[f32_arg0.weaponData.ref] and f33_local5.bundleVariants[f32_arg0.weaponData.ref][1] then
				f32_arg0.BundleUpsellButton:SetupUpsellButtonWithBundleID( f32_arg0, f33_local5.bundleVariants[f32_arg0.weaponData.ref][1].bundleID )
			else
...
local f0_local13 = function ( f20_arg0, f20_arg1, f20_arg2, f20_arg3, f20_arg4, f20_arg5 )
	...
	f20_local5.lootID = LOOT.GetItemID( LOOT.itemTypes.WEAPON, f20_arg3.ref )
	...
	if not f20_local5.handlersAdded then
		...
		f20_local5:addEventHandler( "button_action", function ( f23_arg0 )
			if CoD.IsDMZMatch() and 0 < f23_arg0.numBlueprints then
				LUI.FlowManager.RequestAddMenu( "WeaponLocker", true, f20_arg0, false, {
					...
					weaponRef = f23_arg0.weaponData.ref,
					hideTabs = true
				} )
			else
...
local f0_local14 = function ( f19_arg0, f19_arg1, f19_arg2, f19_arg3, f19_arg4 )
	...
	if f19_local0 ~= f19_local1 then
		...
		f19_arg0.WeaponsGrid:MouseSetActiveToDefaultFocus( f19_arg1 )
...
local f0_local15 = function ( f14_arg0, f14_arg1, f14_arg2 )
	...
	f14_arg0.bindButton:addEventHandler( "button_alt2", function ( f17_arg0, f17_arg1 )
		...
		if f14_arg0( f17_local1 ) then
			f14_arg0( f14_arg0, f14_arg0, f17_local1 )
		end
	end )
	if not CONDITIONS.IsMobileOrMobileSim() and CONDITIONS.InFrontend( f14_arg0 ) and CONDITIONS.IsWeaponPreviewEnabled() then
		...
		f14_arg0.bindButton:addEventHandler( "button_right_stick", function ( f15_arg0, f15_arg1 )
			f14_arg0( f15_arg0:getParent(), f14_arg0, f14_arg0 )
		end )
	end
end
...
local f0_local20 = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	f3_local0 = f3_local0.loadouts[f3_arg0.loadoutIndex]
	...
	if DMZ.IsLimitedInventoryEnabled() then
		f3_local1.exclusiveInventoryItems = true
	end
	f3_arg0.blueprintsByWeapon = WEAPON.GetModificationsByWeapon( f3_arg1, f3_local1 )
	...
	local f3_local9 = BATTLEPASS.GetLootTierMap()
	local f3_local10 = {}
	local f3_local11 = {}
	local f3_local12 = WEAPON.GetWeapons()
	assert( f3_local12 )
	for f3_local21, f3_local22 in ipairs( f3_local12 ) do
		local f3_local23 = f3_local22[0x9E9C01960F4C582]
		...
		if f3_local16 or f3_local17 then
			...
			if not f3_local8 or not f3_local18 then
				...
				if not f3_local25.isUnlocked then
					local f3_local20 = f3_local9[LOOT.GetItemID( LOOT.itemTypes.WEAPON, f3_local23 )]
					if f3_local20 then
	...
	for f3_local15 = 1, #f3_local13, 1 do
		if f3_local13[f3_local15][0x8B6F2336E5960E5] ~= nil then
			...
			local f3_local16 = WEAPON.AllClassesAllowed()
	...
	if f3_arg0.BundleUpsellButton then
		f3_arg0.BundleUpsellButton:SetUpsellMenu( LOADOUT.GetWeaponMenuRef() )
	end
end
