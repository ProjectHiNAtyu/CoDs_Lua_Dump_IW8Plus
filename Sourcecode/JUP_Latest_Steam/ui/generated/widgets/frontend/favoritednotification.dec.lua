...
States = {
	[0xAD14C6E7156B923] = function ( f2_arg0, f2_arg1 )
		...
		local f2_local1 = function ( f4_arg0, f4_arg1 )
			f4_arg0[0xBFF4CC56C2092F0]:AnimateSequence( 0x8B05807B5566370 )
		end
		...
		f2_arg0[0x49D85F0EF1CEC84] = {
			...
			[0xA249B1921E2BDEA] = function ( f3_arg0, f3_arg1 )
				f3_arg0[0xBFF4CC56C2092F0]:AnimateSequence( 0xA249B1921E2BDEA )
			end
		}
...
function FavoritedNotification( f1_arg0, f1_arg1 )
	local f1_local0 = LUI
	...
	f1_local3.id = "FavoritedNotification"
	...
	f1_local5:setImage( RegisterMaterial( 0xF039F611BB663D6 ), 0 )
	f1_local3:addElement( f1_local5 )
	f1_local3[0xBFF4CC56C2092F0] = f1_local5
	return f1_local3
end

MenuBuilder.registerType( 0xE418209B625D374, FavoritedNotification )
LockTable( _M )
