...
local f0_local0 = function ( f4_arg0, f4_arg1, f4_arg2 )
	...
	f4_arg0.MenuTitle:SetTitle( Engine[0xED84C33EC5F01EA]( "LUA_MENU_CP/DIFFICULTY" ) )
end
...
function CPGameDifficulty( menu, controller )
	...
	MenuTitle.MenuTitle:setText( ToUpperCase( Engine[0xED84C33EC5F01EA]( "LUA_MENU_CP/DIFFICULTY" ) ), 0 )
