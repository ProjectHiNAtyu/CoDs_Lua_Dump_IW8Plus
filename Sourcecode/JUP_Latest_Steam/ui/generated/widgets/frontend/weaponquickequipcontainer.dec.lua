...
function WeaponQuickEquipContainer( f1_arg0, f1_arg1 )
	...
	f1_local3.id = "WeaponQuickEquipContainer"
	local f1_local4
	if f1_arg1 then
		f1_local4 = f1_arg1
	else
	...
	f1_local5:SetAnchorsAndPosition( 0, 1, 0, 1, -0.14, 1919.86, 0.35, 1080.35 )
	f1_local3:addElement( f1_local5 )
	f1_local3[0xF3FC81DFCEB7D35] = f1_local5
	local f1_local6 = nil
	if f1_local0.InGame() then
		f1_local6 = f1_local2.BuildRegisteredType( 0x41379B674922F82, {
			controllerIndex = f1_local4
		} )
		f1_local6[0x8B72E07B55C3AC0] = "LoadoutTabBacker"
		ACTIONS.ScaleStretchAnchorFullscreen( f1_local6 )
		f1_local6:SetAnchorsAndPosition( 0, 0, 1, 0, 0, 0, -531, 0 )
		f1_local3:addElement( f1_local6 )
		f1_local3[0x41379B674922F82] = f1_local6
	end
	local f1_local7 = nil
	f1_local7 = f1_local2.BuildRegisteredType( 0xEDDFDA88B8E60FD, {
		controllerIndex = f1_local4
	} )
	f1_local7[0x8B72E07B55C3AC0] = "LoadoutButtons"
	f1_local7:SetAnchorsAndPosition( 0, 1, 0, 1, 115.88, 1859.88, 723.53, 927.53 )
	f1_local3:addElement( f1_local7 )
	f1_local3[0x7AA11720C6959C8] = f1_local7
	local f1_local8 = nil
	...
	f1_local8:SetAnchorsAndPosition( 0.5, 0.5, 1, 0, -813, 680, -137, -73 )
	f1_local3:addElement( f1_local8 )
	f1_local3[0x94FA1B3F0F5F070] = f1_local8
	local f1_local9 = nil
	if f1_local0.IsGLGunsmithEnabled() and not f1_local0.IsCPMission() then
		f1_local9 = f1_local2.BuildRegisteredType( 0x40DD6E46A5A464D, {
			controllerIndex = f1_local4
		} )
		f1_local9[0x8B72E07B55C3AC0] = "LoadoutsScrollbar"
		f1_local9:SetAnchorsAndPosition( 0.5, 0.5, 1, 0, -411.5, 278.5, -56, -38 )
		f1_local3:addElement( f1_local9 )
		f1_local3[0x2E3AD036F828CCE] = f1_local9
	end
	...
	f1_local10[0x8B72E07B55C3AC0] = "GameModeTabs"
	f1_local10:SetAnchorsAndPosition( 0, 1, 0, 1, 662.88, 893.88, 556.04, 588.04 )
	f1_local3:addElement( f1_local10 )
	f1_local3[0x870375D9105F8A4] = f1_local10
	local f1_local11 = nil
	f1_local11 = f1_local2.BuildRegisteredType( 0x32898ABF5D19C6F, {
		controllerIndex = f1_local4
	} )
	f1_local11[0x8B72E07B55C3AC0] = "NewWeapon"
	f1_local11:SetAlpha( 0, 0 )
	f1_local11:SetAnchorsAndPosition( 0, 1, 0, 1, 1059.86, 1809.86, 132.04, 532.04 )
	f1_local3:addElement( f1_local11 )
	f1_local3[0x7D00EF39D56F78D] = f1_local11
	local f1_local12 = nil
	f1_local12 = f1_local2.BuildRegisteredType( 0x32898ABF5D19C6F, {
		controllerIndex = f1_local4
	} )
	f1_local12[0x8B72E07B55C3AC0] = "PreviousWeapon"
	f1_local12:SetAlpha( 0, 0 )
	f1_local12:SetAnchorsAndPosition( 0, 1, 0, 1, 28.38, 778.38, 132.04, 532.04 )
	f1_local3:addElement( f1_local12 )
	f1_local3[0x24CB45E075DE0FC] = f1_local12
	local f1_local13 = nil
	f1_local13 = f1_local1.UIImage.new()
	f1_local13[0x8B72E07B55C3AC0] = "CompareImage"
	f1_local13:SetAlpha( 0, 0 )
	f1_local13:setImage( RegisterMaterial( 0x81122B1C5DB63A6 ), 0 )
	f1_local13:SetAnchorsAndPosition( 0, 1, 0, 1, 876.5, 1004.5, 271.04, 399.04 )
	f1_local3:addElement( f1_local13 )
	f1_local3[0x6A823A799D186C1] = f1_local13
	f0_local0( f1_local3, f1_local4, f1_arg1 )
	return f1_local3
end

MenuBuilder.registerType( 0x21A88F0015223B3, WeaponQuickEquipContainer )
LockTable( _M )
