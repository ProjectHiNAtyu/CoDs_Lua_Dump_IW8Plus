...
LUI.UIScrollbar.init = function ( f20_arg0, f20_arg1 )
	...
	if f20_arg1.startCap then
		f20_arg1.startCap:addEventHandler( "button_action", function ( f29_arg0, f29_arg1 )
			if f20_arg0._source then
		...
		f20_arg1.startCap:addEventHandler( "leftmousedown", function ( f28_arg0, f28_arg1 )
			return true
		end )
	end
	if f20_arg1.endCap then
		f20_arg1.endCap:addEventHandler( "button_action", function ( f27_arg0, f27_arg1 )
			if f20_arg0._source then
				return f20_arg0._source:processEvent( {
					name = "scrollbar_next",
					scrollbar = f20_arg0
		...
		f20_arg1.endCap:addEventHandler( "leftmousedown", function ( f26_arg0, f26_arg1 )
			return true
		end )
	end
	if f20_arg1.sliderArea and (f20_arg1.slider or f20_arg1.fixedSizeSlider) then
		...
		local f20_local3 = function ( f25_arg0, f25_arg1 )
			if not f20_arg0:IsKBMStyle() then
				return 
			elseif not f25_arg0:IsDisabled() then
				local f25_local0 = f20_arg0._sliderArea:getWidth()
				local f25_local1 = f20_arg0._sliderArea:getHeight()
				local f25_local2, f25_local3, f25_local4, f25_local5 = f20_arg0._sliderArea:getRect()
				f25_local2, f25_local3 = f25_arg1.root:PixelsToUnits( f25_local2, f25_local3 )
				local f25_local6, f25_local7 = f25_arg1.root:PixelsToUnits( f25_arg1.x, f25_arg1.y )
				if f25_arg1.name == "leftmousedown" then
					local f25_local8, f25_local9, f25_local10, f25_local11 = f25_arg0:getRect()
					local f25_local12, f25_local13 = f25_arg1.root:PixelsToUnits( f25_local8, f25_local9 )
					f25_local9 = f25_local13
					f20_arg0.x = f25_local6 - f25_local12
					f20_arg0.y = f25_local7 - f25_local9
				end
				f20_arg0._source:processEvent( {
					name = "scrollbar_drag",
					targetX = LUI.clamp( (f25_local6 - f20_arg0.x - f25_local2) / f25_local0, 0, 1 ),
					targetY = LUI.clamp( (f25_local7 - f20_arg0.y - f25_local3) / f25_local1, 0, 1 ),
					dragStart = f25_arg1.name == "leftmousedown",
					scrollbar = f20_arg0
				} )
				return true
			else
		...
		f20_local2 = function ( f24_arg0, f24_arg1 )
			if not f20_arg0:IsKBMStyle() then
				return 
		...
		local f20_local4 = function ( f23_arg0, f23_arg1 )
			Engine.BFAABIIGDC( true )
			f20_arg0( f23_arg0, f23_arg1 )
			return true
		end
		
		local f20_local5 = function ( f22_arg0, f22_arg1 )
			Engine.BFAABIIGDC( false )
			return true
		end
		
		local f20_local6 = f20_arg1.slider
		if not f20_local6 then
			f20_local6 = f20_arg1.fixedSizeSlider
		end
		f20_local6:registerEventHandler( "leftmousedown", f20_local4 )
		f20_local6:registerEventHandler( "leftmouseup", f20_local5 )
		f20_local6:registerEventHandler( "mouse_capture_lost", f20_local5 )
		f20_local6:registerEventHandler( "mousedrag", f20_local3 )
		f20_arg1.sliderArea:registerEventHandler( "leftmousedown", f20_local2 )
		f20_local6:addEventHandler( "gamepad_button", function ( f21_arg0, f21_arg1 )
...
LUI.UIScrollbar.LinkTo = function ( f7_arg0, f7_arg1 )
	...
	f7_arg1:addEventHandler( "mouseenter", function ( f13_arg0, f13_arg1 )
		f7_arg0( f7_arg0, f13_arg1 )
	end )
	f7_arg1:addEventHandler( "gain_focus", function ( f12_arg0, f12_arg1 )
		f7_arg0( f7_arg0, f12_arg1 )
	end )
	f7_arg1:addEventHandler( "mouseleave", function ( f11_arg0, f11_arg1 )
		if not f7_arg0._eventListener:IsPositionInside( f11_arg1.x, f11_arg1.y ) then
			f7_arg0( f7_arg0, f11_arg1 )
		end
	end )
	f7_arg1:addEventHandler( "lose_focus", function ( f10_arg0, f10_arg1 )
		f7_arg0( f7_arg0, f10_arg1 )
	end )
	f7_arg1:addEventHandler( "grid_size_updated", function ()
		f7_arg0:ResizeScrollbar()
	end )
	f7_arg0._eventListener:addEventHandler( "scrollbar_force_show", function ( f8_arg0, f8_arg1 )
