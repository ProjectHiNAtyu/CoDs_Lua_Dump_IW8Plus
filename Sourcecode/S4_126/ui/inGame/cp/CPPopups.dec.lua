...
function CPVideoOverlayPopup( f1_arg0, f1_arg1, f1_arg2 )
	local f1_local0
	if not f1_arg1 then
		f1_local0 = f1_arg1
	else
...
MenuBuilder.registerType( "CPVideoOverlayPopup", CPVideoOverlayPopup )
LUI.FlowManager.RegisterStackPopBehaviour( "CPVideoOverlayPopup", CP.VideoOverlayPop )
LockTable( _M )
