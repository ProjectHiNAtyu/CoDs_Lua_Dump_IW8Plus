...
local f0_local1 = function ( f5_arg0, f5_arg1 )
	if f5_arg0._state == f5_arg1 then
		if not CONDITIONS.IsMobileOrMobileSim() then
			local f5_local0 = LUI.FlowManager.GetMenuByName( "AARContainer" )
			if f5_local0 then
				local f5_local1 = f5_local0
			elseif f5_local0.scopedData then
				local f5_local1 = f5_local0.scopedData.displaySummary
			end
			LUI.FlowManager.RequestLeaveMenuByName( "AARContainer", true )
		else
			LUI.FlowManager.RequestLeaveMenuByName( "MobileAARContainer", true )
		end
	end
	f5_arg0._state = nil
end
...
PostGameFanfare.advance = function ( f1_arg0 )
	if f1_arg0._state == nil then
		local f1_local0 = GAMEMODE_SCRIPTBUNDLE_UTILS.GetAARMenuLuaName() or "AARContainer"
