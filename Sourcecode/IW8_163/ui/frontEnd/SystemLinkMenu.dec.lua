...
local f0_local4 = function ( f10_arg0, f10_arg1 )
	...
	Engine.DAGFFDGFII( "xstopprivateparty", f10_local0 )
	...
	if Engine.HABIAFADE() and not CONDITIONS.IsLaunchChunk() then
		...
		if CONDITIONS.IsThirdGameMode() then
			f10_local1 = "CPMainMenu"
		else
			f10_local1 = "MPMainMenu"
		end
		LUI.FlowManager.RequestAddMenu( f10_local1, false, f10_local0 )
	else
		LUI.FlowManager.RequestRestoreMenu( "MainMenuOffline", false, f10_local0 )
	end
end
	...
	PRIVATE_MATCH.SetupPrivateMatchTabs( f5_arg0, f5_local0, {
		...
		callbackFunc = function ( f6_arg0 )
			...
			if f6_local0 then
				...
				f5_arg0.HelperBar:RemoveButtonHelperTextFromElement( f5_arg0, "button_alt2", "left" )
