...
local f0_local0 = function ( f4_arg0, f4_arg1, f4_arg2 )
	f4_arg0.InstructionExit.alternateKbmLayout = true
	local f4_local0 = 256
	...
	f4_arg0:registerAndCallEventHandler( "empty_menu_stack", function ()
		HUDUtils.UpdateInstructionPrompts( f4_arg0, {
			...
			ExitTurretInstruction = f4_arg0.InstructionExit,
...
function MobileTurretControls( menu, controller )
	...
	InstructionFire:SetAnchorsAndPosition( 0.5, 0.5, 1, 0, _1080p * 255, _1080p * 455, _1080p * -116, _1080p * -92 )
	...
	InstructionZoom.Instruction:setText( Engine.CBBHFCGDIC( "KILLSTREAKS_HINTS/INSTRUCTION_ZOOM" ), 0 )
	InstructionZoom.Instruction:SetAlignment( LUI.Alignment.Left )
	InstructionZoom.InstructionAlternateKbm:setText( "", 0 )
	InstructionZoom.InstructionAlternateKbm:SetAlignment( LUI.Alignment.Center )
	InstructionZoom.PromptAlternateKbm.ActionIcon:setText( StripColorMarkers( LocalizeString( "[F]" ) ), 0 )
	InstructionZoom.PromptAlternateKbm.KBMButtonPrompt.KeyString:setText( StripColorMarkers( LocalizeString( "[F]" ) ), 0 )
	InstructionZoom:SetAnchorsAndPosition( 0.5, 0.5, 1, 0, _1080p * -455, _1080p * -255, _1080p * -116, _1080p * -92 )
	...
	TimeLabel:setText( Engine.CBBHFCGDIC( "LUA_MENU/TIME" ), 0 )
