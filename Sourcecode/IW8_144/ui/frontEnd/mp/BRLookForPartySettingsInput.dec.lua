...
local f0_local2 = function ( f5_arg0, f5_arg1 )
	...
	if Lobby.LOOK_FOR_PARTY_EXEC_CODES[f5_local0].count == nil then
		Lobby.LOOK_FOR_PARTY_EXEC_CODES[f5_local0].count = 1
	end
...
local f0_local4 = function ( f3_arg0 )
	...
	local f3_local2 = f3_arg0.SideOptionPopUp:GetButtons()
	for f3_local3 = 1, #f3_local2, 1 do
		local f3_local6 = f3_local2[f3_local3]
		local f3_local7 = Lobby.LOOK_FOR_PARTY_EXEC_CODES[f3_local6.parentData]
		if f3_local7 ~= nil then
			local f3_local8 = f3_local7[f3_local6.buttonData[Lobby.LOOK_FOR_PARTY_METADATA.EXEC_CODE_REF]] ~= nil
			if f3_local8 == true then
				f3_local6.selectedState = f3_local8
				f3_local6.Selected:SetEquipped( f3_local8 )
			end
		end
	end
end
