...
local f0_local15 = function ( f4_arg0, f4_arg1, f4_arg2 )
			...
			storeCustomizations = {
				...
				post = {
					...
					function ( f39_arg0, f39_arg1, f39_arg2 )
						f4_arg0:registerAndCallEventHandler( "update_input_type", function ( f40_arg0, f40_arg1 )
							if f40_arg0.BillboardFocusArea:isInFocus() then
								f40_arg0:processEvent( {
									name = "lose_focus"
								} )
								f40_arg0.categoryButtonsContainer:processEvent( {
									name = "gain_focus"
								} )
							end
							local f40_local0
							if LUI.IsLastInputKeyboardMouse( f40_arg1.controllerIndex ) then
								f40_local0 = 0
							else
								f40_local0 = 1
							end
							f39_arg0( f40_arg0, f40_local0 )
						end, {
	...
	local f4_local12 = _1080p * 350 + _1080p * 10
	local f4_local13 = {
		{
			{
				posL = 0,
	...
	local f4_local21 = function ( f15_arg0, f15_arg1, f15_arg2, f15_arg3 )
		return function ( f16_arg0, f16_arg1 )
			assert( f15_arg0[f15_arg0], string.format( "No handlers for event %s", f15_arg0 ) )
	...
	local f4_local25 = Engine[0x2165A8104C064EE]( Store[0xB6B0898C7795778]( f4_arg1 ) )
