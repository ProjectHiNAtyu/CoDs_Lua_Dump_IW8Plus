...
function paranormalDirectionalTeal( f1_arg0, f1_arg1 )
	local f1_local0 = LUI
	...
	f1_local3.id = "paranormalDirectionalTeal"
	...
	local f1_local5 = nil
	f1_local5 = f1_local1.BuildRegisteredType( 0xDC55F48CD5C918, {
	...
	f1_local6:SetAnchorsAndPosition( 0.5, 0.5, 0.5, 0.5, -140, 140, -110, 110 )
	f1_local3:addElement( f1_local6 )
	f1_local3[0x2B42111498D9EB6] = f1_local6
	local f1_local7 = nil
	f1_local7 = f1_local1.BuildRegisteredType( 0xDC55F48CD5C918, {
		controllerIndex = f1_local4
	} )
...
MenuBuilder.registerType( 0xD7C66703CB008D6, paranormalDirectionalTeal )
LockTable( _M )
