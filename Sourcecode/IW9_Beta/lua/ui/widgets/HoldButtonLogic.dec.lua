...
local f0_local1 = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	f3_arg0:addEventHandler( "gamepad_button", function ( f4_arg0, f4_arg1 )
		...
		if not f4_local0.buttons[f4_arg1.button] then
		...
		if not f4_arg0.fillTween then
			f4_local0.fill:SetProgress( 0, 0 )
			f4_arg0.fillTween = f4_local0.fill:SetProgress( 1, f4_local0.duration, LUI.EASING.inOutQuadratic )
