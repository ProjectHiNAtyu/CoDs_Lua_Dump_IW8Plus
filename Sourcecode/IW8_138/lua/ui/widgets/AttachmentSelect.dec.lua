...
local f0_local5 = function ( f27_arg0, f27_arg1 )
	...
	f27_arg0.DetailedEquippedSlots:Setup( f27_arg0._weaponTable, f27_arg0._category )
...
local f0_local6 = function ( f13_arg0, f13_arg1, f13_arg2 )
	...
	for f13_local9, f13_local10 in ddlpairs( f13_arg0._weaponPlayerData.attachmentSetup ) do
		if f13_local4 and f13_local9 < ATTACHMENT.count and f13_local10.attachment:get() == ATTACHMENT.none then
	...
	f13_arg0.DetailedEquippedSlots:Setup( f13_arg0._weaponTable, f13_arg2.category )
	f13_local6 = 0
