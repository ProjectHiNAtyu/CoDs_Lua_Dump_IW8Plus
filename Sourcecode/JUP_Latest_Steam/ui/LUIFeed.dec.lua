...
LUI.BaseUIFeed.init = function ( f18_arg0, f18_arg1 )
	...
	f18_arg0._singlePrimaryAxis = f18_arg1.singlePrimaryAxis
	f18_arg0._resetCounter = 0
	local f18_local0 = f18_arg1.childVisibilityNotifyFunc
...
LUI.BaseUIFeed.GetGridLocation = function ( f13_arg0, f13_arg1 )
	...
	if f13_arg0:GetPrimaryAxis() == LUI.DIRECTION.horizontal then
		if f13_arg0._singlePrimaryAxis then
			f13_local0 = 0
		else
			f13_local0 = math.floor( f13_arg1 / f13_arg0:GetMaxVisibleColumns() )
		end
		if f13_arg0._singlePrimaryAxis and not f13_arg1 then
			f13_local1 = f13_arg1
		else
...
LUI.BaseUIFeed.UpdateTrackerDataSources = function ( f11_arg0 )
	if f11_arg0._numAliveDataSource then
		DataModel[0x83C9B5DE1D9371]( f11_arg0._numAliveDataSource:GetModel( f11_arg0._controllerIndex ), f11_arg0._numAlive )
	end
	if f11_arg0._numVisibleDataSource then
		DataModel[0x83C9B5DE1D9371]( f11_arg0._numVisibleDataSource:GetModel( f11_arg0._controllerIndex ), f11_arg0._numVisible )
	end
end
...
LUI.UIFeed.init = function ( f8_arg0, f8_arg1 )
	local f8_local0 = LUI.ShallowCopy( f8_arg1 )
	local f8_local1 = f8_local0.refreshChild
	f8_local0.refreshChild = function ( f9_arg0, f9_arg1, f9_arg2 )
		f8_arg0( f9_arg0, f8_arg0:GetDataAtIndex( f8_arg0:GetDataIndex( f9_arg1, f9_arg2 ) ) )
	end
...
LUI.UIDataSourceFeed.SetFeedDataSource = function ( f1_arg0, f1_arg1 )
	...
	f1_arg0._pushSubscription = f1_arg0:SubscribeToModel( f1_arg0._feedDataSource:GetPushModel( f1_arg0._controllerIndex ), function ( f2_arg0 )
		if DataModel[0x614D394F6F9A18D]( f2_arg0 ) == true then
			local f2_local0 = f1_arg0._feedDataSource:GetTTLModel( f1_arg0._controllerIndex )
			local f2_local1
			if f2_local0 then
				f2_local1 = DataModel[0x614D394F6F9A18D]( f2_local0 )
