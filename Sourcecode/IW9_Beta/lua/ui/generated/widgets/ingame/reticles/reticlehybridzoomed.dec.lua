...
function PostLoadFunc( f8_arg0, f8_arg1, f8_arg2 )
	local f8_local0 = 0.5
	local f8_local1 = DataSources.alwaysLoaded.player.currentWeapon.adsPercent
...
function ReticleHybridZoomed( menu, controller )
	...
	self:SubscribeToModel( DataSources.alwaysLoaded.player.currentWeapon.isAimingAtEnemy:GetModel( f1_local1 ), function ()
		if DataSources.alwaysLoaded.player.currentWeapon.isAimingAtEnemy:GetValue( menu ) ~= nil and DataSources.alwaysLoaded.player.currentWeapon.isAimingAtEnemy:GetValue( menu ) == false then
			ACTIONS.AnimateSequence( menu, "PerceptionOff", menu )
		end
		if DataSources.alwaysLoaded.player.currentWeapon.isAimingAtEnemy:GetValue( menu ) ~= nil and DataSources.alwaysLoaded.player.currentWeapon.isAimingAtEnemy:GetValue( menu ) == true then
