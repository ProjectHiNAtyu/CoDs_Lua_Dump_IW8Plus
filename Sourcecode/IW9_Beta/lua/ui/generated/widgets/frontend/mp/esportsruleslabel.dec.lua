...
function ESportsRulesLabel( menu, controller )
	...
	ESportsRulesLabel:SetFont( FONTS.GetFont( FONTS.PrimaryRegular.File ) )
	ESportsRulesLabel:SetFontSize( 24 * _PT )
	ESportsRulesLabel:SetMinFontSize( 18 * _PT )
	ESportsRulesLabel:SetWordWrap( true )
