...
function LobbyStatus( f1_arg0, f1_arg1 )
	...
	self:SetAnchorsAndPosition( 0, 1, 1, 0, 0, 500, 0, 86 )
	self.id = "LobbyStatus"
	...
	bg:SetRGB( 0 )
	bg:SetAlpha( 1 )
	bg:setImage( RegisterMaterial( 0x3A8F29C0EC8E46E ), 0 )
	bg.id = "bg"
	self:addElement( bg )
	self.bg = bg
	...
	self.UpdateMessage = function ( f3_arg0 )
		...
		if not self then
			self = LUI.UIText.new()
			self.id = "newMessage"
			self:SetRGB( COLORS.grey179 )
			self:SetAlpha( 1 )
			self:SetFont( FONTS.GetFont( FONTS.SecondaryRegular.File ) )
			self:SetAlignment( f1_arg0 )
			self:SetAnchorsAndPosition( 0, 0, 0, 1, 12, 0, f1_arg0, f1_arg0 + f1_arg0 )
