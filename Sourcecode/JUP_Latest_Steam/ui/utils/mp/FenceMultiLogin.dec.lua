...
function PopupFenceMultiLoginError( f1_arg0, f1_arg1 )
	...
	if CONDITIONS.IsMobileOrMobileSim() then
		...
		f1_local0.confirmation_action = function ( f3_arg0, f3_arg1 )
			if Engine[0xE25E29D8ADE8F27]() and Dvar[0x9E5BE3B4BBA4E0E]( 0x7481B61D50CC29 ) then
				...
				LUI.FlowManager.RequestAddMenu( "MobileCODAccountLogin", false, f3_arg1.controller, true )
			end
		end
