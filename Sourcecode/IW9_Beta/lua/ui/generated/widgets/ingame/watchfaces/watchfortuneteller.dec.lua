...
local f0_local0 = function ( f5_arg0, f5_arg1, f5_arg2 )
	...
	if Engine[0x12586A3F4FB490E]() then
		...
		local f5_local2 = function ()
			...
			f8_local1.onComplete = function ()
				...
				f8_local0.Fortune:setText( Engine[0xED84C33EC5F01EA]( f8_local0[f9_local0] ) )
			end
	...
	f5_arg0:SubscribeToModel( f5_local1:GetModel( f5_arg1 ), function ( f7_arg0 )
		if DataModel[0x614D394F6F9A18D]( f7_arg0 ) ~= nil then
			...
			f5_arg0.Fortune:setText( Engine[0xED84C33EC5F01EA]( f5_arg0[f7_local0] ) )
		end
	end )
	if not CONDITIONS.IsThirdGameMode() then
		f5_arg0:SubscribeToModel( DataSources.inGame.player.spawnNotify:GetModel( f5_arg1 ), function ()
			...
			f5_arg0.Fortune:setText( Engine[0xED84C33EC5F01EA]( 0xCDF8D318134F56D ) )
		end )
	end
end
...
function WatchFortuneTeller( menu, controller )
	...
	self._sequenceLengths.Shook = 2000
	local f1_local9 = nil
	...
	self._sequenceLengths.Reset = 100
