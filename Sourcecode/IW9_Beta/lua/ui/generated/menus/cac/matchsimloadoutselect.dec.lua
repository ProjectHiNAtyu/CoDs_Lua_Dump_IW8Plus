...
function PostLoadFunc( f6_arg0, f6_arg1, f6_arg2 )
	...
	local f6_local1 = LOADOUT.GetLoadoutSquadMember( f6_arg1 )
	f6_local1 = f6_local1.loadouts
	f6_arg0.LoadoutGrid:SetRefreshChild( function ( f7_arg0, f7_arg1, f7_arg2 )
		...
		f7_arg0.GenericButton:addEventHandler( "button_action", function ( f8_arg0 )
			if Dvar[0x9E5BE3B4BBA4E0E]( 0xF1B7C8C6D3F5169 ) == true then
				return 
			else
	...
	f6_arg0.LoadoutGrid:SetNumRows( LOADOUT.GetMaxLoadoutCount() )
...
function MatchSimLoadoutSelect( menu, controller )
	...
	MenuTitle.MenuTitle:setText( Engine[0xED84C33EC5F01EA]( 0x9B2BDD559BB4556 ), 0 )
	...
	LoadoutGrid:SetMaxVisibleRows( 5 )
	LoadoutGrid:SetRowSpacing( 10 )
