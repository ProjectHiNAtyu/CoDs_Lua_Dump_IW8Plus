...
function FooterOptionsIcon( f1_arg0, f1_arg1 )
	local f1_local0 = LUI
	...
	f1_local3.id = "FooterOptionsIcon"
	...
	f1_local5:setImage( RegisterMaterial( 0x558B8AD8B8D5E82 ), 0 )
...
MenuBuilder.registerType( 0xE207641C462F24D, FooterOptionsIcon )
LockTable( _M )
