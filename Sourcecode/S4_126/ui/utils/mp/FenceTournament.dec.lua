...
FenceTournament.Stop = function ( f7_arg0 )
	...
	LUI.FlowManager.RequestLeaveMenuByName( "TournamentInProgressPopup", true )
	f7_arg0._openedPopup = false
end

FenceTournament.UpdateState = function ( f6_arg0 )
	assert( f6_arg0._state ~= LUI.Fence.STATE.fail )
	if Tournament[0xA680A9DEFDE4269]( f6_arg0._controllerIndex ) or Dvar[0x9E5BE3B4BBA4E0E]( "#x37446c08e17ad765b" ) then
...
FenceTournament.ShowInProgressPopup = function ( f1_arg0 )
	LUI.FlowManager.RequestPopupMenu( nil, "TournamentInProgressPopup", false, nil, false, {
		message = Engine[0xED84C33EC5F01EA]( "MENU/FETCHING_TOURNAMENT_BRACKET" ),
