...
local f0_local0 = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	if false then
		f3_arg0.ProgressText:setText( Engine[0xED84C33EC5F01EA]( 0x7DB5EB1A3C881DD ) )
...
function ContractProgress( menu, controller )
	...
	ProgressHeader:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 0, 0, _1080p * 36 )
	...
	ProgressTitle:setText( ToUpperCase( Engine[0xED84C33EC5F01EA]( 0xD068FCD314778C ) ), 0 )
	ProgressTitle:SetFont( FONTS.GetFont( FONTS.PrimaryRegular.File ) )
	ProgressTitle:SetFontSize( 24 * _PT )
	ProgressTitle:SetMinFontSize( 18 * _PT )
	ProgressTitle:SetWordWrap( true )
	ProgressTitle:SetAlignment( LUI.Alignment.Left )
	ProgressTitle:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 10, _1080p * -112, _1080p * 6, _1080p * 30 )
	...
	ProgressBackground:SetAnchorsAndPosition( 0, 1, 1, 0, 0, 0, _1080p * -30, _1080p * -2 )
	...
	ProgressText:SetFontSize( 48 * _PT )
	ProgressText:SetMinFontSize( 18 * _PT )
	ProgressText:SetWordWrap( true )
	ProgressText:SetAlignment( LUI.Alignment.Center )
	ProgressText:SetAnchorsAndPosition( 0, 1, 0.5, 0.5, _1080p * 23, _1080p * -10, _1080p * -16.5, _1080p * 31.5 )
	...
	ProgressBorder:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 0, 0, 0 )
