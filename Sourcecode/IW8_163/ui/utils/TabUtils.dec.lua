...
TAB.SetTabState = function ( f16_arg0, f16_arg1 )
	...
	local f16_local3 = IsLanguageArabic()
	if f16_local3 then
		f16_local3 = CONDITIONS.IsMagmaGameMode()
	end
	local f16_local4
	if f16_local3 then
		f16_local4 = "AR"
		...
		if f16_local0 then
			if f16_arg1 and f16_arg1.event == TAB.TAB_EVENT.MOUSE_ENTER then
				if f16_arg0.focused then
					WZWIP.AnimateThemeElement( f16_arg0, "Highlighted" .. f16_local4 )
				else
					WZWIP.AnimateThemeElement( f16_arg0, "Focused" .. f16_local4 )
				end
			elseif f16_arg1 and f16_arg1.event == TAB.TAB_EVENT.LEFT_MOUSE_UP then
				WZWIP.AnimateThemeElement( f16_arg0, "Highlighted" .. f16_local4 )
			elseif f16_arg0.focused then
				WZWIP.AnimateThemeElement( f16_arg0, "FocusedNoSound" .. f16_local4 )
			else
				WZWIP.AnimateThemeElement( f16_arg0, "UnFocused" .. f16_local4 )
			end
		elseif f16_arg0.focused then
			if f16_local2 then
				WZWIP.AnimateThemeElement( f16_arg0, "Focused" .. f16_local4 )
	...
	if f16_arg0._isBattlePassTab then
		local f16_local5 = WZWIP.AnimateThemeElement
		local f16_local6 = f16_arg0
		local f16_local7
		if f16_arg0.focused or f16_local1 then
			f16_local7 = "BattlePassTabOver"
		else
			f16_local7 = "BattlePassTabUp"
		end
	...
	if f16_arg0._isFreeItem then
		...
		local f16_local7
		if f16_arg0.focused or f16_local1 then
			f16_local7 = "FreeBundleTabOver"
		else
			f16_local7 = "FreeBundleTabUp"
		end
		f16_local5( f16_local6, f16_local7 )
	end
	if f16_arg0._isEventTab then
		local f16_local5 = SEASONAL_EVENT.GetCurrentInitSetupSequenceName()
		if f16_arg0.focused or f16_local1 then
			local f16_local8 = f16_local5 .. "TabOver"
			if not f16_local8 then
				f16_local5 = f16_local8
			end
		end
		f16_local5 = f16_local5 .. "TabUp"
	end
end
...
TAB.SetUp = function ( f4_arg0, f4_arg1 )
	...
	if f4_local0 then
		f4_local0 = CONDITIONS.IsWZWipFlowEnabled()
	end
	if f4_local0 then
		local f4_local1 = "AR"
	else
	...
	f4_arg0.Enable = function ( f15_arg0 )
		...
		WZWIP.AnimateThemeElement( f15_arg0, "UnFocused" .. f4_arg0 )
	end
	
	f4_arg0.Disable = function ( f14_arg0 )
		f14_arg0._disabled = true
		WZWIP.AnimateThemeElement( f14_arg0, "Disabled" .. f4_arg0 )
	end
