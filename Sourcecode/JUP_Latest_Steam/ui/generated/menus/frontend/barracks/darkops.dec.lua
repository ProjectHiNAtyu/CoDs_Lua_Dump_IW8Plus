...
function DarkOps( f1_arg0, f1_arg1 )
	...
	f1_local6[0x93CC4E91B38D10C]:setText( Engine[0xED84C33EC5F01EA]( 0xCFEC9F284CC1E80 ), 0 )
...
MenuBuilder.registerType( 0x13C938FEC5A5E5B, DarkOps )
LockTable( _M )
