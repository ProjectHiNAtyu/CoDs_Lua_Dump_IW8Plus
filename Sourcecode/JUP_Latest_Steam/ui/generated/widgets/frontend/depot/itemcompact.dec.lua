...
function ItemCompact( f1_arg0, f1_arg1 )
	...
	f1_local9:SetAnchorsAndPosition( 0, 1, 1, 0, 277, 375, -52, -22 )
...
MenuBuilder.registerType( 0xC1D8C7F7421B9BB, ItemCompact )
LockTable( _M )
