...
local f0_local1 = function ( f6_arg0, f6_arg1, f6_arg2 )
	...
	f6_arg0:AddContextualMenuAction( {
		...
		conditionFunction = function ()
			local f20_local0 = Engine[0xFB1B6E36ABE59B8]()
			if f20_local0 then
				f20_local0 = SOCIAL.IsValidPlatformID( f6_arg0.platformId )
				if f20_local0 then
					f20_local0 = f6_arg0.isValidEntry
					if not f20_local0 then
						f20_local0 = Social[0xB433172370D0A5B]( f6_arg0 )
					end
				end
			end
			return f20_local0
	...
	if f6_arg0._isMyPlayer then
		...
		return 
	elseif CONDITIONS.WhispersEnabled( f6_arg1 ) then
...
local f0_local2 = function ( f5_arg0, f5_arg1, f5_arg2 )
	...
	if f5_arg0.PlayerName then
		if f5_arg1.titleColor then
			f5_arg0.PlayerName:SetRGB( f5_arg1.titleColor )
		else
			f5_arg0.PlayerName:SetRGB( SWATCHES[0x2B125210C0B2BB1][0x241D6F6276E2F07] )
		end
	end
	...
	if f5_arg1.textColor then
		f5_arg0.Message:SetRGB( f5_arg1.textColor )
	else
		f5_arg0.Message:SetRGB( SWATCHES[0x2B125210C0B2BB1][0xF5C0139BA6F896C] )
	end
...
local f0_local3 = function ( f2_arg0, f2_arg1, f2_arg2 )
	...
	f2_arg0:addEventHandler( "button_over", function ( f4_arg0, f4_arg1 )
		if LUI.IsLastInputKeyboardMouse( f4_arg1.controller or f4_arg0._controllerIndex ) then
...
function BaseTextChatEntry( f1_arg0, f1_arg1 )
	local f1_local0 = LUI
	local f1_local1 = f1_local0.UIButton.new()
	f1_local1:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 620, 0, 96 )
	f1_local1.id = "BaseTextChatEntry"
	local f1_local2
	if f1_arg1 then
		f1_local2 = f1_arg1
	else
...
MenuBuilder.registerType( 0xD51B07373C9DA0F, BaseTextChatEntry )
LockTable( _M )
