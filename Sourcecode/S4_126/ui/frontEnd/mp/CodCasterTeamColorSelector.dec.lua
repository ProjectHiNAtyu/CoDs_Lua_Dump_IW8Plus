	...
	f19_arg2:SubscribeToModelThroughElement( f19_arg2, "color", function ( f21_arg0 )
		...
		if f21_local0 then
			...
			if not f19_arg0._hasSetupVisualStates then
				...
				CODCASTER.SetupVisualStateHandler( f19_arg0, f19_arg0, f19_arg0, {
					dataSources = {
					...
					onState = function ( f22_arg0, f22_arg1, f22_arg2 )
						f22_arg0:SetButtonDisabled( CODCASTER.GetCurrentVisualState( f22_arg0 ) == "Locked" )
					end
				} )
			end
		end
...
local f0_local5 = function ( f17_arg0, f17_arg1 )
	...
	local f17_local3 = Engine[0xED84C33EC5F01EA]( "CODCASTER/EDIT_COLOR" )
	...
	OSK[0xC1C15C14B75864C]( f17_local0, f17_local3, f17_local4, f0_local0, true, false, false, function ( f18_arg0, f18_arg1, f18_arg2 )
		...
		elseif f18_arg2 ~= f17_arg0 then
			local f18_local3 = Engine[0xED84C33EC5F01EA]( "CODCASTER/INVALID_HEX_CODE" )
			LUI.FlowManager.RequestErrorPopup( f18_local3, f18_local3 )
		end
...
local f0_local8 = function ( f6_arg0, f6_arg1, f6_arg2 )
	...
	CODCASTER.SetupAdvancedDataSourceGrid( f6_arg0.ColorsList )
	...
	if CODCASTER_CONDITIONS.IsTeamSettingsCustomColorsEnabled() then
		f6_arg0:SubscribeToModelThroughElement( f6_arg0, "editedColor", function ( f10_arg0 )
			...
			f6_arg0.HexCodeLabel:setText( Engine[0xED84C33EC5F01EA]( "CODCASTER/HEX_CODE", Engine[0x7D3158A9539A355]( COLORS_UTILS.RGBToHex( GetColorTableFromIntColor( f10_local0 ) ) ) ) )
		end )
		...
		f6_arg0:SubscribeToModelThroughElement( f6_arg0, nil, function ( f7_arg0 )
			...
			if not f6_arg0.EditColorPreview._isVisualStateSetup then
				CODCASTER.SetupVisualStateHandler( f6_arg0.EditColorPreview, f6_arg0, f6_arg0, {
					dataSources = {
...
function CodCasterTeamColorSelector( menu, controller )
	...
	if CODCASTER_CONDITIONS.IsTeamSettingsCustomColorsEnabled() then
		...
		f1_local4.Label:setText( Engine[0xED84C33EC5F01EA]( "CODCASTER/EDIT_COLOR" ), 0 )
	...
	ColorTypeTitle:SetRGBFromTable( SWATCHES.text.buttonTextDefault, 0 )
	ColorTypeTitle:setText( Engine[0xED84C33EC5F01EA]( "CODCASTER/TEAM_PRIMARY_COLOR_COLON" ), 0 )
	...
	if CODCASTER_CONDITIONS.IsTeamSettingsCustomColorsEnabled() then
		...
		f1_local7:SetRGBFromTable( SWATCHES.text.buttonTextDefault, 0 )
		f1_local7:setText( Engine[0xED84C33EC5F01EA]( "CODCASTER/HEX_CODE" ), 0 )
		f1_local7:SetFont( FONTS.GetFont( FONTS.MainRegularHeader.File ) )
