...
local f0_local2 = function ( f10_arg0, f10_arg1, f10_arg2 )
	assert( f10_arg0.NextRank )
	assert( f10_arg0.CurrentRank )
	f10_arg2 = LUI.clamp( f10_arg2, 0, 1 )
	f10_arg0.MatchXPProgressBar.Mask:SetRightAnchor( 1 - f10_arg2, 0 )
	f10_arg0.Playhead:SetRightAnchor( 1 - f10_arg2, 0 )
	f10_arg0.curFillRate = f10_arg2
end

local f0_local3 = function ( f9_arg0, f9_arg1, f9_arg2, f9_arg3 )
	assert( f9_arg0.NextRank )
	assert( f9_arg0.CurrentRank )
	local f9_local0 = PROGRESSION.GetRankDisplay( f9_arg2 )
	local f9_local1 = PROGRESSION.GetRankDisplay( f9_arg3 )
	if f9_arg3 then
		local f9_local2 = PROGRESSION.GetRankIcon( f9_arg3 )
		if f9_local2 and 0 < #f9_local2 then
			f9_arg0.NextRank.Icon:setImage( RegisterMaterial( f9_local2 ) )
		end
		f9_arg0.NextRank:UpdateRank( f9_local1 )
	end
	if f9_arg2 then
		local f9_local2 = PROGRESSION.GetRankIcon( f9_arg2 )
		if f9_local2 and 0 < #f9_local2 then
			f9_arg0.CurrentRank.Icon:setImage( RegisterMaterial( f9_local2 ) )
		end
		f9_arg0.CurrentRank:UpdateRank( f9_local0 )
	end
end
...
local f0_local5 = function ( f6_arg0, f6_arg1, f6_arg2 )
	...
	local f6_local7 = PROGRESSION.GetRankDisplay( f6_local3 )
	local f6_local8 = PROGRESSION.GetRankDisplay( f6_local4 )
	if f6_local6 then
		...
		if f6_local3 then
			local f6_local9 = PROGRESSION.GetRankIcon( f6_local3 )
			if f6_local9 and 0 < #f6_local9 then
				f6_arg0.CurrentRank.Icon:setImage( RegisterMaterial( f6_local9 ) )
			end
			f6_arg0.CurrentRank.NextText:setText( f6_local7 )
	...
	if f6_arg0.curFillRate == nil or f6_local1 < f6_arg0.curFillRate then
		...
		local f6_local9 = f0_local0
	end
	local f6_local9 = (f6_local1 - f6_arg0.curFillRate) * 10 * f0_local0
	if f6_local9 == 0 then
		f6_local9 = 1
	end
	if f6_local4 then
		local f6_local10 = PROGRESSION.GetRankIcon( f6_local4 )
		if f6_local10 and 0 < #f6_local10 then
			f6_arg0.NextRank.Icon:setImage( RegisterMaterial( f6_local10 ) )
		end
		f6_arg0.NextRank:UpdateRank( f6_local8 )
	end
	if f6_local3 then
		...
		f6_arg0.CurrentRank:UpdateRank( f6_local7 )
	end
	f6_arg0.MatchXPProgressBar.Mask:SetRightAnchor( 1 - f6_arg0.curFillRate, 0 )
	f6_arg0.MatchXPProgressBar.Mask:SetRightAnchor( 1 - f6_local1, f6_local9, LUI.EASING.inOutQuartic )
	f6_arg0.Playhead:SetRightAnchor( 1 - f6_arg0.curFillRate, 0 )
	f6_arg0.Playhead:SetRightAnchor( 1 - f6_local1, f6_local9, LUI.EASING.inOutQuartic )
	if 1 < f6_local9 then
		Engine[0xC4146BA76D0F982]( SOUND_SETS.aarrewards.progressBar )
		local f6_local10 = 0.1
		local f6_local11 = f6_local9 - f6_local9 * 0.1
		if f6_local11 <= 0 then
			f6_local11 = 1
		else
			
		end
		local f6_local12 = f6_arg0:Wait( f6_local11 )
...
function AARProgressBar( menu, controller )
	...
	ToNextRankXP:SetFont( FONTS.GetFont( FONTS.PrimaryRegular.File ) )
	ToNextRankXP:SetFontSize( 18 * _PT )
	ToNextRankXP:SetMinFontSize( 18 * _PT )
