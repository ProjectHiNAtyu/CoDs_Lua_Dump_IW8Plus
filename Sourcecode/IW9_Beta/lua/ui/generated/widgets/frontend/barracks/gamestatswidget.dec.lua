...
local f0_local0 = function ( f3_arg0, f3_arg1 )
	...
	for f3_local4 = 1, #f3_arg0._Bars, 1 do
		...
		f3_local8.Label:setText( Engine[0x7D3158A9539A355]( string.format( "%.2f", f3_local7 ) ) )
		if f3_local7 <= 0 then
...
local f0_local1 = function ( f2_arg0, f2_arg1, f2_arg2 )
	...
	f2_arg0._Labels[1]:setText( Engine[0xED84C33EC5F01EA]( 0x49F977224A95E5D ) )
	for f2_local12 = 2, #f2_arg0._Labels, 1 do
		f2_arg0._Labels[f2_local12]:setText( Engine[0xED84C33EC5F01EA]( 0x1BB4904C17728CF, f2_local12 ) )
	end
end
...
function GameStatsWidget( menu, controller )
	...
	AvgLabel:setText( Engine[0xED84C33EC5F01EA]( 0x854B231C6299E85 ), 0 )
	AvgLabel:SetFont( FONTS.GetFont( FONTS.PrimaryRegular.File ) )
	AvgLabel:SetFontSize( 28 * _PT )
	AvgLabel:SetMinFontSize( 18 * _PT )
