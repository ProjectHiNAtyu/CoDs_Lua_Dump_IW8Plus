...
function BarracksChallengesDailyContainer( menu, controller )
	...
	if not CONDITIONS.IsWZWipFlowEnabled() then
		f1_local7 = MenuBuilder.BuildRegisteredType( "BarracksChallengesDaily", {
			controllerIndex = f1_local1
		} )
		f1_local7.id = "BarracksChallengesDaily"
		f1_local7:SetAnchorsAndPosition( 0, 0, 0, 0, 0, 0, 0, 0 )
		self:addElement( f1_local7 )
		self.BarracksChallengesDaily = f1_local7
	end
	local f1_local8 = nil
	if CONDITIONS.IsWZWipFlowEnabled() then
		f1_local8 = MenuBuilder.BuildRegisteredType( "WZBarracksChallengesDaily", {
			controllerIndex = f1_local1
		} )
		f1_local8.id = "WZWipBarracksChallengesDaily"
		f1_local8:SetAnchorsAndPosition( 0, 0, 0, 0, 0, 0, 0, 0 )
		self:addElement( f1_local8 )
		self.WZWipBarracksChallengesDaily = f1_local8
	end
