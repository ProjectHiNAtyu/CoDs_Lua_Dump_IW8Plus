...
local f0_local12 = function ( f10_arg0 )
	...
	for f10_local7, f10_local8 in pairs( f10_arg0._talkers ) do
		if f10_local8.gamertag then
			f10_local8:setText( Engine[0xED84C33EC5F01EA]( 0x1F66995F0749E75, Engine[0x7D3158A9539A355]( f10_local8.gamertag ) ) )
...
f0_local13 = function ( f8_arg0 )
	...
	if Engine[0x2DA54CF5D6B7F02]() and Dvar[0x9E5BE3B4BBA4E0E]( f0_local0 ) == true then
		...
		f8_local1 = Social[0xE30C6358EF728A1]()
	end
