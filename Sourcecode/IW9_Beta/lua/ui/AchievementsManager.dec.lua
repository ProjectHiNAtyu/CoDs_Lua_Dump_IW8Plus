...
local f0_local0 = function ( f8_arg0, f8_arg1 )
	if f8_arg1 == nil or f8_arg0.achievementsList[f8_arg1] == nil then
		...
		LUI.ToastManager.CreateToast( f8_arg0._controllerIndex, LUI.ToastManager.StandardEmphasisToast( Engine[0xED84C33EC5F01EA]( 0x17F0717CCB6C4EA ), Engine[0xED84C33EC5F01EA]( f8_arg0.achievementsList[f8_arg1].name ), LUI.ToastManager.ToastNotificationType.Unlocks ) )
	end
end
