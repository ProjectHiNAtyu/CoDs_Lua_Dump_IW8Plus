...
LUI.UIRadialProgressBar.init = function ( f10_arg0, f10_arg1 )
	...
	local f10_local1
	if f10_arg1.snapToMultiplesOfAngle ~= nil and type( f10_arg1.snapToMultiplesOfAngle ) ~= "number" then
		f10_local1 = false
	else
		f10_local1 = true
	end
	f10_local0( f10_local1 )
	assert( 1 < f10_arg1.segmentCount )
	assert( f10_arg1.segmentMaterial )
	f10_local0 = assert
	f10_local1 = f10_arg1.maskMaterial
	if not f10_local1 then
		f10_local1 = f10_arg1.segmentCount < 3
	end
	f10_local0( f10_local1 )
	...
	f10_arg0.useCodeImplementation = f10_arg0.segmentCount < 3
	...
	if f10_arg0.useCodeImplementation then
		...
		f10_arg0:CreateSegments( f10_arg1.segmentMaterial, f10_arg1.maskMaterial, f10_arg1.counterClockwise )
...
LUI.UIRadialProgressBar.SetProgress = function ( f8_arg0, f8_arg1, f8_arg2, f8_arg3 )
	...
	if type( f8_arg0.percentUpdateCompleteFunc ) == "function" then
