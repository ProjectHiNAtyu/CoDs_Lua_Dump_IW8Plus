...
function LobbyMemberStats( menu, controller )
	...
	Wins.id = "Wins"
	Wins.Title:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU/WINS" ), 0 )
	...
	Streak.id = "Streak"
	Streak.Title:setText( Engine[0xED84C33EC5F01EA]( "MP_FRONTEND_ONLY/WIN_STREAK" ), 0 )
	...
	WinLoss.id = "WinLoss"
	WinLoss.Title:setText( Engine[0xED84C33EC5F01EA]( "MENU/WLRATIO" ), 0 )
	...
	KD.id = "KD"
	KD.Title:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU/KD_RATIO" ), 0 )
