...
LUI.InWorldManager.UpdateWidgetsVisibility = function ( f6_arg0, f6_arg1 )
	local f6_local0 = AnyActiveMenusInStack( LUI.UIRoot.GetRootForControllerIndex( f6_arg1 ) )
	local f6_local1 = CONDITIONS.IsNukeEndState( f6_arg0, f6_arg1 )
	local f6_local2 = Game.BFEEGCHICA( f6_arg1, "ui_hide_hud" )
	local f6_local3
	if not f6_local0 then
		f6_local3 = f6_local0
	elseif not f6_local1 then
		f6_local3 = f6_local1
	else
		f6_local3 = f6_local2
	end
	if f6_local3 and f6_arg0.headIcons then
...
LUI.InWorldManager.MPRegisterUpdateWidgetVisibilityHandlers = function ( f4_arg0, f4_arg1 )
	...
	f4_arg0:registerOmnvarHandler( "ui_hide_hud", f4_local0 )
...
LUI.InWorldManager.InitLayer = function ( f2_arg0 )
	...
	if Engine.ECHCFGDDDF() then
		f2_arg0.BombTimerContainer = MenuBuilder.BuildRegisteredType( "BombTimerContainer", {
			controllerIndex = f2_arg0._controllerIndex
		} )
		f2_arg0:addElement( f2_arg0.BombTimerContainer )
