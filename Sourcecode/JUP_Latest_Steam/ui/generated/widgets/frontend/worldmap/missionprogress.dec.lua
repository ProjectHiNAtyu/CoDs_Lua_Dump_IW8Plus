...
function MissionProgress( f1_arg0, f1_arg1 )
	local f1_local0 = LUI
	local f1_local1 = MenuBuilder
	local f1_local2 = f1_local0.UIElement.new()
	f1_local2:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 350, 0, 30 )
	f1_local2.id = "MissionProgress"
	local f1_local3
	if f1_arg1 then
		f1_local3 = f1_arg1
	else
	...
	f1_local5:SetAnchorsAndPosition( 0, 1, 0, 1, 268, 346, 5, 27 )
	f1_local2:addElement( f1_local5 )
	f1_local2[0xDC3F0A47C2A0E07] = f1_local5
	return f1_local2
end

MenuBuilder.registerType( 0x1F3D2750E4AE8F2, MissionProgress )
LockTable( _M )
