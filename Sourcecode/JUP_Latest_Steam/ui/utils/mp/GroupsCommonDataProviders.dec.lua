...
local f0_local1 = function ( f18_arg0 )
	if f18_arg0 == "Officers" or f18_arg0 == "Members" then
		return Dvar[0x22EAAB59AA27E9B]( 0xC0EB4EEDBEAF2F4 )
...
f0_local0.SetupDataFetch = function ( f14_arg0, f14_arg1 )
	...
	local f14_local6 = f14_arg1.filterFunc
	if not f14_local6 then
		f14_local6 = GROUPS.CommonDataProviders.FilterFunc
	end
	local f14_local7 = nil
	local f14_local8 = f14_arg1.role
	if not f14_local8 then
		f14_local8 = f0_local0( f14_arg0.label )
	end
	if f14_local8 then
		f14_local7 = GROUPS.CommonDataProviders.GetFetchMembersFuncByRole( f14_local0, f14_arg0.provider, f14_local8, f14_local4, f14_local5 )
	else
		f14_local7 = GROUPS.CommonDataProviders.GetFetchBannedFunc( f14_local0, f14_arg0.provider, f14_local4 )
	end
	if f14_arg1.window then
		...
		f14_arg1.window:addEventHandler( "on_close", function ( f15_arg0, f15_arg1 )
			...
			f14_arg0.provider:SetErrorHandler( nil )
		end )
	end
	f14_arg0.provider:SetFetchRequest( f14_local7 )
	f14_arg0.provider:SetSpinner( GROUPS.CommonDataProviders.SpinnerFunc )
	f14_arg0.provider:SetFilterFunc( f14_local6 )
	return f14_arg0
end
