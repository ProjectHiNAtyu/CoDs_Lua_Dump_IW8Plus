...
LUI.AddStickLayoutLogic = function ( f1_arg0, f1_arg1, f1_arg2 )
	...
	local f1_local2 = LUI.DataSourceInGlobalModel.new( f0_local0 .. ".oldColor", SWATCHES[0x3E789DB0A12E313][0xF046B6ADEBDABE2] )
	local f1_local3 = LUI.DataSourceInGlobalModel.new( f0_local0 .. ".newColor", SWATCHES[0x91C92D7BD2A93C4][0xE24310977B6DEEB] )
