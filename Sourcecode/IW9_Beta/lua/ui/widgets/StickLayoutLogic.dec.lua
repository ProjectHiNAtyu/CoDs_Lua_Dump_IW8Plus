...
LUI.AddStickLayoutLogic = function ( f1_arg0, f1_arg1, f1_arg2 )
	...
	local f1_local5 = function ( f8_arg0, f8_arg1 )
		...
		local f8_local2 = {
			...
			name = LUI.DataSourceInGlobalModel.new( f8_local1 .. ".name", Engine[0xED84C33EC5F01EA]( f8_local0.name ) )
		}
		local f8_local3 = {
			up = LUI.DataSourceInGlobalModel.new( f8_local1 .. ".left.up", Engine[0xED84C33EC5F01EA]( f8_local0.leftUp ) ),
			upColor = f1_arg0( f8_local0, "leftUp" ),
			down = LUI.DataSourceInGlobalModel.new( f8_local1 .. ".left.down", Engine[0xED84C33EC5F01EA]( f8_local0.leftDown ) ),
			downColor = f1_arg0( f8_local0, "leftDown" ),
			left = LUI.DataSourceInGlobalModel.new( f8_local1 .. ".left.left", Engine[0xED84C33EC5F01EA]( f8_local0.leftLeft ) ),
			leftColor = f1_arg0( f8_local0, "leftLeft" ),
			right = LUI.DataSourceInGlobalModel.new( f8_local1 .. ".left.right", Engine[0xED84C33EC5F01EA]( f8_local0.leftRight ) ),
			rightColor = f1_arg0( f8_local0, "leftRight" ),
			button = LUI.DataSourceInGlobalModel.new( f8_local1 .. ".left.button", Engine[0xED84C33EC5F01EA]( f8_local0.leftButton ) ),
			buttonColor = f1_arg0( f8_local0, "leftButton" )
		}
		local f8_local4 = LUI.DataSourceInGlobalModel.new
		local f8_local5 = f8_local1 .. ".left.showLeftStick"
		local f8_local6
		if f8_local0.leftUp == f1_arg0.leftUp and f8_local0.leftDown == f1_arg0.leftDown and f8_local0.leftLeft == f1_arg0.leftLeft and f8_local0.leftRight == f1_arg0.leftRight and f8_local0.leftButton == f1_arg0.leftButton then
			f8_local6 = false
		else
			f8_local6 = true
		end
		f8_local3.showLeftStick = f8_local4( f8_local5, f8_local6 )
		f8_local2.left = f8_local3
		f8_local3 = {
			up = LUI.DataSourceInGlobalModel.new( f8_local1 .. ".right.up", Engine[0xED84C33EC5F01EA]( f8_local0.rightUp ) ),
			upColor = f1_arg0( f8_local0, "rightUp" ),
			down = LUI.DataSourceInGlobalModel.new( f8_local1 .. ".right.down", Engine[0xED84C33EC5F01EA]( f8_local0.rightDown ) ),
			downColor = f1_arg0( f8_local0, "rightDown" ),
			left = LUI.DataSourceInGlobalModel.new( f8_local1 .. ".right.left", Engine[0xED84C33EC5F01EA]( f8_local0.rightLeft ) ),
			leftColor = f1_arg0( f8_local0, "rightLeft" ),
			right = LUI.DataSourceInGlobalModel.new( f8_local1 .. ".right.right", Engine[0xED84C33EC5F01EA]( f8_local0.rightRight ) ),
			rightColor = f1_arg0( f8_local0, "rightRight" ),
			button = LUI.DataSourceInGlobalModel.new( f8_local1 .. ".right.button", Engine[0xED84C33EC5F01EA]( f8_local0.rightButton ) ),
			buttonColor = f1_arg0( f8_local0, "rightButton" )
		}
		f8_local4 = LUI.DataSourceInGlobalModel.new
		f8_local5 = f8_local1 .. ".right.showRightStick"
		if f8_local0.rightUp == f1_arg0.rightUp and f8_local0.rightDown == f1_arg0.rightDown and f8_local0.rightLeft == f1_arg0.rightLeft and f8_local0.rightRight == f1_arg0.rightRight and f8_local0.rightButton == f1_arg0.rightButton then
			f8_local6 = false
		else
			f8_local6 = true
		end
		f8_local3.showRightStick = f8_local4( f8_local5, f8_local6 )
		f8_local2.right = f8_local3
		return f8_local2
	end
	
	local f1_local6 = function ( f7_arg0, f7_arg1 )
		f1_arg0:SetDataSource( f1_arg0[f7_arg0], f7_arg1 )
		Engine[0xB02A448C4130634]( f1_arg0._dataSource.ref:GetValue( f7_arg1 ), f7_arg1 )
	end
