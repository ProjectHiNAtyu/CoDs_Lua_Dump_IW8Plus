...
CLANS.IsValidClan = function ( f38_arg0 )
	...
	assert( f38_local0, "Clan ID must be a string to support uint64" )
	local f38_local1
	...
	assert( f38_local1, "Clan ID string is blank or too large for a uint64 number" )
	local f38_local2
	if f38_local0 then
...
CLANS.GetLeaderboardTierColor = function ( f1_arg0 )
	if f1_arg0 == CLANS.LeaderboardTier.STANDARD_TIER then
		return SWATCHES.vClanTiers.tier1, "^3"
