...
local f0_local0 = "#x37a05849f08b72606"
...
local f0_local12 = function ( f10_arg0 )
	...
	for f10_local7, f10_local8 in pairs( f10_arg0._talkers ) do
		if f10_local8.gamertag then
			f10_local8:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU/TALKER_X", Engine[0x7D3158A9539A355]( f10_local8.gamertag ) ) )
...
f0_local13 = function ( f8_arg0, f8_arg1 )
	...
	local f8_local1 = nil
	if Engine[0x2DA54CF5D6B7F02]() and Dvar[0x9E5BE3B4BBA4E0E]( f0_local0 ) == true then
		f8_local1 = f8_arg0._aiTalkers
	else
		f8_local1 = Friends[0xE30C6358EF728A1]( f8_arg1 )
	end
...
function SocialPartyWidgetTalkers( menu, controller )
	...
	Talker1:SetFont( FONTS.GetFont( FONTS.MainRegularHeader.File ) )
	Talker1:SetFontSize( 16 * _PT )
	Talker1:SetMinFontSize( 16 * _PT )
	...
	Talker2:SetFont( FONTS.GetFont( FONTS.MainRegularHeader.File ) )
	Talker2:SetFontSize( 16 * _PT )
	Talker2:SetMinFontSize( 16 * _PT )
	...
	Talker3:SetFont( FONTS.GetFont( FONTS.MainRegularHeader.File ) )
	Talker3:SetFontSize( 16 * _PT )
	Talker3:SetMinFontSize( 16 * _PT )
	...
	self._sequenceLengths.TalkerX1 = 0
	local f1_local8 = nil
	...
	self._sequenceLengths.TalkerX2 = 0
	local f1_local9 = nil
	...
	self._sequenceLengths.TalkerX3 = 0
	...
	self._sequenceLengths.TalkerX0 = 0
