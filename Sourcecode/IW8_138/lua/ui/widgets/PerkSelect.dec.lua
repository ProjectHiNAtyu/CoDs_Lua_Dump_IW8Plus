...
local f0_local0 = function ()
	...
	if not CONDITIONS.IsThirdGameMode() then
		f53_local0 = not CONDITIONS.InGameAndBR()
	else
		f53_local0 = false
	end
	return f53_local0
...
local f0_local1 = function ( f52_arg0, f52_arg1, f52_arg2, f52_arg3, f52_arg4, f52_arg5, f52_arg6, f52_arg7, f52_arg8, f52_arg9, f52_arg10 )
	f52_arg0.InfoPanel.ItemName:setText( f52_arg2 )
	f52_arg0.InfoPanel:SetupPatchNotes( f52_arg1, f52_arg9 )
	local f52_local0 = f52_arg0.InfoPanel:UpdateDescription( {
		newDesc = f52_arg3,
		isUnlocked = f52_arg4,
		unlockText = f52_arg5,
		isNew = f52_arg6,
		extraDesc = f52_arg7,
		isRestricted = f52_arg8,
		unlockRank = f52_arg10
	} )
	if f52_arg0.BRWarningInfoFEPro then
		local f52_local1 = 120 * _1080p
		local f52_local2 = f52_arg0.InfoPanel:GetCurrentAnchorsAndPositions()
		f52_local2 = f52_local2.top
		local f52_local3 = LAYOUT.GetElementHeight( f52_arg0.BRWarningInfoFEPro )
		f52_arg0.BRWarningInfoFEPro:SetTop( f52_local2 + f52_local0 + f52_local1 + f52_local3, 200 )
		f52_arg0.BRWarningInfoFEPro:SetBottom( f52_local2 + f52_local0 + f52_local1 + f52_local3 * 2, 200 )
	end
end

local f0_local2 = function ( f51_arg0, f51_arg1, f51_arg2 )
	f51_arg0.BasePerk:UpdatePerk( f51_arg2.basePerk )
	f51_arg0.UpgradePerk1:UpdatePerk( f51_arg2.upgradePerk1 )
	f51_arg0.UpgradePerk2:UpdatePerk( f51_arg2.upgradePerk2 )
end

local f0_local3 = function ( f50_arg0, f50_arg1 )
	CLIENT_MODEL.SetModel( f50_arg0, f50_arg1 )
end

local f0_local4 = function ( f49_arg0, f49_arg1, f49_arg2, f49_arg3 )
	if CONDITIONS.InFrontend() and f49_arg0.perkType == f49_arg2 then
		if f49_arg2 == Cac.PerkTypes.CORE then
			f0_local0( CLIENT_MODEL.coreMPModels.PERK_PATCH, f49_arg3 )
		elseif f49_arg2 == Cac.PerkTypes.ACTIVE then
			f0_local0( CLIENT_MODEL.coreMPModels.PERK_ACTIVE_PATCH, f49_arg3 )
		elseif f49_arg2 == Cac.PerkTypes.PASSIVE then
			f0_local0( CLIENT_MODEL.coreMPModels.PERK_PASSIVE_PATCH, f49_arg3 )
		elseif f49_arg2 == Cac.PerkTypes.SPECIAL_ONE then
			f0_local0( CLIENT_MODEL.coreMPModels.PERK_PATCH_SPECIALIST, f49_arg3 )
		elseif f49_arg2 == Cac.PerkTypes.SPECIAL_TWO then
			f0_local0( CLIENT_MODEL.coreMPModels.PERK_ACTIVE_PATCH_SPECIALIST, f49_arg3 )
		elseif f49_arg2 == Cac.PerkTypes.SPECIAL_THREE then
			f0_local0( CLIENT_MODEL.coreMPModels.PERK_PASSIVE_PATCH_SPECIALIST, f49_arg3 )
		end
	end
end

local f0_local5 = function ( f48_arg0, f48_arg1, f48_arg2 )
...
local f0_local6 = function ( f47_arg0, f47_arg1, f47_arg2, f47_arg3 )
	local f47_local0 = 1
...
local f0_local9 = function ( f44_arg0, f44_arg1, f44_arg2, f44_arg3 )
...
local f0_local10 = function ( f41_arg0, f41_arg1, f41_arg2, f41_arg3, f41_arg4 )
	...
	if f40_local0.id == "PerkSelect" then
		if Engine.DDJFBBJAIG() and Engine.ECHCFGDDDF() then
			...
			if f40_local0.perkType == Cac.PerkTypes.SPECIAL_ONE or f40_local0.perkType == Cac.PerkTypes.SPECIAL_TWO or f40_local0.perkType == Cac.PerkTypes.SPECIAL_THREE then
				local f40_local4 = LOADOUT.GetPerkDataByField( f40_local2, CSV.perks.cols.specialistModel )
				if f40_local4 and 0 < #f40_local4 then
					f40_local3 = f40_local4
				end
			end
			f0_local0( f40_local0, f40_arg1, f40_local0.perkType, f40_local3 )
		end
		local f40_local1
		if f40_arg3 then
...
local f0_local13 = function ( f32_arg0, f32_arg1 )
	...
	for f32_local0 = 0, StringTable.BFHCAIIDA( CSV.menuPerks.file ) - 1, 1 do
		...
		if Engine.DDJFBBJAIG() or not f32_local4.isRestricted then
		...
		if Engine.DDJFBBJAIG() then
			...
			if f16_local1 and f16_local1 > Cac.PerkTypes.NONE then
				...
				if f16_local1 == Cac.PerkTypes.SPECIAL_ONE or f16_local1 == Cac.PerkTypes.SPECIAL_TWO or f16_local1 == Cac.PerkTypes.SPECIAL_THREE then
					local f16_local3 = LOADOUT.GetPerkDataByField( f16_local0.ref, CSV.perks.cols.specialistModel )
					if f16_local3 and 0 < #f16_local3 then
