...
function ContractRewardBox( menu, controller )
	...
	Title:setText( ToUpperCase( Engine.CBBHFCGDIC( "LUA_MENU/REWARD" ) ), 0 )
	...
	Flare2.id = "Flare2"
	Flare2:SetRGBFromTable( SWATCHES.CashPlacement.PlatinumBody, 0 )
	...
	Flare.id = "Flare"
	Flare:SetRGBFromTable( SWATCHES.Reticles.Highlight, 0 )
