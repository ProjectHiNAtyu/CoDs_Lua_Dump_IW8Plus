...
local f0_local7 = 804
local f0_local8 = {
	iw9_s4_ch_fob_daily_urgent_unlock_white_lotus = "white_lotus",
	iw9_s4_ch_fob_daily_urgent_unlock_black_mous = "black_mous",
	iw9_s4_ch_fob_daily_urgent_unlock_crown = "crown",
	iw9_s4_ch_fob_daily_urgent_unlock_phalanx = "phalanx"
}
local f0_local9 = function ( f12_arg0, f12_arg1, f12_arg2, f12_arg3 )
	...
	for f12_local2 = 1, f12_local1, 1 do
		...
		if f12_local5.category == "communications_station" then
			f12_local8 = f12_arg0._dailyChallengeUnlocks[f12_local5.id]
			local f12_local9 = DMZ.GetPMCUnlockRequirement( f12_local8, f12_arg1 )
			local f12_local10
			if f12_local8 ~= "crown" and not f12_local9 then
				f12_local10 = f12_local9
			else
				f12_local10 = ""
			end
			f12_local5.factionUnlockString = f12_local10
...
local f0_local12 = function ( f9_arg0, f9_arg1 )
	...
	for f9_local1 = 1, #f9_arg0._trackButtons, 1 do
		...
		f9_local4:SetAnchorsAndPosition( 0, 1, 0, 1, 0, f0_local0, f9_local0, f9_local0 + f9_local5, f0_local0 )
	...
	for f8_local2 = 1, #f8_local0, 1 do
		...
		if f8_local6:HasChildren() and not f8_local6:IsExpanded() then
			...
			if not f8_local7 then
				...
				f8_local6:SetAnchorsAndPosition( 0, 1, 0, 1, 0, f0_local0, f8_local1, f8_local1 + f8_local7 )
...
local f0_local16 = function ( f2_arg0, f2_arg1, f2_arg2 )
	...
	f2_arg0._dailyChallengeUnlocks = {}
	for f2_local3, f2_local4 in pairs( f0_local0 ) do
		f2_arg0._dailyChallengeUnlocks[StringTable[0x2DCF0973239E909]( CSV.baseChallenges.file, CSV.baseChallenges.cols.ref, f2_local3, CSV.baseChallenges.cols.id )] = f2_local4
	end
...
function DMZBaseList( f1_arg0, f1_arg1 )
	local f1_local0 = LUI
	local f1_local1 = f1_local0.UIElement.new()
	f1_local1:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 556, 0, 804 )
	f1_local1.id = "DMZBaseList"
	local f1_local2
	if f1_arg1 then
		f1_local2 = f1_arg1
	else
...
MenuBuilder.registerType( 0xC4360998A9AFBA1, DMZBaseList )
LockTable( _M )
