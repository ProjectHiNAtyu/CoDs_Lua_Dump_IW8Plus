...
local f0_local3 = function ( f7_arg0, f7_arg1 )
	...
	f7_arg0.m_rightMouseDown = false
end
...
function FrontendCameraMover( f1_arg0, f1_arg1 )
	...
	self.closeTree = function ( f4_arg0 )
		f4_arg0:CleanupFrontendCameraMover()
	...
	if f1_arg1.useMousePan then
		self:SetHandleMouse( true )
		if f1_arg1.panWithRightMouseButton then
			self:addEventHandler( "rightMouseDrag", f0_local0 )
			self:addEventHandler( "rightmousedown", f0_local0 )
			self:addEventHandler( "rightmouseup", f0_local0 )
		else
			self:addEventHandler( "mousedrag", f0_local0 )
