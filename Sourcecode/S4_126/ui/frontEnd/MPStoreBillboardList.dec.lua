...
local f0_local9 = function ( f66_arg0, f66_arg1 )
	...
	if f66_local0.previewBundleID then
		if 0 < Loot[0xB7D304F1F31158E]( f66_arg0._controllerIndex, tonumber( f66_local0.previewBundleID ) ) then
			f66_local1 = f66_arg1
		end
...
local f0_local10 = function ( f65_arg0 )
	if f65_arg0._storeEmpty then
		if f65_arg0._lowestAvailableTime ~= "9999999999" and f65_arg0._lowestTimeDvar ~= "" then
			...
			local f65_local3 = Engine[0xED84C33EC5F01EA]( "STORE/STORE_EMPTY", f65_local1 )
...
local f0_local11 = function ( f64_arg0 )
	...
	for f64_local0 = 1, #f64_arg0._allCategoryData, 1 do
		...
		if f64_local3.timerPubVar then
			local f64_local4 = Dvar[0x54084D7CA2317BB]( f64_local3.timerPubVar )
			if not f64_local4 or 0 >= #f64_local4 or not f64_local4 then
				f64_local4 = Engine[0xF16311E3FCA3DCF]()
			end
			if 0 < Engine[0x81B9C166599CE22]( tostring( f64_local4 ) ) and f64_local4 < f64_arg0._lowestAvailableTime then
...
local f0_local12 = function ( f63_arg0, f63_arg1, f63_arg2 )
	local f63_local0 = {}
	local f63_local1 = f63_arg2.items[1] or {}
	if f63_arg2.idPubVar and f63_local1.layoutOnlyItem then
		local f63_local2 = Dvar[0x54084D7CA2317BB]( f63_arg2.idPubVar ) or ""
		...
		for f63_local5 = 1, #f63_local3, 1 do
			...
			if STORE.BundleAvailable( f63_arg1, f63_local8 ) then
				...
				local f63_local11 = StringTable[0x8073B436CDE1BF]( CSV.bundleIDs.file, CSV.bundleIDs.cols.id, f63_local3[f63_local5] )
				if f63_local11 ~= -1 then
					local f63_local12 = CSV.ReadRow( f63_local10, f63_local11 )
					f63_local9.name = f63_local12.name
					f63_local9.asset = f63_local12.image
					f63_local9.description = STORE.GetBundleDescription( f63_local9.id )
					f63_local9.rarity = f63_local12.rarity
					f63_local9.bundleType = f63_local12.bundleType
					f63_local9.titleImage = f63_local12.titleImage
					f63_local9.currencyID = tonumber( f63_local12.currencyID )
					f63_local9.currencyAmount = tonumber( f63_local12.currencyAmount )
					local f63_local13
					if 0 < #f63_local12.firstPartyProductID then
						f63_local13 = f63_local12.firstPartyProductID
						if not f63_local13 then
						
						else
							f63_local9.firstPartyProductID = f63_local13
							if 0 < #f63_local12.video then
								f63_local13 = f63_local12.video
								if not f63_local13 then
								
								else
									f63_local9.video = f63_local13
	...
	if #f63_local0 == 0 then
		...
		if not f63_local2.usesFirstPartyStore then
			...
			f63_local2.asset = "v_ui_bg_generic"
		end
...
local f0_local13 = function ( f55_arg0 )
	return function ( f56_arg0, f56_arg1, f56_arg2 )
		...
		local f56_local1 = function ()
			...
			QUARTERMASTER.BeginMenuBrowseEvent( f56_arg0._controllerIndex, f60_local2, f60_local3 )
		end
...
local f0_local14 = function ( f54_arg0, f54_arg1, f54_arg2 )
	...
	if f54_local0 and f54_local1 then
		...
		LUI.FlowManager.RequestPopupMenu( f54_arg0, "MessagePopup", true, controllerIndex, false, {
...
local f0_local15 = function ( f53_arg0, f53_arg1 )
	local f53_local0 = STORE.GetCategoryIndex( f53_arg1 )
...
local f0_local16 = function ( f4_arg0, f4_arg1, f4_arg2 )
	f4_arg0.FocusBundleByID = function ( f52_arg0, f52_arg1, f52_arg2 )
		f4_arg0( f4_arg0, f52_arg1, f52_arg2 )
	end
	...
	local f4_local1 = function ( f48_arg0 )
	...
	local f4_local4 = function ( f40_arg0 )
	...
	local f4_local5 = function ( f39_arg0, f39_arg1, f39_arg2, f39_arg3 )
		if f39_arg0 then
	...
	local f4_local6 = function ( f37_arg0, f37_arg1 )
		f37_arg0.Name:setText( Engine[0xED84C33EC5F01EA]( f37_arg1.name ) )
		if f37_arg0.Owned.Text then
			local f37_local0 = Loot[0xB7D304F1F31158E]( f4_arg0, f37_arg1.id )
	...
	local f4_local9 = {}
	local f4_local10 = function ( f35_arg0, f35_arg1, f35_arg2, f35_arg3, f35_arg4 )
	...
	local f4_local11 = {}
	local f4_local12 = function ( f34_arg0, f34_arg1, f34_arg2 )
	...
	local f4_local13 = _1080p * 350 + _1080p * 10
	local f4_local14 = {
		{
			{
				posL = 0,
	...
	local f4_local15 = {}
	local f4_local16 = function ( f33_arg0 )
	...
	local f4_local17 = {}
	local f4_local18 = function ( f32_arg0, f32_arg1, f32_arg2, f32_arg3, f32_arg4 )
	...
	local f4_local20 = function ( f30_arg0 )
		f4_arg0 = {}
		f4_arg0 = {}
		f4_arg0 = {}
		f4_arg0 = {}
	...
	local f4_local21 = {
		button_over = {
			...
			[StoreItemLayout.CUSTOM] = function ( f25_arg0, f25_arg1, f25_arg2, f25_arg3 )
				f4_arg0()
				f4_arg0( Engine[0x7EC0C425E339DCD]( f25_arg2.layoutName ) )
			...
			[StoreItemLayout.BILLBOARD_LIST] = function ( f23_arg0, f23_arg1, f23_arg2, f23_arg3 )
				...
				QUARTERMASTER.BeginMenuBrowseEvent( f4_arg0, f23_arg2, f23_local0[1] )
			...
			[StoreItemLayout.BILLBOARD_LIST] = function ( f20_arg0, f20_arg1, f20_arg2, f20_arg3 )
				...
				if not f20_local2.usesFirstPartyStore then
					...
					if f20_local2.firstPartyProductID then
						if STORE.IsGamePreorderBundle( bundleID ) then
					...
					if f20_local2.video and 0 < #f20_local2.video then
	...
	f4_arg0.BillboardCategoryButtonAction = f4_local21.button_action[StoreItemLayout.BILLBOARD_LIST]
	local f4_local22 = function ( f17_arg0, f17_arg1, f17_arg2, f17_arg3 )
	...
	local f4_local23 = function ( f16_arg0, f16_arg1, f16_arg2, f16_arg3 )
	...
	local f4_local24 = function ( f15_arg0 )
	...
	local f4_local25 = function ( f13_arg0, f13_arg1 )
		...
		local f13_local2 = Engine[0xED84C33EC5F01EA]( f13_arg1.name )
				...
				if f13_arg0.justForYou then
					if f13_arg0.categoryIndex == f13_arg0._selectedCategory then
						if f14_local0.emptyCategory then
							...
							f13_arg0.NoMoreItemsMessage.Title:setText( Engine[0xED84C33EC5F01EA]( "MENU/BUNDLE_BUY_THROUGH_MESSAGE" ) )
					...
					local f14_local4 = Dvar[0x54084D7CA2317BB]( f13_arg0.idPubVar ) or ""
	...
	local f4_local26 = Store[0xB6B0898C7795778]()
	local f4_local27 = Store[0x5CA33565A117BF3]()
	local f4_local28 = Engine[0xB6B0898C7795778]( f4_local26 )
	local f4_local29 = Engine[0x5CA33565A117BF3]( f4_local27 )
	f4_arg0._allCategoryData = f4_local29
	...
	for f4_local30 = 1, #f4_local29, 1 do
		local f4_local33 = f4_local29[f4_local30]
		f4_local33.items = f4_local33.items or {}
		f0_local0( f4_arg0, f4_arg1, f4_local33 )
	end
	f0_local0( f4_arg0 )
	f4_arg0.StoreEmpty:registerEventHandler( "categoryTimerUpdate", function ( element, event )
		f4_arg0( f4_arg0 )
	end )
	local f4_local30 = f4_local28.layoutType
	local f4_local31 = f4_local4( f4_local30 )
	QUARTERMASTER.RecordStoreEnterEvent( f4_arg1, f4_local30, f4_arg0.recommendationData )
	f4_local24( f4_local30 )
	if f4_local31.storeCustomizations then
		f4_local5( f4_local31.storeCustomizations.pre, f4_local29, f4_local31 )
	end
	for f4_local32 = 1, #f4_local29, 1 do
		local f4_local35 = f4_local29[f4_local32]
		f4_local35.categoryIndex = f4_local32
		if f4_local35.name then
			local f4_local36 = f4_local25( f4_local35.layoutType or f4_local30, f4_local35 )
			f4_local23( f4_local36, f4_local35.layoutType or f4_local30, f4_local31.categoryButton, f4_local35 )
			f4_local5( f4_local31.categoryButton.buttonCustomizations, f4_local35, f4_local31, {
				categoryButton = f4_local36
			} )
			f4_local36:addEventHandler( "button_over", function ( f11_arg0, f11_arg1 )
	...
	if f4_local31.storeCustomizations then
		f4_local5( f4_local31.storeCustomizations.post, f4_local29, f4_local31, {
			buttonToFocus = f4_arg2.buttonToFocus
		} )
	end
	f4_arg0.BillboardGrid:SetNumRows( 1 )
	f4_arg0.BillboardGrid:SetNumColumns( 0 )
	local f4_local32 = LUI.UITimer.new( {
		interval = 1000,
		event = "categoryTimerUpdate"
	} )
	f4_local32.id = "timer"
	f4_arg0:addElement( f4_local32 )
	local f4_local34 = LUI.UITimer.new( {
		event = "autoScrollTimerUpdate",
		interval = f0_local0
	} )
	f4_local34.id = "autoScrollTimer"
	f4_arg0:addElement( f4_local34 )
	...
	f4_arg0.DisableAutoScrollTimer = function ()
		...
		local f8_local0 = f4_arg0._autoScrollEnabledTimerHolder:Wait( Dvar[0x22EAAB59AA27E9B]( "#x32f701b843d121f08" ), true )
...
function MPStoreBillboardList( menu, controller )
	...
	BillboardGrid:SetRowSpacing( 0 )
	BillboardGrid:setUseStencil( true )
	BillboardGrid:SetWraps( nil, false )
	...
	CategoryText:SetFontSize( 32 * _PT )
