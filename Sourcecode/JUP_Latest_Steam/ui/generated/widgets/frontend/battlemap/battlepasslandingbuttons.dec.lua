...
function BattlePassLandingButtons( f1_arg0, f1_arg1 )
	local f1_local0 = LUI
	...
	f1_local2.id = "BattlePassLandingButtons"
	local f1_local3
	if f1_arg1 then
		f1_local3 = f1_arg1
	else
	...
	local f1_local7 = nil
	f1_local7 = f1_local1.BuildRegisteredType( 0x781886D2CC0F9F6, {
		controllerIndex = f1_local3
	} )
...
MenuBuilder.registerType( 0x84CD98F8234F3F6, BattlePassLandingButtons )
LockTable( _M )
