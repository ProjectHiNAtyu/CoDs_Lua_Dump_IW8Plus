...
function ShowESportsRules( f4_arg0 )
	f4_arg0.ESportsRulesLabel:setText( Engine[0xED84C33EC5F01EA]( "PATCH_MENU/CDL_RULES_VERSION", MLG.GetRulesVersionNumber() ) )
end
...
local f0_local0 = function ( f2_arg0, f2_arg1, f2_arg2 )
	if MLG.AreMLGRulesEnabled() then
		f2_arg0.ESportsRulesLabel:setText( Engine[0xED84C33EC5F01EA]( "PATCH_MENU/CDL_RULES_VERSION", MLG.GetRulesVersionNumber() ) )
	else
...
function ESportsRulesLabel( menu, controller )
	...
	ESportsRulesLabel:SetMinFontSize( 16 * _PT )
