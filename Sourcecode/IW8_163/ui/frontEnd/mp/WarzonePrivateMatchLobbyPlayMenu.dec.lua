...
local f0_local1 = function ( f13_arg0, f13_arg1, f13_arg2 )
	...
	if not f13_local0.squadActionDisplayed and not PRIVATE_MATCH.IsWZSoloGameModeLobby( f13_arg0, f13_arg1, f13_arg2 ) and Lobby.BGIADHIHAG() then
...
local f0_local6 = function ( f6_arg0, f6_arg1 )
	...
	f6_arg0:registerEventHandler( "update_lobby", function ( element, event )
		Lobby.UpdateClientCharactersDelayed( f6_arg0, f6_arg0, {
