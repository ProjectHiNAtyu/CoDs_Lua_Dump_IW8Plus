...
local f0_local0 = function ( f17_arg0, f17_arg1 )
	f17_arg0._introVideo = f17_arg1
	if f17_arg0._introVideo and 0 < #f17_arg0._introVideo then
		ACTIONS.AnimateSequence( f17_arg0, "ShowIntroVideo" )
		f17_arg0.TutorialVideo.Mask:SetAlpha( 1 )
		f17_arg0._endFlag = false
		f17_arg0.TutorialVideo:AnimateSequence( "MaskFadeOut" )
		Engine.DFCGFCGBFD( f17_arg1, VideoPlaybackFlags.MUTE )
		...
		ACTIONS.AnimateSequence( f17_arg0, "HideIntroVideo" )
		f17_arg0.HelperBar.ButtonHelperText:PushButtonPrompt( {
			gamepad_only = true,
			button_ref = "button_r3",
			helper_text = nil,
...
local f0_local1 = function ( f16_arg0, f16_arg1 )
	local f16_local0 = OPERATOR.IsUnlocked( f16_arg0._controllerIndex, f16_arg1.ref )
	f0_local0( f16_arg0, f16_arg1.introVideo )
	f16_arg0.OperatorCard:SetupCardDetails( f16_arg1 )
	f16_arg0.SquadName:setText( ToUpperCase( Engine.CBBHFCGDIC( "LUA_MENU/BREADCRUMB_2_ITEMS", OPERATOR.GetFactionName( f16_arg1.ref ), f16_arg1.name ) ) )
	f16_arg0.Bloodtype:SetupBloodDetails( f16_arg1.bloodType )
	f16_arg0.Thumbprint:setImage( RegisterMaterial( f16_arg1.thumbprint ) )
	f16_arg0.FactionIcon:setImage( RegisterMaterial( f16_arg1.factionIcon ) )
	f16_arg0._currentFocusedOperatorData = f16_arg1
end

local f0_local2 = function ( f15_arg0, f15_arg1 )
	if not f15_arg0._activeButton or f15_arg0._activeButton ~= f15_arg1 then
		if f15_arg0._activeButton then
			f15_arg0._activeButton:LoseButtonFocus()
		end
		f15_arg0._activeButton = f15_arg1
		f0_local0( f15_arg0, f15_arg1._operatorInfo )
	end
end

local f0_local3 = function ( f13_arg0 )
	f13_arg0.OperatorGrid:SetRefreshChild( function ( f14_arg0, f14_arg1, f14_arg2 )
		local f14_local0 = f14_arg1 + f14_arg2 * f13_arg0.OperatorGrid:GetNumColumns()
		if f14_local0 == nil then
			return 
		elseif not f13_arg0._operatorList then
			return 
		else
			f14_arg0:Setup( f13_arg0._controllerIndex, f13_arg0._operatorList[f14_local0 + 1], f13_arg0 )
		end
	end )
end
...
local f0_local4 = function ( f9_arg0, f9_arg1, f9_arg2 )
	...
	f9_arg0:addAndCallEventHandler( "onVideoChange", function ()
		...
		f9_arg0.Darkener:SetScale( f12_local0 )
		f9_arg0.Blur:SetScale( f12_local0 )
	end )
