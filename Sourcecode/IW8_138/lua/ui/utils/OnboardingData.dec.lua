...
ONBOARDING_DATA = {
	...
	GetOnboardingLoadoutData = function ()
		...
		if CONDITIONS.IsThirdGameMode() then
			f92_local4 = "onboarding_loadout_1"
		else
			f92_local4 = "onboarding_ch2_mw_only_edit_loadout_01"
		end
		f92_local3.image = f92_local4
		if CONDITIONS.IsThirdGameMode() then
			f92_local4 = "ONBOARDING/LOADOUT_1_CP"
		else
			f92_local4 = "ONBOARDING/EDITDROPKIT_MW_EDITLOADOUT_1"
		end
		f92_local3.desc = f92_local4
		f92_local2[1] = f92_local3
		f92_local3 = {}
		if CONDITIONS.IsThirdGameMode() then
			f92_local4 = "onboarding_loadout_2"
		else
			f92_local4 = "onboarding_ch2_mw_only_edit_loadout_02"
		end
		f92_local3.image = f92_local4
		if CONDITIONS.IsThirdGameMode() then
			f92_local4 = "ONBOARDING/LOADOUT_2_CP"
		else
			f92_local4 = "ONBOARDING/EDITDROPKIT_MW_EDITLOADOUT_2"
		end
		f92_local3.desc = f92_local4
		f92_local2[2] = f92_local3
		f92_local3 = {}
		if CONDITIONS.IsThirdGameMode() then
			f92_local4 = "onboarding_loadout_3"
		else
			f92_local4 = "onboarding_ch2_mw_only_edit_loadout_03"
		end
		f92_local3.image = f92_local4
		if CONDITIONS.IsThirdGameMode() then
			f92_local4 = "ONBOARDING/LOADOUT_3"
		else
			f92_local4 = "ONBOARDING/EDITDROPKIT_MW_EDITLOADOUT_3"
		end
		f92_local3.desc = f92_local4
		f92_local2[3] = f92_local3
		f92_local1.panelData = f92_local2
		f92_local1.confirmButton = {
			action = f92_local0
		}
		return f92_local1
	end,
	...
	GetOnboardingPerkUpdateData = function ()
		local f85_local0 = function ( f87_arg0 )
			...
			cancelButton = {
				...
				action = function ( f79_arg0, f79_arg1 )
					if LUI.FlowManager.IsInStack( "MainMenuOffline" ) then
						ACTIONS.RestoreMenu( "MainMenuOffline", true, f79_arg1 )
					else
						ACTIONS.RestoreMenu( "MainMenu", true, f79_arg1 )
					end
				end
	...
	GetPlunderTutorialData = function ( f59_arg0 )
		return {
	...
	GetOnboardingTDMData = function ( f57_arg0 )
		return {
	...
	GetOnboardingGunfightData = function ( f55_arg0 )
		return {
	...
	GetOnboardingMPMoshpitData = function ( f53_arg0 )
		return {
	...
	GetOnboardingArmoredRoyaleData = function ( f37_arg0 )
		return {
	...
	GetOnboardingZombiesBRData = function ( f35_arg0 )
		return {
	...
	GetOnboardingRebirthOnboardingData = function ( f17_arg0 )
		return {
