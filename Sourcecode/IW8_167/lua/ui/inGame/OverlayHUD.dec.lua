...
LUI.OverlayHUD.init = function ( f6_arg0, f6_arg1, f6_arg2, f6_arg3 )
	...
	f6_arg0:registerEventHandler( "ui_br_squad_eliminated_active", LUI.OverlayHUD.UpdateOverlays )
...
LUI.OverlayHUD.UpdateOverlays = function ( f1_arg0 )
	...
	if f1_local0 then
		...
		DebugPrint( "\n -------- current overlay information: " .. tostring( f1_arg0._overlays[f1_local0].id ) )
