	...
	if f17_local1 then
		for f17_local2 = 1, #f17_local1, 1 do
			...
			if f17_local5 and not f17_local5[0xAED63DFE5400760] then
				local f17_local6 = {
					ref = f17_local5[0x9E9C01960F4C582],
...
local f0_local10 = function ( f6_arg0 )
	if f6_arg0._supportAltImage then
		f6_arg0.bindButton:addEventHandler( "button_alt1", function ( f7_arg0, f7_arg1 )
			f6_arg0._isAltImage = not f6_arg0._isAltImage
			f6_arg0:PreviewItem()
			f6_arg0.ReticleGrid:RefreshContent()
		end )
	end
end
...
local f0_local11 = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	if not f3_arg2.isStorePreview then
		...
		f3_arg0.GunsmithWeaponLevel:SetAlpha( 0 )
		local f3_local0 = LOOT.GetItemRef( LOOT.itemTypes.RETICLE, f3_arg2.lootID )
