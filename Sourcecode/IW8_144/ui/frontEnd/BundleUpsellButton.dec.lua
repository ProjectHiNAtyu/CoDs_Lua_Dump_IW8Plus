...
local f0_local5 = function ( f23_arg0, f23_arg1 )
	...
	local f23_local2 = Loot.DFGCEHHCEA( f23_local1 )
	if f23_local2 then
...
local f0_local8 = function ( f19_arg0, f19_arg1, f19_arg2 )
	if Dvar.IBEGCHEFE( "NLTNQNSMQK" ) then
		...
		if f19_arg2 then
			local f19_local1, f19_local2 = STORE.GetIndexForBundle( f19_arg2.id, f19_arg1 )
			if f19_local1 then
		...
		if not f19_arg2 or not f19_local0 then
			f19_arg0:HideButton()
		else
			local f19_local1 = f19_arg0._bundleData.hasOperatorMissions
			local f19_local2 = f19_arg0._bundleData
			local f19_local3
			if f19_local1 ~= "" then
				f19_local3 = tonumber( f19_local1 )
				if not f19_local3 then
				
				else
					f19_local2.hasOperatorMissions = f19_local3 == 1
					f19_arg0:ShowButton( f19_arg2 )
					f19_local2 = function ( f20_arg0 )
					...
					f19_arg0:addEventHandler( "button_action", f19_local2 )
					f19_arg0:addEventHandler( "view_bundle", f19_local2 )
				end
			end
			f19_local3 = 0
		end
