...
local f0_local21 = function ( f25_arg0, f25_arg1, f25_arg2, f25_arg3, f25_arg4 )
...
local f0_local24 = function ( f19_arg0, f19_arg1, f19_arg2 )
	...
	f19_local2:SetAnchorsAndPosition( 0, 1, 0, 1, f0_local0 + f19_local5, f0_local0 + f19_local5 + f19_local6, f0_local0 + f19_local1, f0_local0 + f0_local0 + f19_local1 )
	...
	f19_local7( f19_local8, f19_local9.left + f19_local6 )
	...
	f19_local3.UnlockLines:SetRight( f19_local7 )
	...
	f19_local8( f19_local11, f19_local12 + f19_local10 * f0_local0 / 1.55 )
...
local f0_local26 = function ( f15_arg0, f15_arg1, f15_arg2 )
...
local f0_local27 = function ( f14_arg0, f14_arg1, f14_arg2 )
...
local f0_local28 = function ( f13_arg0 )
...
local f0_local29 = function ( f12_arg0, f12_arg1, f12_arg2 )
		...
		if f9_arg0._enabled then
			...
			if f10_arg1.down then
				...
				elseif f10_arg1.button == "left" and f10_local3 then
					f10_local6 = f10_local3 % f9_arg0.slotsToCheck == f9_arg0.moveLeftSlot
				elseif f10_arg1.button == "right" and f10_local3 then
					f10_local5 = f10_local3 % f9_arg0.slotsToCheck == f9_arg0.moveRightSlot
...
local f0_local33 = function ( f4_arg0, f4_arg1 )
...
local f0_local34 = function ( f3_arg0 )
	for f3_local3, f3_local4 in ipairs( f3_arg0._progressionRows ) do
		f3_local4:Initialize()
	end
end

local f0_local35 = function ( f2_arg0, f2_arg1, f2_arg2 )
...
MenuBuilder.registerType( 0x22E4BC15C50523F, GunsmithProgressionPanel )
LockTable( _M )
