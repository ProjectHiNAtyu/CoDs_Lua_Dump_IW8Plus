...
local f0_local0 = function ( f5_arg0, f5_arg1, f5_arg2 )
	...
	if f5_local5 then
		...
		f5_local8 = Engine[0xED84C33EC5F01EA]( "MLG_GAMEBATTLES/MATCH_WON", f5_local9 )
	else
		...
		f5_local8 = Engine[0xED84C33EC5F01EA]( "MLG_GAMEBATTLES/GAME_WON_LINE", f5_local7, f5_local4 )
	end
	...
	f5_arg0.MatchId:setText( Engine[0xED84C33EC5F01EA]( "MLG_GAMEBATTLES/MATCH_ID_LABEL" ) .. " #" .. f5_local0.matchId )
...
function GameBattlesMatchResults( menu, controller )
	...
	AdditionalInformation:setText( Engine[0xED84C33EC5F01EA]( "MLG_GAMEBATTLES/MATCH_RESULT_ADDITIONAL_INFORMATION" ), 0 )
	AdditionalInformation:SetFont( FONTS.GetFont( FONTS.MainRegularHeader.File ) )
	AdditionalInformation:SetFontSize( 24 * _PT )
	AdditionalInformation:SetMinFontSize( 16 * _PT )
	...
	MatchId:setText( "", 0 )
	MatchId:SetFont( FONTS.GetFont( FONTS.MainRegularHeader.File ) )
	MatchId:SetFontSize( 24 * _PT )
	MatchId:SetMinFontSize( 16 * _PT )
	...
	ResultText:setText( ToUpperCase( Engine[0xED84C33EC5F01EA]( "MLG_GAMEBATTLES/GAME_WON_LINE" ) ), 0 )
	ResultText:SetFont( FONTS.GetFont( FONTS.MainRegularHeader.File ) )
	ResultText:SetFontSize( 24 * _PT )
	ResultText:SetMinFontSize( 16 * _PT )
	...
	self._sequenceLengths.RoundEnd = 0
