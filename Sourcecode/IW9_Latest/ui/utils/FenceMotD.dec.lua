...
FenceMotD.StartForConsoleOrPC = function ( f8_arg0 )
	if LUI.WebViewManager.MotdEnabled() then
		...
		DebugPrint( "[TELESCOPE] Start preload MOTD." )
...
FenceMotD.UpdateStateForConsoleOrPC = function ( f3_arg0 )
	...
	if LUI.WebViewManager.MotdEnabled() and not CONDITIONS.IsCortezSubExe() and Dvar[0x9E5BE3B4BBA4E0E]( 0xEF7A1FAC7B6759F ) then
