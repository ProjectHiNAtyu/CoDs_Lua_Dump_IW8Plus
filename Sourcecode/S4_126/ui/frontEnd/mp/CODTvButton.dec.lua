	...
	f9_arg0:SubscribeToModelThroughElement( f9_arg0, "viewers", function ()
		...
		if f16_local1 ~= nil then
			...
			elseif 0 < f16_local1 then
				f9_arg0.ViewsLabel:setText( Engine[0xED84C33EC5F01EA]( "CODTV/VIEWS", f16_local1 ) )
			else
	...
	f9_arg0:SubscribeToModelThroughElement( f9_arg0, "status", function ()
		...
		if f9_arg0.vid_type == CODTV.VIDEO_TYPE.STREAM then
			...
			if f13_local1.status:GetValue( f9_arg0 ) == 1 then
				f9_arg0.LiveLabel:setText( Engine[0xED84C33EC5F01EA]( "CODTV/LIVE" ), 0 )
				f9_arg0.LiveIcon:SetRGBFromInt( 16318464, 0 )
			else
				f9_arg0.LiveIcon:SetRGBFromInt( 16776960, 0 )
				f9_arg0.LiveLabel:setText( Engine[0xED84C33EC5F01EA]( "CODTV/REBROADCAST" ), 0 )
			end
		end
	end )
...
function CODTvButton( menu, controller )
	...
	ViewsLabel:setText( Engine[0xED84C33EC5F01EA]( "CODTV/VIEWERS" ), 0 )
	ViewsLabel:SetFont( FONTS.GetFont( FONTS.MainRegularHeader.File ) )
	ViewsLabel:SetFontSize( 16 * _PT )
	ViewsLabel:SetMinFontSize( 16 * _PT )
	...
	LiveLabel:setText( Engine[0xED84C33EC5F01EA]( "CODTV/LIVE" ), 0 )
	LiveLabel:SetFont( FONTS.GetFont( FONTS.MainRegularHeader.File ) )
	LiveLabel:SetFontSize( 16 * _PT )
	LiveLabel:SetMinFontSize( 16 * _PT )
	...
	DurationLabel:SetFont( FONTS.GetFont( FONTS.MainRegularHeader.File ) )
	DurationLabel:SetFontSize( 16 * _PT )
	DurationLabel:SetMinFontSize( 16 * _PT )
