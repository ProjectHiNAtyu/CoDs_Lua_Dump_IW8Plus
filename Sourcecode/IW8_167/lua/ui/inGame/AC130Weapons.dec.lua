...
function AC130Weapons( menu, controller )
	...
	Weapon105mm.NameText:setText( ToUpperCase( Engine.CBBHFCGDIC( "KILLSTREAKS/AC130_105MM" ) ), 0 )
	...
	Weapon40mm.NameText:setText( ToUpperCase( Engine.CBBHFCGDIC( "KILLSTREAKS/AC130_40MM" ) ), 0 )
	...
	Weapon25mm.NameText:setText( ToUpperCase( Engine.CBBHFCGDIC( "KILLSTREAKS/AC130_25MM" ) ), 0 )
	...
	if CONDITIONS.IsGamepadEnabled( self ) then
		...
		f1_local11:setText( Engine.CBBHFCGDIC( "LUA_MENU/BUTTON_WEAPON_NEXT" ), 0 )
		f1_local11:SetFont( FONTS.GetFont( FONTS.StreakRegular.File ) )
