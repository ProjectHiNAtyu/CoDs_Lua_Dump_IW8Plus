...
function MedalOverview( menu, controller )
	...
	AvgMedalsTitle:setText( Engine.CBBHFCGDIC( "LUA_MENU_MP/AVG_MEDALS" ), 0 )
	AvgMedalsTitle:SetFont( FONTS.GetFont( FONTS.MainRegular.File ) )
	...
	TotalMedalsTitle:setText( Engine.CBBHFCGDIC( "LUA_MENU_MP/TOTAL_MEDALS" ), 0 )
	TotalMedalsTitle:SetFont( FONTS.GetFont( FONTS.MainRegular.File ) )
	...
	Title.id = "Title"
	Title:setText( Engine.CBBHFCGDIC( "LUA_MENU_MP/MEDAL_MOST_IMPRESSIVE" ), 0 )
