...
local f0_local3 = function ( f33_arg0 )
	...
	if 0 < #f33_arg0._patchNoteData then
		...
		f33_arg0.MessageText:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU_MP/VIEW_PATCH_NOTES" ) )
	else
		f33_arg0:SetAlpha( 0 )
	end
	...
	if f30_arg0:ShouldHideCRM() then
		...
		f30_arg0.CRMListGrid:SetRefreshChild( function ( f31_arg0, f31_arg1, f31_arg2 )
			...
			if f31_local0[CRM.keys.LAYOUT_TYPE] == 2 then
				...
				if f31_local2 then
					local f31_local3 = StringTable[0x2DCF0973239E909]( CSV.bundleIDs.file, CSV.bundleIDs.cols.id, f31_local2, CSV.bundleIDs.cols.image )
		...
		f30_arg0.MinimizedCount:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU/X_OF_Y", f30_local0 + 1, #f30_arg0._menuMessageData ) )
...
local f0_local6 = function ( f28_arg0, f28_arg1 )
	...
	if f28_arg1 then
		...
		f28_arg0.Pips:SetAnchorsAndPosition( 0, 1, 1, 0, _1080p * 13, _1080p * 105, _1080p * -66, _1080p * -62 )
...
local f0_local8 = function ( f26_arg0, f26_arg1 )
	if f26_arg0:GetVisibility() == LUI.Visibility.Hidden or f26_arg0:GetAlpha() <= 0 then
		return 
	elseif f26_arg1.controller ~= Engine[0x45B054C920178E9]() then
...
local f0_local9 = function ( f15_arg0, f15_arg1, f15_arg2 )
	...
	if CONDITIONS.IsGLFrontendEnabled() then
		f15_arg0.HighlightTop:SetVisibility( LUI.Visibility.Hidden )
		f15_arg0.HighlightBottom:SetVisibility( LUI.Visibility.Hidden )
	end
	f15_arg1 = Engine[0x45B054C920178E9]()
	...
	if CONDITIONS.IsGLFrontendEnabled() then
		f15_arg0.Pips:SetVisibility( LUI.Visibility.Hidden )
		f15_arg0.Backer:SetVisibility( LUI.Visibility.Hidden )
		f15_arg0.MessageText:SetVisibility( LUI.Visibility.Hidden )
	end
	f15_arg0:addAndCallEventHandler( "update_input_type", function ( f25_arg0, f25_arg1 )
		if LUI.IsLastInputKeyboardMouse( f25_arg1.controllerIndex ) then
			...
			f25_arg0.ActionPrompt:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU/OPEN_CRM_POPUP" ) )
	...
	f15_arg0:addEventHandler( "scroll_crm", function ( f22_arg0, f22_arg1 )
		...
		if f22_local0 ~= "CRMContainer" and f22_local0 ~= "CRMPatchNoteInfo" and 1 < f22_local1 then
			...
			f22_arg0.MinimizedCount:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU/X_OF_Y", f22_local3 + 1, f22_local1 ) )
			f22_arg0:UpdateActionPrompt( f22_local4 )
		end
	end )
	f15_arg0.messageTimer = LUI.UITimer.new( {
		interval = Dvar[0x22EAAB59AA27E9B]( "#x3e4e498b6b23f7126" ) * 1000,
		event = {
...
function CRMMain( menu, controller )
	...
	MessageBG:SetRGBFromInt( 16735217, 0 )
	MessageBG:SetAlpha( 0, 0 )
	MessageBG:SetAnchorsAndPosition( 0, 0, 1, 0, 0, 0, _1080p * -92, 0 )
	...
	MinimizedCount:SetRGBFromTable( SWATCHES.text.buttonTextDefault, 0 )
	MinimizedCount:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU/X_OF_Y" ), 0 )
	MinimizedCount:SetFont( FONTS.GetFont( FONTS.MainRegularHeader.File ) )
	MinimizedCount:SetFontSize( 16 * _PT )
	MinimizedCount:SetMinFontSize( 16 * _PT )
	MinimizedCount:SetWordWrap( false )
	MinimizedCount:SetAlignment( LUI.Alignment.Right )
	MinimizedCount:SetAnchorsAndPosition( 1, 0, 1, 0, _1080p * -185, _1080p * -143, _1080p * -61, _1080p * -43 )
	...
	CRMListGrid:SetAnchorsAndPosition( 0.5, 0.5, 1, 0, _1080p * -216, _1080p * 216, _1080p * -240, 0 )
	...
	Backer:SetAnchorsAndPosition( 0, 0, 1, 0, 0, 0, _1080p * -72, _1080p * -24 )
	...
	ActionPrompt:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU/OPEN_CRM_POPUP" ), 0 )
	ActionPrompt:setCaseStyle( LUI.CaseStyle.Uppercase )
	ActionPrompt:SetFont( FONTS.GetFont( FONT_STYLES.fontStyle_XSBodyText.font.File ) )
	ActionPrompt:SetFontSize( 22 * _PT )
	ActionPrompt:SetMinFontSize( 16 * _PT )
	ActionPrompt:SetWordWrap( false )
	ActionPrompt:SetTracking( FONT_STYLES.fontStyle_XSBodyText.tracking * _1080p, 0 )
	ActionPrompt:SetLeading( FONT_STYLES.fontStyle_XSBodyText.leading * _1080p, 0 )
	ActionPrompt:SetAlignment( LUI.Alignment.Right )
	ActionPrompt:SetVerticalAlignment( LUI.Alignment.Bottom )
	ActionPrompt:SetAnchorsAndPosition( 1, 0, 1, 0, _1080p * -140, _1080p * -13, _1080p * -62, _1080p * -36 )
	...
	MessageText:setText( Engine[0xED84C33EC5F01EA]( "MENU/NEW" ), 0 )
	MessageText:setCaseStyle( LUI.CaseStyle.Uppercase )
	MessageText:SetFont( FONTS.GetFont( FONT_STYLES.fontStyle_XSBodyTextBold.font.File ) )
	MessageText:SetFontSize( 22 * _PT )
	MessageText:SetMinFontSize( 16 * _PT )
	MessageText:SetWordWrap( false )
	MessageText:SetTracking( FONT_STYLES.fontStyle_XSBodyTextBold.tracking * _1080p, 0 )
	MessageText:SetLeading( FONT_STYLES.fontStyle_XSBodyTextBold.leading * _1080p, 0 )
	MessageText:SetAlignment( LUI.Alignment.Left )
	MessageText:SetVerticalAlignment( LUI.Alignment.Bottom )
	MessageText:SetOptOutRightToLeftAlignmentFlip( true )
	MessageText:SetEllipsesEnabled( true )
	MessageText:SetAnchorsAndPosition( 0, 1, 1, 0, _1080p * 12, _1080p * 224, _1080p * -53, _1080p * -31 )
	...
	Pips.id = "Pips"
	Pips:SetAnchorsAndPosition( 0, 1, 1, 0, _1080p * 9, _1080p * 101, _1080p * -72, _1080p * -68 )
	...
	SplitScreenWarning:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU/CRM_SPLITSCREEN_WARNING" ), 0 )
	SplitScreenWarning:SetFont( FONTS.GetFont( FONTS.MainRegularHeader.File ) )
	SplitScreenWarning:SetFontSize( 22 * _PT )
	SplitScreenWarning:SetMinFontSize( 16 * _PT )
	...
	Mask:SetAnchorsAndPosition( 0.5, 0.5, 1, 0, _1080p * -216, _1080p * 216, _1080p * -240, _1080p * -23 )
	...
	self._sequenceLengths.Minimize = 200
	...
	self._sequenceLengths.Opening = 400
	...
	self._sequenceLengths.MouseFocusedMaximized = 0
	...
	self._sequenceLengths.MouseUnfocused = 0
	...
	self._sequenceLengths.Maximize = 200
	...
	self._sequenceLengths.SplitScreenWarningFlash = 400
	...
	self._sequenceLengths.MouseFocusedMinimized = 0
