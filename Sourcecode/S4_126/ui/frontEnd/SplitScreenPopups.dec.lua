...
MenuBuilder.registerType( "SplitScreenPopups", function ( f1_arg0, f1_arg1 )
	...
	if f1_local1 and 0 < #f1_local1 then
		if #f1_local1 <= 1 then
			f1_local0.message = Engine[0xED84C33EC5F01EA]( "LUA_MENU_MP/SPLITSCREEN_SINGLE_UNSUPPORTED_MODE", Engine[0x7D3158A9539A355]( f1_local1[1].name:GetValue( f1_local2 ) ) )
		else
			f1_local0.message = Engine[0xED84C33EC5F01EA]( "LUA_MENU_MP/SPLITSCREEN_MULTIPLE_UNSUPPORTED_MODES" )
		end
	elseif f1_arg1.isSplitScreenWarning then
		if 1 < Engine[0x70187FE84AE61FD]() then
			f1_local0.message = Engine[0xED84C33EC5F01EA]( "LUA_MENU_MP/SPLITSCREEN_SINGLE_UNSUPPORTED_MODE", Engine[0x7D3158A9539A355]( f1_arg1.text ) )
		else
			f1_local0.message = Engine[0xED84C33EC5F01EA]( "LUA_MENU_MP/SPLITSCREEN_SINGLE_UNSUPPORTED_MODE_PARTY", Engine[0x7D3158A9539A355]( f1_arg1.text ) )
		end
	end
	...
	if f1_local1 and 1 < #f1_local1 then
		...
		table.insert( f1_local0.buttons, 1, {
			label = Engine[0xED84C33EC5F01EA]( "LUA_MENU_MP/REMOVE_MODES_CONTINUE" ),
