...
function SpiderGraph( f1_arg0, f1_arg1 )
	local f1_local0 = LUI
	local f1_local1 = f1_local0.UIElement.new()
	f1_local1:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 512, 0, 512 )
	f1_local1.id = "SpiderGraph"
	local f1_local2
	if f1_arg1 then
		f1_local2 = f1_arg1
	else
...
MenuBuilder.registerType( 0x7273E15D942FC0C, SpiderGraph )
LockTable( _M )
