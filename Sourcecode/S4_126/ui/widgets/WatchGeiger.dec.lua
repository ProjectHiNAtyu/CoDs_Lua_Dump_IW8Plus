...
local f0_local3 = function ( f7_arg0, f7_arg1, f7_arg2 )
	...
	f7_local5 = function ( f14_arg0 )
		if f7_arg0 and f7_arg0 then
			Engine[0xC4146BA76D0F982]( "watch_geiger_nuke_pulse" )
	...
	local f7_local8 = function ( f11_arg0 )
		...
		if f7_arg0 and f11_arg0 ~= 0 then
			Engine[0xC4146BA76D0F982]( "watch_geiger_tick" )
		end
		...
		if 30 <= f11_arg0 then
			...
			f7_arg0 = true
			if f7_arg0 then
				Engine[0xC4146BA76D0F982]( "watch_geiger_nuke_activate" )
			end
		else
	...
	KillCount:RegisterAnimationSequence( "ScreenOffline", {
		{
			...
			value = Engine[0xED84C33EC5F01EA]( "LUA_MENU/WATCH_OFFLINE" )
		},
		{
