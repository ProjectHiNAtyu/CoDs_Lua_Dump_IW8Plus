...
local f0_local12 = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	f3_arg0:AddGamepadEventCallback( "button_shoulderl", function ( f13_arg0, f13_arg1 )
		f3_arg0( f13_arg0 )
	end )
	f3_arg0:AddGamepadEventCallback( "button_alt1", function ( f11_arg0, f11_arg1 )
		local f11_local0 = f11_arg1.controller or f3_arg0
		local f11_local1 = {
			controllerIndex = f11_local0,
			filter = f11_arg0._filter,
			platformFilter = f11_arg0._platformFilter,
			playlistFilter = f11_arg0._isHardcore,
			showPlaylistFilter = Leaderboards.GetLeaderboardHasHardcoreMode( f11_arg0._leaderboard ),
	...
	f3_arg0:AddGamepadEventCallback( "button_alt2", function ( f9_arg0, f9_arg1 )
		local f9_local0 = f9_arg0._canSwitchLeaderboard or false
	...
	f3_arg0:AddGamepadEventCallback( "button_left_trigger", function ( f8_arg0, f8_arg1 )
		f3_arg0( f8_arg0 )
	end )
