...
function ItemAtom( f1_arg0, f1_arg1 )
	...
	f1_local9:SetAnchorsAndPosition( 0, 1, 1, 0, 139, 235, -56, -26 )
...
MenuBuilder.registerType( 0xFAB9079902DE60B, ItemAtom )
LockTable( _M )
