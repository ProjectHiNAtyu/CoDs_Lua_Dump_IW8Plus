...
local f0_local12 = function ( f6_arg0, f6_arg1, f6_arg2 )
	...
	for f6_local4 = 1, f6_local2, 1 do
		if f6_local0[f6_local4].type ~= AEKinds.IW9_AE_KIND_MP_PROGRESSION.ID then
			...
			if f6_local9 ~= "" then
				local f6_local13 = LOOT.GetTypeForID( f6_local9 )
				local f6_local14 = LOOT.GetItemImage( f6_local13, LOOT.GetItemRef( f6_local13, f6_local9 ), f6_local9 )
			end
			f6_local1[f6_local4] = {
				{
					lootTypeName = nil,
