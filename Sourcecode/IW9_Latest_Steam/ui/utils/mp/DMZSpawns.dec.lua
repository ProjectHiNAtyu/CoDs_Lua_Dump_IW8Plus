...
local f0_local3 = function ( f7_arg0 )
	...
	DebugPrint( "Spawn Points Size: " .. tostring( #f7_arg0 ) )
	for f7_local0 = 0, DMZSPAWNS.MAX_QUADS - 1, 1 do
		DebugPrint( "Quad: " .. f7_local0 )
		DebugPrint( "----------------------------------" )
		if f7_arg0[f7_local0] then
			for f7_local3 = 0, #f7_arg0[f7_local0], 1 do
				DebugPrint( "Point " .. f7_local3 .. ": " .. "( " .. f7_arg0[f7_local0][f7_local3].origin.x .. ", " .. f7_arg0[f7_local0][f7_local3].origin.y .. ", " .. f7_arg0[f7_local0][f7_local3].origin.z .. " )" .. ", ID: " .. f7_arg0[f7_local0][f7_local3].id )
			end
		end
		DebugPrint( "----------------------------------" )
	end
...
local f0_local4 = function ( f6_arg0, f6_arg1, f6_arg2, f6_arg3, f6_arg4, f6_arg5 )
	...
	DebugPrint( "Chosen Spawn ID: " .. f6_arg0.id )
	DebugPrint( "Chosen Spawn Origin: " .. "( " .. f6_arg0.origin.x .. ", " .. f6_arg0.origin.y .. ", " .. f6_arg0.origin.z .. " )" )
	DebugPrint( "Player Team: " .. f6_arg1.team )
	DebugPrint( "Player Member Index: " .. f6_arg1.memberIndex )
	DebugPrint( "Seed Used / Lobby ID: " .. f6_arg2 )
	DebugPrint( "Spawn Set: " .. f6_arg3 )
	DebugPrint( "Player Data Index: " .. f6_arg5 )
	if f6_arg3 == "Fallback Spawn Chosen" then
		DebugPrint( "Spawn Quadrant: " .. DMZSPAWNS.DEBUG_QUAD_TEXT[4] )
	else
		DebugPrint( "Spawn Quadrant: " .. DMZSPAWNS.DEBUG_QUAD_TEXT[f6_arg4] )
	end
...
local f0_local5 = function ( f5_arg0 )
	...
	DebugPrint( "Squad: " .. f5_arg0.squad )
	DebugPrint( "Team: " .. f5_arg0.team )
	DebugPrint( "Member Index: " .. f5_arg0.memberIndex )
	DebugPrint( "--------End Lobby Client Info Debug------------" )
end

local f0_local6 = function ( f4_arg0 )
	DebugPrint( "--------Start Spawn Point Debug------------" )
	DebugPrint( "ID: " .. f4_arg0.id )
	DebugPrint( "Origin: " .. "( " .. f4_arg0.origin.x .. ", " .. f4_arg0.origin.y .. ", " .. f4_arg0.origin.z .. " )" )
	DebugPrint( "--------End Spawn Point Debug------------" )
end
...
local f0_local7 = function ( f3_arg0, f3_arg1 )
	...
	if f3_local0 == 1 then
		...
		for f3_local4 = 0, f3_local0 - 1, 1 do
			...
			if (f3_local8.isMyPlayer:GetValue( f3_local4, {
				defaultValue = false
			} ) or "nil") == true then
				f3_local2 = {
