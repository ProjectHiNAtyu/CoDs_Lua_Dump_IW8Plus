		...
		if f8_arg0.selected then
			f8_arg0:dispatchEventToRoot( {
				...
				options = {
					...
					description = Engine[0xED84C33EC5F01EA]( "LUA_MENU/FILTER_EQUIPPED", f8_arg0.MainButton.modeInfo.name ),
...
function GameModeButton( menu, controller )
	...
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 560 * _1080p, 0, 56 * _1080p )
	...
	MainButton:SetAnchorsAndPosition( 0, 1, 0, 1, 0, _1080p * 479, 0, _1080p * 56 )
	...
	OptionsButton.Text:setText( Engine[0xED84C33EC5F01EA]( "MENU/OPTIONS" ), 0 )
	OptionsButton.Text:SetAlignment( LUI.Alignment.Center )
	OptionsButton:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 484, _1080p * 605, 0, _1080p * 56 )
