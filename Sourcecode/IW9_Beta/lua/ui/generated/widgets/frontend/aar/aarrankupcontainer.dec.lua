	...
	if f17_arg0._unlocks and 0 < #f17_arg0._unlocks then
		for f17_local0 = 1, AAR.MAX_UNLOCK_DISPLAY_NUM, 1 do
			...
			if f17_local3 then
				...
				f17_local4.Title.Text:setText( f17_local3.name )
...
local f0_local7 = function ( f12_arg0, f12_arg1, f12_arg2, f12_arg3 )
	...
	f12_arg0.RankUpItem.RankValue:setText( f12_arg2.rankDisplay )
...
local f0_local9 = function ( f8_arg0, f8_arg1, f8_arg2 )
	...
	f8_arg0.RankUpItem.RankValue:setText( ToUpperCase( Engine[0xED84C33EC5F01EA]( 0x4C725AB2D93B772 ) ) )
...
function AARRankUpContainer( menu, controller )
	...
	Unlock3.id = "Unlock3"
	Unlock3:SetAnchorsAndPosition( 0.5, 0.5, 1, 0, _1080p * 250, _1080p * 650, _1080p * -735, _1080p * -511 )
	...
	Unlock2.id = "Unlock2"
	Unlock2:SetAnchorsAndPosition( 0.5, 0.5, 1, 0, _1080p * -200, _1080p * 200, _1080p * -735, _1080p * -511 )
	...
	Unlock1.id = "Unlock1"
	Unlock1:SetAnchorsAndPosition( 0.5, 0.5, 1, 0, _1080p * -650, _1080p * -250, _1080p * -735, _1080p * -511 )
