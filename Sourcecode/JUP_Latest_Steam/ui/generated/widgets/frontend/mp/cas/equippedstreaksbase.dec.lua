...
local f0_local2 = function ( f8_arg0, f8_arg1, f8_arg2 )
	for f8_local7, f8_local8 in ipairs( f8_arg0._streakInfos ) do
		...
		f8_local8.StreakIcon:setImage( RegisterMaterial( 0x6BA7085B2DB9F78 ) )
	end
end
...
local f0_local7 = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	if f3_arg0.EquippedBanner and f3_arg0.EquippedBannerText then
...
function EquippedStreaksBase( f1_arg0, f1_arg1 )
	local f1_local0 = LUI
	local f1_local1 = f1_local0.UIElement.new()
	f1_local1:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 682, 0, 128 )
	f1_local1.id = "EquippedStreaksBase"
	local f1_local2
	if f1_arg1 then
		f1_local2 = f1_arg1
	else
...
MenuBuilder.registerType( 0xA28E2DB6DA9A7EE, EquippedStreaksBase )
LockTable( _M )
