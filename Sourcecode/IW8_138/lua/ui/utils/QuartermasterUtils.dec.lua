		...
		if f4_arg1.idPubVar then
			...
			if not string.match( f4_local2, tostring( f4_arg2.id ) ) then
				if string.len( f4_local2 ) == 0 then
					...
					f4_local2 = f4_local2 .. "," .. tostring( f4_arg2.id )
				end
			end
			...
			for f4_local4 = 1, #f4_local3, 1 do
				...
				if string.len( f4_local0 ) == 0 and STORE.BundleAvailable( f4_arg0, f4_local7 ) then
					f4_local0 = f4_local7
				elseif STORE.BundleAvailable( f4_arg0, f4_local7 ) then
