...
local f0_local13 = function ( f7_arg0, f7_arg1 )
	...
	local f7_local1 = ""
	local f7_local2 = "%01d"
	for f7_local3 = #f0_local0, 1, -1 do
		local f7_local6 = f0_local0[f7_local3]
		if f7_arg1[f7_local6] then
			f7_local1 = f7_local1 .. string.format( f7_local2, f7_local0[f7_local6] or 0 )
			f7_local2 = ":%02d"
		end
	end
	return f7_local1
...
TIME.FormatSeconds = function ( f6_arg0, f6_arg1, f6_arg2 )
	if not f6_arg2 then
		f6_arg2 = {
			minute = false,
			second = false
...
TIME.FormatMilliseconds = function ( f5_arg0, f5_arg1, f5_arg2 )
	if not f5_arg2 then
		f5_arg2 = {
			minute = false,
			second = false
	...
	if f5_arg1 == TIME.Format.READABLE then
		return f0_local0( f5_arg0, f5_arg2 )
	elseif f5_arg1 == TIME.Format.READABLE_MINIMAL then
		return f0_local0( f5_arg0, f5_arg2 )
	elseif f5_arg1 == TIME.Format.STOPWATCH then
		return f0_local0( f5_arg0 )
	elseif f5_arg1 == TIME.Format.STOPWATCH_MINIMAL then
		return f0_local0( f5_arg0 )
	elseif f5_arg1 == TIME.Format.CLOCK then
		return f0_local0( f5_arg0 )
	elseif f5_arg1 == TIME.Format.CLOCK_FLEXIBLE then
		return f0_local0( f5_arg0, f5_arg2 )
	else
...
TIME.FormatSecondsAgo = function ( f4_arg0, f4_arg1 )
...
TIME.FormatMillisecondsAgo = function ( f3_arg0, f3_arg1 )
...
TIME.IsDifferentDate = function ( f2_arg0, f2_arg1 )
	return Engine[0xD52EDA08B43D341]( f2_arg0 ) ~= Engine[0xD52EDA08B43D341]( f2_arg1 )
end
