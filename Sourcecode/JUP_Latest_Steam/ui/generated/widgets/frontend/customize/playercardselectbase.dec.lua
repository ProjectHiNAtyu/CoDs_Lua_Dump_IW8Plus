...
local f0_local2 = function ( f27_arg0, f27_arg1 )
	...
	if CONDITIONS.IsMobileOrMobileSim() then
		local f27_local1 = CallingCardUtils.FindPlayerCardGivenLootId( f27_arg0._equippedPlayerCardIndex )
		...
		f27_arg0.CallingCardShowcases:SetRefreshChild( function ( f28_arg0, f28_arg1, f28_arg2 )
			...
			if f28_local0 < SOCIAL.MAX_NUM_SHOWCASE_CARDS then
				...
				local f28_local2 = CallingCardUtils.FindPlayerCardGivenLootId( f28_local1[f28_local0 + 1] )
...
local f0_local6 = function ( f23_arg0, f23_arg1 )
	local f23_local0 = CallingCardUtils.FindPlayerCardGivenLootId( f23_arg0._equippedPlayerCardIndex )
...
local f0_local13 = function ( f9_arg0, f9_arg1 )
	...
	f9_arg0:AddGamepadEventCallback( "button_alt1", function ( f10_arg0, f10_arg1 )
		...
		if LUI.IsLastInputGamepad( f10_local0 ) then
			f10_arg0._currentSelectedLootID = f10_arg0._playerCardTable[f9_arg0( f10_arg0 )].lootID
		end
...
local f0_local14 = function ( f5_arg0, f5_arg1, f5_arg2 )
	...
	f5_arg0._lootTable = {}
	f5_arg0._allLootTable = CallingCardUtils.GetAllPlayerCards( f5_arg1 )
	...
	f5_arg0:addAndCallEventHandler( "onVideoChange", function ()
		if f5_arg0.TabBacker then
			if CoD.CurrentAspectRatioCompare( LUI.AspectRatio.standard ) == LUI.COMPARE.higher then
				f5_arg0.TabBacker:SetAnchorsAndPosition( 0, 0, 0, 1, -192, 192, 0, 160 )
			else
				f5_arg0.TabBacker:SetAnchorsAndPosition( 0, 0, 0, 1, 0, 0, 0, 160 )
			end
		end
	end )
	if not f5_local0 and not IsLanguageArabic() and f5_arg0.NewItemPreviewNotification then
...
MenuBuilder.registerType( 0x2A2311F622B06AB, PlayerCardSelectBase )
LockTable( _M )
