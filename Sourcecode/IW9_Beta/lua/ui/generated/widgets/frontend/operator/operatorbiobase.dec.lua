...
local f0_local1 = function ( f10_arg0, f10_arg1 )
	...
	f10_arg0.Thumbprint:setImage( RegisterMaterial( f10_arg1.thumbprint ) )
...
local f0_local4 = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	f3_arg0.bindButton:addEventHandler( "button_right_stick", function ( f5_arg0, f5_arg1 )
		local f5_local0 = LUI.FlowManager.GetScopedData( "OperatorSelect" )
		f5_local0.operatorData.useSelectedOperatorIndexForFocus = true
		OPERATOR.PlayFullscreenIntroVideo( f3_arg0, f3_arg0._introVideo, f5_arg1.controller )
	end )
