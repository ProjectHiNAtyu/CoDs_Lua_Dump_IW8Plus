...
local f0_local3 = function ( f27_arg0, f27_arg1 )
	...
	for f27_local9, f27_local10 in ipairs( f27_arg0 ) do
		f27_local5 = false
		f27_local1 = string.find( f27_local10.productId, f27_local0 )
		f27_local3 = string.find( f27_local10.productId, f27_local2 )
		if f27_arg1 == f0_local0.T9_GAME_PACKS and f27_local1 ~= nil then
			f27_local5 = true
		...
		if f27_local5 then
			table.insert( f27_local4, f27_local10 )
		end
	end
	return f27_local4
end
