...
function BootEULAPopup( f28_arg0, f28_arg1 )
	...
	f28_arg1.disableAcceptUntilLastPage = false
	f28_arg1.acceptAction = BOOT.AcceptLegalPopupAction
	f28_arg1.declineAction = function ( f29_arg0, f29_arg1 )
	...
	if not CONDITIONS.IsMobileOrMobileSim() then
		f28_local1 = MenuBuilder.BuildRegisteredType( "EULAPopup", f28_arg1 )
	else
		f28_local1 = MenuBuilder.BuildRegisteredType( "MobileEULAPopup", f28_arg1 )
	end
...
function BootKoreanPIProcessingPopup( f26_arg0, f26_arg1 )
	...
	f26_arg1.terms = Engine[0xED84C33EC5F01EA]( 0x69CB4E78EC06EC7 )
...
function BootKoreanPIOverseasPopup( f24_arg0, f24_arg1 )
	local f24_local0 = {
		nil,
		0x715FCB285617F3C
	}
	...
	f24_arg1.EULAStringIds = f24_local0
	f24_arg1.disableAcceptUntilLastPage = true
	f24_arg1.terms = Engine[0xED84C33EC5F01EA]( 0xCC28914012095CA )
	f24_arg1.acceptAction = BOOT.AcceptLegalPopupAction
	f24_arg1.declineAction = function ( f25_arg0, f25_arg1 )
		LUI.FlowManager.RequestPopupMenu( f24_arg0, "EULADeclinePopup", true, f25_arg1.controller, false, {
			title = Engine[0xED84C33EC5F01EA]( 0x24519E7D78C6D3A ),
			message = Engine[0xED84C33EC5F01EA]( 0xE95ABA09D6BC336 )
		}, f24_arg0, true, true )
	end
	
	local f24_local1 = MenuBuilder.BuildRegisteredType( "EULAPopup", f24_arg1 )
	f24_local1.id = "KoreanPIOverseaPopup"
	return f24_local1
end

MenuBuilder.registerType( "BootKoreanPIOverseasPopup", BootKoreanPIOverseasPopup )
BOOT.AcceptLegalPopupAction = function ( f23_arg0, f23_arg1 )
	BOOT.IncreaseBootPopupIndex()
	local f23_local0 = BOOT.GetCurrentLegalBootPopupName()
	if f23_local0 then
		LUI.FlowManager.RequestPopupMenu( unused, f23_local0, false, f23_arg1.controller, false, {}, nil, true, true )
...
BOOT.GetRetryPopupButtons = function ( f14_arg0 )
	...
	local f14_local2 = {
		...
		action = function ( f15_arg0, f15_arg1 )
			LUI.FlowManager.RequestPopupMenu( self, "quit_popmenu", false, f15_arg1.controller )
		end
	}
