...
EventRewards.RewardsTable = {
	[EventRewards.RewardEvents.DOV] = {
		...
		ProcessRewards = function ( f9_arg0, f9_arg1, f9_arg2 )
			LUI.FlowManager.RequestPopupMenu( f9_arg0, "FutureTitleUpsellPopup", true, f9_arg1, false, {
				freeRewards = true
			} )
		end
	},
	[EventRewards.RewardEvents.VG_REVEAL] = {
		...
		ProcessRewards = function ( f8_arg0, f8_arg1, f8_arg2 )
			LUI.FlowManager.RequestPopupMenu( f8_arg0, "ChallengeRewardsPopup", true, f8_arg1, false, {
				freeRewards = true,
				rewards = f8_arg2,
	...
	[EventRewards.RewardEvents.TT] = {
		...
		ProcessRewards = function ( f6_arg0, f6_arg1, f6_arg2 )
			...
			LUI.FlowManager.RequestPopupMenu( f6_arg0, "ChallengeRewardsPopup", true, f6_arg1, false, {
				freeRewards = true,
				rewards = f6_arg2,
				toastNotificationDetails = f6_local0,
				description = f6_local0.description
			} )
		end
	}
}
