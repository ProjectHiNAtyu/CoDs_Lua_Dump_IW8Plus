...
local f0_local0 = function ( f2_arg0, f2_arg1, f2_arg2 )
	...
	f2_arg0.addButtonHelperFunction = function ( f5_arg0, f5_arg1 )
		f5_arg0:AddButtonHelperText( {
			...
			side = "left",
			helper_text = ToUpperCase( Engine[0xED84C33EC5F01EA]( "LUA_MENU/BUY_NOW" ) )
		} )
		f5_arg0:AddButtonHelperText( {
			clickable = true,
...
function TrialFullWindow( menu, controller )
	...
	HeaderText:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU/TRIAL_POPUP_HEADER" ), 0 )
	HeaderText:SetFont( FONTS.GetFont( FONTS.MainRegularHeader.File ) )
	HeaderText:SetFontSize( 54 * _PT )
