...
local f0_local1 = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	local f3_local1 = LUI.FlowManager.GetScopedData( "ArenaTournament" )
	assert( f3_local0.TeamName )
	assert( f3_local0.Wins )
	local f3_local2 = f3_arg2.teams[f3_arg1]
	f3_local0.TeamName:setText( f3_local2.name )
	f3_local0.ReadyFlash:SetRGBFromTable( SWATCHES.Tournament.bracketBacker )
	...
	if f3_local3 then
		...
		if not f3_local6 then
			...
			if f3_local2.won and f3_arg0._state ~= f0_local0.WON and f3_arg2.complete then
				...
				f3_local0.Wins:SetRGBFromTable( SWATCHES.Tournament.teamNeutral )
				f3_local0.TeamName:SetFont( FONTS.GetFont( FONTS.MainBold.File ) )
				f3_local0.Wins:SetFont( FONTS.GetFont( FONTS.MainBold.File ) )
			...
			elseif not f3_local2.won and f3_local2.isMyTeam and f3_arg0._state ~= f0_local0.MY_TEAM then
				...
				f3_local0.ScoreBacker:SetRGBFromTable( SWATCHES.Tournament.bracketBacker )
				f3_local0.TeamName:SetFont( FONTS.GetFont( FONTS.MainRegular.File ) )
			end
			if not f3_arg2.complete then
				...
				if not f3_local2.won and f3_arg0._matchData and f3_arg0._matchData.complete ~= f3_arg2.complete then
					...
					if f3_local2.isMyTeam then
						...
						f3_local0.TeamName:SetRGBFromTable( SWATCHES.Scoreboard.highlight )
					end
			...
			if not f3_arg0._fullTeamReady then
				...
				if f3_local4 and f3_arg2.isMyMatch then
					...
					if not f3_local1.firstBracketUpdate then
						...
						local f3_local7 = Engine[0xC4146BA76D0F982]
						if f3_local2.isMyTeam then
							f3_local6 = "ui_iw8_2v2_teamready_myteam_notify"
						else
							f3_local6 = "ui_iw8_2v2_teamready_opposing_notify"
						end
						f3_local7( f3_local6 )
					end
				end
	...
	f3_local6 = Engine[0xED84C33EC5F01EA]( "TOURNAMENT/NO_DATA" )
end
...
local f0_local2 = function ( f2_arg0, f2_arg1, f2_arg2 )
	...
	if f2_arg2.bracketTeam == 1 then
		f2_arg0.Bracket.TeamColor:SetBottom( 2 * _1080p )
	else
		f2_arg0.Bracket.TeamColor:SetTop( -2 * _1080p )
	end
end

function BracketTeam( menu, controller )
	local self = LUI.UIElement.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 302 * _1080p, 0, 38 * _1080p )
	self.id = "BracketTeam"
	local f1_local1
	if controller then
