...
local f0_local11 = function ( f43_arg0, f43_arg1 )
	...
	if Dvar.IBEGCHEFE( "LNTLOLLNQN" ) then
		...
		if f43_local4 and f43_local4.name == "MainMenu" then
			...
			if f43_local5 then
				local f43_local6 = f43_local5 == MAIN_MENU.GameModeEnumValues.BR
				if not f43_local6 then
					f43_local6 = Engine.ECHHDAIBD( f43_local5 ) == ContentProgressState.INSTALLED
				end
				if f43_local6 then
					if f43_local5 == MAIN_MENU.GameModeEnumValues.MP then
						...
						f43_local0 = true
					elseif f43_local5 == MAIN_MENU.GameModeEnumValues.BR then
					...
					MAIN_MENU.InstallAction( f43_arg0, f43_arg1, f43_local5 )
				end
			end
...
local f0_local14 = function ( f40_arg0 )
	if Engine.DDJFBBJAIG() and CONDITIONS.IsBladeBannerActive() then
		if MAIN_MENU.IsPreOrderAvailable() then
			...
			f40_arg0.NewGameRevealBanner.Title:setText( ToUpperCase( Engine.CBBHFCGDIC( "LUA_MENU_WZ335/CORTEZ_PREORDER_BANNER_COMING_SOON_TEXT" ) ) )
			f40_arg0.NewGameRevealBanner.SubTitle:setText( ToUpperCase( Engine.CBBHFCGDIC( "LUA_MENU_WZ335/CORTEZ_PREORDER_BANNER_COMING_SOON_SUBTEXT" ) ) )
		elseif MAIN_MENU.IsCortezReleaseCountdown() then
			ACTIONS.AnimateSequence( f40_arg0.NewGameRevealBanner, "CortezTheme" )
		...
		elseif MAIN_MENU.IsCortezNowAvailable() or MAIN_MENU.IsLegacyNowAvailable() then
			ACTIONS.AnimateSequence( f40_arg0.NewGameRevealBanner, "CortezTheme" )
			ACTIONS.AnimateSequence( f40_arg0.NewGameRevealBanner, "EventLive" )
			f40_arg0.NewGameRevealBanner.Title:setText( ToUpperCase( Engine.CBBHFCGDIC( "LUA_MENU_WZ345/CORTEZ_NOW_AVAILABLE" ) ) )
			f40_arg0.NewGameRevealBanner.SubTitle:setText( ToUpperCase( Engine.CBBHFCGDIC( "LUA_MENU_WZ345/LAUNCH_COD_HQ" ) ) )
		...
		elseif MAIN_MENU.IsStyxNowAvailable() then
			ACTIONS.AnimateSequence( f40_arg0.NewGameRevealBanner, "StyxTheme" )
			ACTIONS.AnimateSequence( f40_arg0.NewGameRevealBanner, "EventLive" )
			f40_arg0.NewGameRevealBanner.Title:setText( ToUpperCase( Engine.CBBHFCGDIC( "LUA_MENU_WZ345/STYX_NOW_AVAILABLE" ) ) )
			f40_arg0.NewGameRevealBanner.SubTitle:setText( ToUpperCase( Engine.CBBHFCGDIC( "LUA_MENU_WZ345/LAUNCH_COD_HQ" ) ) )
		end
	end
end
