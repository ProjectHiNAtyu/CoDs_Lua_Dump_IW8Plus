...
local f0_local0 = function ( f3_arg0, f3_arg1, f3_arg2, f3_arg3 )
	...
	for f3_local8 = 1, 3, 1 do
		...
		if f3_local12:getText() == Engine[0x7D3158A9539A355]( f3_local11 ) then
			return 
		end
		f3_local12:setText( Engine[0x7D3158A9539A355]( f3_local11 ) )
...
function MissionsHonours( menu, controller )
	...
	BonusText1:SetFont( FONTS.GetFont( FONTS.PrimaryRegular.File ) )
	BonusText1:SetFontSize( 20 * _PT )
	BonusText1:SetMinFontSize( 18 * _PT )
	BonusText1:SetWordWrap( true )
	...
	BonusText1:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 20, _1080p * -120, 0, _1080p * 20 )
	...
	BonusText2:SetFont( FONTS.GetFont( FONTS.PrimaryRegular.File ) )
	BonusText2:SetFontSize( 20 * _PT )
	BonusText2:SetMinFontSize( 18 * _PT )
	BonusText2:SetWordWrap( true )
	...
	BonusText3:SetFont( FONTS.GetFont( FONTS.PrimaryRegular.File ) )
	BonusText3:SetFontSize( 20 * _PT )
	BonusText3:SetMinFontSize( 18 * _PT )
	BonusText3:SetWordWrap( true )
