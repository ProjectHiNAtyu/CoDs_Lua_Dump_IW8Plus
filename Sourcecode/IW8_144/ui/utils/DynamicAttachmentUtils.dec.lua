...
DYN_ATTACHMENT.FormatDynamicAttachmentVariantIcon = function ( f25_arg0, f25_arg1, f25_arg2 )
	...
	if DYN_ATTACHMENT.IsAttachmentVariantIconEnable() and f25_arg0 and f25_arg2 and 0 < f25_arg2 then
		local f25_local1 = StringTable.DIFCHIGDFB( CSV.DynamicWeaponVariantIconMapTable.file, CSV.DynamicWeaponVariantIconMapTable.cols.ref, f25_arg0, f25_arg2 + CSV.DynamicWeaponVariantIconMapTable.cols.base )
...
DYN_ATTACHMENT.FormatDynamicAttachmentVariantAnimation = function ( f24_arg0, f24_arg1, f24_arg2 )
	if DYN_ATTACHMENT.IsAttachmentVariantIconEnable() and f24_arg0 and f24_arg2 and 0 < f24_arg2 then
		local f24_local0 = StringTable.DIFCHIGDFB( CSV.DynamicWeaponVariantIconMapTableAnim.file, CSV.DynamicWeaponVariantIconMapTableAnim.cols.ref, f24_arg0, f24_arg2 + CSV.DynamicWeaponVariantIconMapTableAnim.cols.baseAnimation )
