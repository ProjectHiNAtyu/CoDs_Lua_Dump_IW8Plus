...
function TournamentFullBracket( menu, controller )
	...
	local f1_local2 = nil
	if CONDITIONS.IsTournamentFullSize() then
		f1_local2 = MenuBuilder.BuildRegisteredType( "HorizontalMinimalScrollbar", {
			controllerIndex = f1_local1
		} )
		f1_local2.id = "Scrollbar"
		f1_local2:SetAnchorsAndPosition( 0, 0, 1, 0, 0, 0, _1080p * 5, _1080p * 15 )
		self:addElement( f1_local2 )
		self.Scrollbar = f1_local2
	end
