...
local f0_local0 = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	if not IsSystemLink() then
		...
		f3_arg0:registerEventHandler( "update_lobby", function ( element, event )
			Lobby.UpdateClientCharactersDelayed( f3_arg0, f3_arg0, {
...
function GameSetup( menu, controller )
	...
	GameSetupButtons:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 96, _1080p * 526, _1080p * 216, _1080p * 616 )
	...
	if not CONDITIONS.IsPrivateMatchTournament( self ) then
		...
		f1_local9.DisabledMessage:SetLeft( 0, 0 )
		f1_local9:SetAnchorsAndPosition( 0, 1, 1, 0, _1080p * 96, _1080p * 696, _1080p * -286, _1080p * -131 )
