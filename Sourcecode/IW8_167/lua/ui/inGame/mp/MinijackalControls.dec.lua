...
function PostLoadFunc( f2_arg0, f2_arg1, f2_arg2 )
	...
	if Game.BFEEGCHICA( f2_arg1, "ui_minijackal_controls" ) == 2 then
		f2_arg0.Fire:setText( Engine.CBBHFCGDIC( "LUA_MENU_MP/MINIJACKAL_FIRE_LASER" ), 0 )
	end
end
...
function MinijackalControls( menu, controller )
	...
	Fire = LUI.UIText.new()
	Fire.id = "Fire"
	Fire:setText( Engine.CBBHFCGDIC( "LUA_MENU_MP/MINIJACKAL_FIRE" ), 0 )
	...
	Missile.id = "Missile"
	Missile:setText( Engine.CBBHFCGDIC( "LUA_MENU_MP/MINIJACKAL_MISSILE" ), 0 )
	...
	Up = LUI.UIText.new()
	Up.id = "Up"
	Up:setText( Engine.CBBHFCGDIC( "LUA_MENU_MP/MINIJACKAL_UP" ), 0 )
	...
	Down = LUI.UIText.new()
	Down.id = "Down"
	Down:setText( Engine.CBBHFCGDIC( "LUA_MENU_MP/MINIJACKAL_DOWN" ), 0 )
	...
	L3Boost.id = "L3Boost"
	L3Boost:setText( Engine.CBBHFCGDIC( "LUA_MENU_MP/MINIJACKAL_BOOST" ), 0 )
