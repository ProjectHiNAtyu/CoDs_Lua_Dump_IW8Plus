...
function WatchGeiger( menu, controller )
	...
	self._sequences.GoalReached = function ()
		menu:AnimateLoop( "GoalReached", -1 )
	end
	
	self._sequenceLengths.GoalReached = 1000
	...
	self._sequences.Deployed = function ()
		menu:AnimateLoop( "Deployed", -1 )
		menu:AnimateLoop( "Deployed", -1 )
		menu:AnimateLoop( "Deployed", -1 )
	end
	
	self._sequenceLengths.Deployed = 500
	...
	self._sequenceLengths.ScreenOffline = 0
