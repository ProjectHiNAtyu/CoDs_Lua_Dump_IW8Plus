...
local f0_local0 = function ( f2_arg0, f2_arg1, f2_arg2 )
	...
	local f2_local2 = function ()
		...
		if f4_local0 ~= -1 then
			...
			f2_arg0.FinalScoreLabel:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU/FINAL_SCORE" ) )
		end
	end
	...
	local f2_local3 = function ()
		...
		if f3_local0 ~= -1 then
			...
			f2_arg0.FinalScoreLabel:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU/FINAL_TIME" ) )
		end
	end
...
function TrialStatLineBottom( menu, controller )
	...
	FinalScoreLabel:setText( Engine[0xED84C33EC5F01EA]( "LUA_MENU/FINAL_TIME" ), 0 )
	FinalScoreLabel:SetFont( FONTS.GetFont( FONTS.MainRegularHeader.File ) )
	FinalScoreLabel:SetFontSize( 30 * _PT )
	FinalScoreLabel:SetMinFontSize( 16 * _PT )
	...
	FinalScore:SetFontSize( 36 * _PT )
	FinalScore:SetMinFontSize( 16 * _PT )
