...
local f0_local1 = function ( f3_arg0, f3_arg1, f3_arg2 )
	...
	f3_arg0:SubscribeToModel( DataSources.alwaysLoaded.activeParty.memberCount:GetModel( f3_arg1 ), function ()
...
function PlayerFocus( menu, controller )
	...
	MenuTitle.MenuTitle:setText( Engine[0xED84C33EC5F01EA]( 0xE9DCD38C4202F05 ), 0 )
