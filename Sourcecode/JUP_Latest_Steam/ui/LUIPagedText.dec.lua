...
LUI.UIPagedText.GetTotalPages = function ( f1_arg0, f1_arg1, f1_arg2 )
	local f1_local0 = f1_arg2.markLocalized
	local f1_local1 = 0
	for f1_local2 = 1, #f1_arg1, 1 do
		if f1_local0 then
			f1_local1 = f1_local1 + #f1_arg0:GetPagedText( f1_arg1[f1_local2], f1_arg0._textPageHeight, f1_arg0._maxCharsPerPage )
		else
			f1_local1 = f1_local1 + #f1_arg0:GetPagedText( LocalizeLongString( f1_arg1[f1_local2] ), f1_arg0._textPageHeight, f1_arg0._maxCharsPerPage )
		end
	end
	return f1_local1
end
