...
local f0_local0 = function ( f5_arg0, f5_arg1, f5_arg2 )
	...
	f5_arg0.MenuTitle:SetTitle( Engine[0xED84C33EC5F01EA]( 0x29120EDE20125E1 ) )
end

function LeaderboardStandardMenu( menu, controller )
	local self = LUI.UIElement.new()
	self.id = "LeaderboardStandardMenu"
	local f1_local1
	if controller then
	...
	self.bindButton:addEventHandler( "button_alt1", function ( f3_arg0, f3_arg1 )
		ACTIONS.OpenMenu( "LeaderboardFilterMenu", true, f3_arg1.controller or menu )
	end )
	self.bindButton:addEventHandler( "button_alt2", function ( f2_arg0, f2_arg1 )
		ACTIONS.OpenMenu( "LeaderboardSelectModeMenu", true, f2_arg1.controller or menu )
	end )
